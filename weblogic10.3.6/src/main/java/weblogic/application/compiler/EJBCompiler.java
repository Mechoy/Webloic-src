...
final class EJBCompiler implements Compiler {
   private final CompilerFlow[] flow;

   public EJBCompiler(CompilerCtx var1) {
      this.flow = new CompilerFlow[]{new SingleModuleCompileFlow(var1), new ManifestFlow(var1), new ModuleClassEnhanceFlow(var1)};
   }
