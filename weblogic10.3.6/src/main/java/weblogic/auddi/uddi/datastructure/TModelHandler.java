...
public class TModelHandler extends UDDIXMLHandler {
   public Object create(Node var1) throws UDDIException {
      TModel var2 = new TModel();
         ...
         for(int var14 = 0; var14 < var10.getLength(); ++var14) {
            if (var10.item(var14).getNodeType() != 8) {
               ...
               if (var10.item(var14).getNodeName().equals("identifierBag")) {
                  ...
                  IdentifierBag var21 = (IdentifierBag)var17.create(var10.item(var14));
                  var2.setIdentifierBag(var21);
               }

               if (var10.item(var14).getNodeName().equals("categoryBag")) {
                  CategoryBagHandler var19 = new CategoryBagHandler();
                  CategoryBag var22 = (CategoryBag)var19.create(var10.item(var14));
                  var2.setCategoryBag(var22);
               }
            }
         }
      }
