...
public class AddPublisherAssertionsRequestHandler extends UDDIXMLHandler {
   private UDDIRequest uddirequest;

   public Object create(Node var1) throws UDDIException {
      AddPublisherAssertionsRequest var2 = new AddPublisherAssertionsRequest();
      var2.setAPI(false);
      ...
      if (var5 != null) {
         for(int var6 = 0; var6 < var5.getLength(); ++var6) {
            ...
            if (var5.item(var6).getNodeName().equals("publisherAssertion")) {
