...
public class DeleteBindingRequestHandler extends UDDIXMLHandler {
   private UDDIRequest uddirequest;

   public Object create(Node var1) throws UDDIException {
      DeleteBindingRequest var2 = new DeleteBindingRequest();
      var2.setAPI(false);
      ...
      if (var5 != null) {
         for(int var6 = 0; var6 < var5.getLength(); ++var6) {
            ...
            if (var5.item(var6).getNodeName().equals("bindingKey")) {
               ...
               BindingKeyHandler var9 = (BindingKeyHandler)var3.makeHandler("bindingKey");
               BindingKey var10 = (BindingKey)var9.create(var5.item(var6));
               var2.addBindingKey(var10);
            }
         }
      }
