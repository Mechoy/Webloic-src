...
public class GetPublisherAssertionsRequestHandler extends UDDIXMLHandler {
   private UDDIRequest uddirequest;

   public Object create(Node var1) throws UDDIException {
      Logger.trace("+GetPublisherAssertionsRequestHandler.create()");
      GetPublisherAssertionsRequest var2 = new GetPublisherAssertionsRequest();
      var2.setAPI(false);
