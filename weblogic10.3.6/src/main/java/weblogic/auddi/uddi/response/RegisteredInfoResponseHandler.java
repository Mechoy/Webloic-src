...
public class RegisteredInfoResponseHandler extends UDDIXMLHandler {
   private RegisteredInfoResponse registeredInfoResponse = null;
   private static UDDIXMLHandlerMaker maker = null;

   public Object create(Node var1) throws UDDIException {
      this.registeredInfoResponse = new RegisteredInfoResponse();
      ...
      if (var2.getAttributeNode("truncated") != null) {
         ...
         this.registeredInfoResponse.setTruncated(Boolean.valueOf(var4));
      }
      ...
      if (var2.getAttributeNode("operator") != null) {
         ...
         this.registeredInfoResponse.setOperator(var5);
      }
      ...
      if (var7 != null) {
         for(int var9 = 0; var9 < var7.getLength(); ++var9) {
            if (var7.item(var9).getNodeName().equals("businessInfos")) {
               ...
               this.registeredInfoResponse.setBusinessInfos(var6);
            }

            if (var7.item(var9).getNodeName().equals("tModelInfos")) {
               TModelInfosHandler var11 = (TModelInfosHandler)maker.makeHandler("tModelInfos");
               TModelInfos var12 = (TModelInfos)var11.create(var7.item(var9));
               this.registeredInfoResponse.setTModelInfos(var12);
            }
         }
      }

      return this.registeredInfoResponse;
   }
}
