...
public class ServiceDetailResponseHandler extends UDDIXMLHandler {
   private ServiceDetailResponse serviceDetailResponse = null;
   private static UDDIXMLHandlerMaker maker = null;

   public Object create(Node var1) throws UDDIException {
      this.serviceDetailResponse = new ServiceDetailResponse();
      ...
      if (var2.getAttributeNode("truncated") != null) {
         ...
         this.serviceDetailResponse.setTruncated(Boolean.valueOf(var4));
      }
      ...
      if (var2.getAttributeNode("operator") != null) {
         ...
         this.serviceDetailResponse.setOperator(var5);
      }

      NodeList var7 = var1.getChildNodes();
      if (var7 != null) {
         for(int var9 = 0; var9 < var7.getLength(); ++var9) {
            if (var7.item(var9).getNodeName().equals("businessService")) {
               BusinessServiceHandler var10 = (BusinessServiceHandler)maker.makeHandler("businessService");
               BusinessService var6 = (BusinessService)var10.create(var7.item(var9));
               this.serviceDetailResponse.addBusinessService(var6);
            }
         }
      }

      return this.serviceDetailResponse;
   }
}
