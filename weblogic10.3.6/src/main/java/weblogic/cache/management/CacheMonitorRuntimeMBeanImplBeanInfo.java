...
public class CacheMonitorRuntimeMBeanImplBeanInfo extends WebLogicMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = CacheMonitorRuntimeMBean.class;

   public CacheMonitorRuntimeMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = CacheMonitorRuntimeMBeanImpl.class;
      ...
      var2.setValue("package", "weblogic.cache.management");
      ...
      var2.setValue("interfaceclassname", "weblogic.management.runtime.CacheMonitorRuntimeMBean");
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = CacheMonitorRuntimeMBean.class.getMethod("preDeregister");
