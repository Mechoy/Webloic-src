...
public final class RemoteClusterHealthCheckerImpl_1036_WLStub extends Stub implements StubInfoIntf, RemoteClusterHealthChecker {
   ...
   public RemoteClusterHealthCheckerImpl_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
