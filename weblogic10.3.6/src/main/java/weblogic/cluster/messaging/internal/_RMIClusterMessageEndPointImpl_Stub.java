...
public final class _RMIClusterMessageEndPointImpl_Stub extends Stub implements ClusterMessageEndPoint {
   private static String[] _type_ids = new String[]{"RMI:weblogic.cluster.messaging.internal.RMIClusterMessageEndPointImpl:0000000000000000", "RMI:weblogic.cluster.messaging.internal.ClusterMessageEndPoint:0000000000000000"};
   // $FF: synthetic field
   ...
   public final void processOneWay(ClusterMessage var1) throws RemoteException {
      try {
         ...
         try {
            OutputStream var3 = (OutputStream)this._request("processOneWay", false);
            var3.write_value(var1, class$weblogic$cluster$messaging$internal$ClusterMessage == null ? (class$weblogic$cluster$messaging$internal$ClusterMessage = class$("weblogic.cluster.messaging.internal.ClusterMessage")) : class$weblogic$cluster$messaging$internal$ClusterMessage);
            this._invoke(var3);
