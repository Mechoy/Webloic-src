...
public final class AsyncReplicationManager_1036_WLStub extends Stub implements StubInfoIntf, ReplicationServicesInternal {
   ...
   public AsyncReplicationManager_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
