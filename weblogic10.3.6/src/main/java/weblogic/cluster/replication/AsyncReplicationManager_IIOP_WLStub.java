...
public final class AsyncReplicationManager_IIOP_WLStub extends Stub implements StubInfoIntf, ReplicationServicesInternal {
   ...
   public AsyncReplicationManager_IIOP_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
