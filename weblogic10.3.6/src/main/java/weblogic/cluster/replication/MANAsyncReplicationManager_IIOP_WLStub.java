...
public final class MANAsyncReplicationManager_IIOP_WLStub extends Stub implements StubInfoIntf, ReplicationServicesInternal {
   ...
   public MANAsyncReplicationManager_IIOP_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
