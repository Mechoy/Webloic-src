...
public class MANAsyncReplicationRuntimeBeanInfo extends MANReplicationRuntimeBeanInfo {
   public static Class INTERFACE_CLASS = MANAsyncReplicationRuntimeMBean.class;

   public MANAsyncReplicationRuntimeBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = MANAsyncReplicationRuntime.class;
      ...
      var2.setValue("interfaceclassname", "weblogic.management.runtime.MANAsyncReplicationRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("ActiveServersInRemoteCluster")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("ActiveServersInRemoteCluster", MANAsyncReplicationRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("DetailedSecondariesDistribution")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("DetailedSecondariesDistribution", MANAsyncReplicationRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("LastSessionsFlushTime")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("LastSessionsFlushTime", MANAsyncReplicationRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("PrimaryCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("PrimaryCount", MANAsyncReplicationRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("RemoteClusterReachable")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("RemoteClusterReachable", MANAsyncReplicationRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("SecondaryCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("SecondaryCount", MANAsyncReplicationRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("SecondaryServerDetails")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("SecondaryServerDetails", MANAsyncReplicationRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("SecondaryServerName")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("SecondaryServerName", MANAsyncReplicationRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("SessionsWaitingForFlushCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("SessionsWaitingForFlushCount", MANAsyncReplicationRuntimeMBean.class, var3, (String)var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = MANAsyncReplicationRuntimeMBean.class.getMethod("preDeregister");
