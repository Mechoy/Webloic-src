...
public final class ReplicationManager_1036_WLStub extends Stub implements StubInfoIntf, ReplicationServicesInternal {
   ...
   public ReplicationManager_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
