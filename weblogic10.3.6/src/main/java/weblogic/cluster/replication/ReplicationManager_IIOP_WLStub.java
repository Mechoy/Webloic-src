...
public final class ReplicationManager_IIOP_WLStub extends Stub implements StubInfoIntf, ReplicationServicesInternal {
   ...
   public ReplicationManager_IIOP_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
