...
public final class _ReplicationServicesInternal_Stub extends Stub implements ReplicationServicesInternal {
   private static String[] _type_ids = new String[]{"RMI:weblogic.cluster.replication.ReplicationServicesInternal:0000000000000000"};
   // $FF: synthetic field
   ...
   public final Object create(HostID var1, int var2, ROID var3, Replicatable var4) throws RemoteException {
      try {
         ...
         try {
            ...
            var6.write_value(var4, class$weblogic$cluster$replication$Replicatable == null ? (class$weblogic$cluster$replication$Replicatable = class$("weblogic.cluster.replication.Replicatable")) : class$weblogic$cluster$replication$Replicatable);
   ...
   public final void updateOneWay(ROID var1, int var2, Serializable var3, Object var4) throws RemoteException {
      try {
         ...
         try {
            OutputStream var6 = (OutputStream)this._request("updateOneWay", true);
            var6.write_value(var1, class$weblogic$cluster$replication$ROID == null ? (class$weblogic$cluster$replication$ROID = class$("weblogic.cluster.replication.ROID")) : class$weblogic$cluster$replication$ROID);
            var6.write_long(var2);
            Util.writeAny(var6, var3);
            Util.writeAny(var6, var4);
   ...
   public final ReplicationManager.ROObject fetch(ROID var1) throws RemoteException {
      try {
         InputStream var2 = null;

         ReplicationManager.ROObject var6;
         try {
            ...
            ReplicationManager.ROObject var4 = (ReplicationManager.ROObject)var2.read_value(class$weblogic$cluster$replication$ReplicationManager$ROObject == null ? (class$weblogic$cluster$replication$ReplicationManager$ROObject = class$("weblogic.cluster.replication.ReplicationManager$ROObject")) : class$weblogic$cluster$replication$ReplicationManager$ROObject);
            return var4;
   ...
   public final void removeOneWay(ROID[] var1, Object var2) throws RemoteException {
      try {
         ...
         try {
            OutputStream var4 = (OutputStream)this._request("removeOneWay", true);
            var4.write_value(var1, array$Lweblogic$cluster$replication$ROID == null ? (array$Lweblogic$cluster$replication$ROID = class$("[Lweblogic.cluster.replication.ROID;")) : array$Lweblogic$cluster$replication$ROID);
            Util.writeAny(var4, var2);
            this._invoke(var4);
         } catch (ApplicationException var12) {
   ...
   public final void remove(ROID[] var1) throws RemoteException {
      try {
         ...
         try {
            OutputStream var3 = (OutputStream)this._request("remove__org_omg_boxedRMI_weblogic_cluster_replication_seq1_ROID", true);
