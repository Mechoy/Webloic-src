...
public final class DomainMigrationHistoryImpl_1036_WLStub extends Stub implements StubInfoIntf, DomainMigrationHistory {
   ...
   public DomainMigrationHistoryImpl_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
