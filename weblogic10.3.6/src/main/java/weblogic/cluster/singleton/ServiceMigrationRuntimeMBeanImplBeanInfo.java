...
public class ServiceMigrationRuntimeMBeanImplBeanInfo extends WebLogicMBeanImplBeanInfo {
   ...
   public ServiceMigrationRuntimeMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = ServiceMigrationRuntimeMBeanImpl.class;
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("ClusterMasterName")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("ClusterMasterName", ServiceMigrationRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MigrationData")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MigrationData", ServiceMigrationRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("ClusterMaster")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("ClusterMaster", ServiceMigrationRuntimeMBean.class, var3, (String)var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = ServiceMigrationRuntimeMBean.class.getMethod("preDeregister");
