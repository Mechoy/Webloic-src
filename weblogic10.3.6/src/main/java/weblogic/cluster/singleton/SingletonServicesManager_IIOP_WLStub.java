...
public final class SingletonServicesManager_IIOP_WLStub extends Stub implements StubInfoIntf, RemoteSingletonServicesControl {
   ...
   public SingletonServicesManager_IIOP_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
