...
public final class _DomainMigrationHistoryImpl_Stub extends Stub implements DomainMigrationHistory {
   private static String[] _type_ids = new String[]{"RMI:weblogic.cluster.singleton.DomainMigrationHistoryImpl:0000000000000000", "RMI:weblogic.cluster.singleton.DomainMigrationHistory:0000000000000000"};
   // $FF: synthetic field
   ...
   public final void update(MigrationData var1) throws RemoteException {
      try {
         ...
         try {
            OutputStream var3 = (OutputStream)this._request("update", false);
