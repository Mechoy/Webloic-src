...
public final class _RemoteLeasingBasisImpl_Stub extends Stub implements RemoteLeasingBasis {
   private static String[] _type_ids = new String[]{"RMI:weblogic.cluster.singleton.RemoteLeasingBasisImpl:0000000000000000", "RMI:weblogic.cluster.singleton.RemoteLeasingBasis:0000000000000000"};
   // $FF: synthetic field
