...
public final class _RemoteSingletonServicesControl_Stub extends Stub implements RemoteSingletonServicesControl {
   private static String[] _type_ids = new String[]{"RMI:weblogic.cluster.singleton.RemoteSingletonServicesControl:0000000000000000"};
   // $FF: synthetic field
