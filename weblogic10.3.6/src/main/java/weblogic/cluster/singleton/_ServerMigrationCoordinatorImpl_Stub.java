...
public final class _ServerMigrationCoordinatorImpl_Stub extends Stub implements ServerMigrationCoordinator {
   private static String[] _type_ids = new String[]{"RMI:weblogic.cluster.singleton.ServerMigrationCoordinatorImpl:0000000000000000", "RMI:weblogic.cluster.singleton.ServerMigrationCoordinator:0000000000000000"};
   // $FF: synthetic field
