...
public interface NamingContextAnyOperations extends NamingContextExtOperations {
   void bind_any(WNameComponent[] var1, Any var2) throws NotFound, CannotProceed, InvalidName, AlreadyBound, TypeNotSupported;

   void rebind_any(WNameComponent[] var1, Any var2) throws NotFound, CannotProceed, InvalidName, TypeNotSupported;

   Any resolve_any(WNameComponent[] var1) throws NotFound, CannotProceed, InvalidName;

   Any resolve_str_any(String var1) throws NotFound, CannotProceed, InvalidName;
}
