...
public final class NamingContextAny_IIOP_WLStub extends Stub implements StubInfoIntf, NamingContextAny, NamingContextExt, NamingContext, Object {
   ...
   public NamingContextAny_IIOP_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
