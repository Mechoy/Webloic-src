...
public final class TerminatorImpl_1036_WLStub extends Stub implements StubInfoIntf, Terminator, Object {
   ...
   public TerminatorImpl_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
   ...
   private static synchronized void ensureInitialized(StubInfo var0) {
      if (!initialized) {
         ...
         md0 = new MethodDescriptor(m[0], class$org$omg$CosTransactions$Terminator == null ? (class$org$omg$CosTransactions$Terminator = class$("org.omg.CosTransactions.Terminator")) : class$org$omg$CosTransactions$Terminator, false, false, false, false, var0.getTimeOut(m[0]), var0.getRemoteRef().getObjectID());
         md1 = new MethodDescriptor(m[1], class$org$omg$CosTransactions$Terminator == null ? (class$org$omg$CosTransactions$Terminator = class$("org.omg.CosTransactions.Terminator")) : class$org$omg$CosTransactions$Terminator, false, false, false, false, var0.getTimeOut(m[1]), var0.getRemoteRef().getObjectID());
         initialized = true;
      }
   }
