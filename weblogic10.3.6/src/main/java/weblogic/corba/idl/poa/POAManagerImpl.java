...
class POAManagerImpl extends ObjectImpl implements POAManager {
   ...
   public POAManagerImpl(String var1) {
      this.state = State.HOLDING;
      if (KernelStatus.isServer()) {
         this.wm = WorkManagerServiceImpl.createService(var1, "POA", "POA");
      } else {
         this.wm = null;
      }
   ...
   public synchronized void deactivate(boolean var1, boolean var2) throws AdapterInactive {
      if (this.state.equals(State.INACTIVE)) {
