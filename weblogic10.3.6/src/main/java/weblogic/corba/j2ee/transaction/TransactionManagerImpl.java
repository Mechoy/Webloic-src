...
public class TransactionManagerImpl implements UserTransaction, ClientTransactionManager, Transaction, Serializable {
   ...
   public TransactionFactory getTxFactory() throws SystemException {
      try {
         ORBInfo var1 = ORBHelper.getORBHelper().getCurrent();
         if (var1 == null) {
            throw new SystemException("No default ORB selected for the current thread");
         }

         this.txFactory = TransactionFactoryHelper.narrow(var1.getORB().resolve_initial_references("TransactionFactory"));
   ...
   public void begin() throws NotSupportedException, SystemException {
      if (this.control != null) {
         ...
         try {
            ...
            ORBInfo var2 = ORBHelper.getORBHelper().getCurrent();
            ORBHelper.getORBHelper().clearORBFromCache(var2.getKey());
   ...
   public void commit() throws RollbackException, HeuristicMixedException, HeuristicRollbackException, SecurityException, IllegalStateException, SystemException {
      try {
         ...
         Terminator var1 = this.control.get_terminator();
   ...
   public int getStatus() throws SystemException {
      if (this.control == null) {
         ...
         try {
            Coordinator var1 = this.control.get_coordinator();
            return Utils.ots2jtaStatus(var1.get_status());
   ...
   public void resume(Transaction var1) throws InvalidTransactionException, IllegalStateException, SystemException {
      try {
         ORBHelper.getORBHelper().getCurrent().setTransaction((TransactionManagerImpl)var1);
   ...
   public void forceResume(Transaction var1) {
      if (var1 != null) {
         try {
            ...
            ORBHelper.getORBHelper().getCurrent().setTransaction(var2);
