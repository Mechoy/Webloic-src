...
public final class UnprepareOperation extends AbstractOperation {
   ...
   protected final AppDeploymentMBean updateConfiguration(String var1, String var2, String var3, DeploymentData var4, String var5, boolean var6) throws ManagementException {
      ...
      Object var11 = null;
      if (isDebugEnabled()) {
         this.printDebugStartMessage(var1, var8, (String)var10, var4, var5, var9, (String)var11);
      }

      OperationHelper.assertNameIsNonNull(var8, var9);
      OperationHelper.validateVersionForDeprecatedOp(var4, var2, var9, 8);
      AppDeploymentMBean var7 = ApplicationVersionUtils.getAppDeployment(this.beanFactory.getEditableDomain(), var8, (String)var10);
