...
public class DataSourceLogFileDataArchive extends FileDataArchive {
   ...
   public DataSourceLogFileDataArchive(String var1, File var2, File var3, File var4, boolean var5) throws IOException, ManagementException {
      super(var1, ArchiveConstants.getColumns(7), var2, var3, var4, RECORD_PARSER, RECORD_MARKER, true, var5);
   }

   public DataSourceLogFileDataArchive(String var1, File var2, File var3, boolean var4) throws IOException, ManagementException {
   ...
   public static void main(String[] var0) throws Exception {
      if (var0.length < 4) {
         ...
         DataSourceLogFileDataArchive var3 = new DataSourceLogFileDataArchive("DataSourceLog", var1, var2, true);
