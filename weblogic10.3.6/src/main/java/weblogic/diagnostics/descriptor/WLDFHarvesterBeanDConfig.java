...
public class WLDFHarvesterBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private WLDFHarvesterBean beanTreeNode;

   public WLDFHarvesterBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (WLDFHarvesterBean)var2;
      this.beanTree = var2;
   ...
   public void setSamplePeriod(long var1) {
      this.beanTreeNode.setSamplePeriod(var1);
