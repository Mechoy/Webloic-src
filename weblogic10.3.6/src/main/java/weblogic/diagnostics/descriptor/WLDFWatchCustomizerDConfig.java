...
public class WLDFWatchCustomizerDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private WLDFWatchCustomizer beanTreeNode;

   public WLDFWatchCustomizerDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (WLDFWatchCustomizer)var2;
      this.beanTree = var2;
