...
public class FailedImageSourceBeanImpl extends AbstractDescriptorBean implements FailedImageSourceBean, Serializable {
   ...
   public FailedImageSourceBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
      this._initializeProperty(-1);
   }
   ...
   public void setFailureExceptionStackTrace(String var1) {
      var1 = var1 == null ? null : var1.trim();
      String var2 = this._FailureExceptionStackTrace;
      this._FailureExceptionStackTrace = var1;
      ...
      public int getPropertyIndex(String var1) {
         switch (var1.length()) {
            case 12:
               ...
               break;
            case 29:
               if (var1.equals("failure-exception-stack-trace")) {
                  return 1;
               }
         }
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      ...
      protected Helper(FailedImageSourceBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      public int getPropertyIndex(String var1) {
         if (var1.equals("FailureExceptionStackTrace")) {
            return 1;
         } else {
      ...
      protected long computeHashValue(CRC32 var1) {
         try {
            ...
            if (this.bean.isFailureExceptionStackTraceSet()) {
               var2.append("FailureExceptionStackTrace");
               var2.append(String.valueOf(this.bean.getFailureExceptionStackTrace()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            FailedImageSourceBeanImpl var2 = (FailedImageSourceBeanImpl)var1;
            this.computeDiff("FailureExceptionStackTrace", this.bean.getFailureExceptionStackTrace(), var2.getFailureExceptionStackTrace(), false);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            FailedImageSourceBeanImpl var3 = (FailedImageSourceBeanImpl)var1.getSourceBean();
            FailedImageSourceBeanImpl var4 = (FailedImageSourceBeanImpl)var1.getProposedBean();
            String var5 = var2.getPropertyName();
            int var6 = var2.getUpdateType();
            if (!var2.isDerivedUpdate()) {
               if (var5.equals("FailureExceptionStackTrace")) {
                  var3.setFailureExceptionStackTrace(var4.getFailureExceptionStackTrace());
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            FailedImageSourceBeanImpl var5 = (FailedImageSourceBeanImpl)var1;
            super.finishCopy(var5, var2, var3);
            if ((var3 == null || !var3.contains("FailureExceptionStackTrace")) && this.bean.isFailureExceptionStackTraceSet()) {
               var5.setFailureExceptionStackTrace(this.bean.getFailureExceptionStackTrace());
            }
