...
public interface MibConstants {
   ...
   String[] SUBSYSTEM_PREFIXES = new String[]{"com", "ejb", "iiop", "jmx", "ldap", "http", "jdbc", "jms", "jta", "jvm", "man", "ons", "url", "nt", "ps", "rmc", "rdbms", "saf", "sca", "ssl", "snmp", "wan", "wldf", "wtc", "wlec", "xml", "wsrm"};
