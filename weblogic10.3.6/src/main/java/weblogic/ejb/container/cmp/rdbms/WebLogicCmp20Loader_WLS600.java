...
public final class WebLogicCmp20Loader_WLS600 extends CMPDDParser implements XMLProcessor, InProcessor {
   ...
   private void __post_151(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6607343](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.sql-select-distinct.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6607343](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.sql-select-distinct.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_167(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6626107](.weblogic-rdbms-jar.create-default-dbms-tables.) must be a non-empty string");
      } else {
   ...
   private void __post_168(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6627502](.weblogic-rdbms-jar.validate-db-schema-with.) must be a non-empty string");
      } else {
   ...
   private void __post_149(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6605014](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.max-elements.) must be a non-empty string");
      } else {
         try {
   ...
   private void __post_155(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6613224](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.generator-name.) must be a non-empty string");
      } else {
   ...
   private void __post_136(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6588783](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-map.dbms-column-type.) must be a non-empty string");
      } else if (!"OracleBlob".equals(var2) && !"OracleClob".equals(var2) && !"LongString".equals(var2)) {
         throw new SAXValidationException("PAction[6588783](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-map.dbms-column-type.) must be one of the values: OracleBlob,OracleClob,LongString");
      } else {
         String var8 = var2;
   ...
   private void __post_154(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6610976](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.generator-type.) must be a non-empty string");
      } else {
         String var8;
   ...
   private void __post_156(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6614233](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.key-cache-size.) must be a non-empty string");
      } else {
   ...
   private void __post_147(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6602784](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.weblogic-ql.) must be a non-empty string");
      } else {
   ...
   private void __post_131(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6583663](.weblogic-rdbms-jar.weblogic-rdbms-bean.data-source-name.) must be a non-empty string");
      } else {
   ...
   private void __post_150(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6606104](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.include-updates.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6606104](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.include-updates.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_148(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6603901](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.group-name.) must be a non-empty string");
      } else {
         EjbQlQueryBean var8 = var3.getEjbQlQuery();
   ...
   private void __post_152(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6608424](.weblogic-rdbms-jar.weblogic-rdbms-bean.delay-database-insert-until.) must be a non-empty string");
         ...
         throw new SAXValidationException("PAction[6608424](.weblogic-rdbms-jar.weblogic-rdbms-bean.delay-database-insert-until.) must be one of the values: ejbCreate,ejbPostCreate,EjbCreate,EjbPostCreate,ejbcreate,ejbpostcreate");
      } else {
         String var7 = null;
   ...
   private void __post_134(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6586771](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-map.cmp-field.) must be a non-empty string");
      } else {
   ...
   private void __post_140(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6595755](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-group.cmr-field.) must be a non-empty string");
      } else {
   ...
   private void __post_162(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6620856](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.group-name.) must be a non-empty string");
      } else {
   ...
   private void __post_144(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6599941](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.query-method.method-name.) must be a non-empty string");
      } else {
   ...
   private void __post_138(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6593747](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-group.group-name.) must be a non-empty string");
      } else {
         var3.setGroupName(var2);
      }
   }
   ...
   private void __post_135(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6587775](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-map.dbms-column.) must be a non-empty string");
      } else {
   ...
   private void __post_159(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6617627](.weblogic-rdbms-jar.weblogic-rdbms-relation.table-name.) must be a non-empty string");
      } else {
   ...
   private void __post_139(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6594751](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-group.cmp-field.) must be a non-empty string");
      } else {
   ...
   private void __post_165(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6624317](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.column-map.key-column.) must be a non-empty string");
      } else {
   ...
   private void __post_161(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6619813](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-name.) must be a non-empty string");
      } else {
   ...
   private void __post_132(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6584673](.weblogic-rdbms-jar.weblogic-rdbms-bean.table-name.) must be a non-empty string");
      } else {
   ...
   private void __post_158(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6616619](.weblogic-rdbms-jar.weblogic-rdbms-relation.relation-name.) must be a non-empty string");
      } else {
   ...
   private void __post_130(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6581546](.weblogic-rdbms-jar.weblogic-rdbms-bean.ejb-name.) must be a non-empty string");
      } else {
   ...
   private void __post_164(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6623333](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.column-map.foreign-key-column.) must be a non-empty string");
      } else {
