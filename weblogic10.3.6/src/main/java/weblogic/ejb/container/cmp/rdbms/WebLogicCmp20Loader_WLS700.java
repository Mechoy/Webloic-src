...
public final class WebLogicCmp20Loader_WLS700 extends CMPDDParser implements XMLProcessor, InProcessor {
   ...
   private void __post_195(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6758640](.weblogic-rdbms-jar.create-default-dbms-tables.) must be a non-empty string");
      } else {
   ...
   private void __post_180(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6734531](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.generator-name.) must be a non-empty string");
      } else {
   ...
   private void __post_181(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6735540](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.key-cache-size.) must be a non-empty string");
      } else {
   ...
   private void __post_197(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6761051](.weblogic-rdbms-jar.database-type.) must be a non-empty string");
      } else {
         String var4;
         if ("DB2".equalsIgnoreCase(var2)) {
            ...
            if (!"DERBY".equalsIgnoreCase(var2)) {
               throw new SAXValidationException(fmt.ILLEGAL_DATABASETYPE_VALUE(var2));
            }
   ...
   private void __post_193(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6756671](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.column-map.foreign-key-column.) must be a non-empty string");
      } else {
   ...
   private void __post_168(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6718619](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.weblogic-ql.) must be a non-empty string");
      } else {
   ...
   private void __post_131(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6678522](.weblogic-rdbms-jar.weblogic-rdbms-bean.data-source-name.) must be a non-empty string");
      } else {
   ...
   private void __post_172(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6723059](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.include-updates.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6723059](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.include-updates.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_174(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6725416](.weblogic-rdbms-jar.weblogic-rdbms-bean.delay-database-insert-until.) must be a non-empty string");
         ...
         throw new SAXValidationException("PAction[6725416](.weblogic-rdbms-jar.weblogic-rdbms-bean.delay-database-insert-until.) must be one of the values: ejbCreate,ejbPostCreate,EjbCreate,EjbPostCreate,ejbcreate,ejbpostcreate,commit");
      } else {
         String var6 = null;
   ...
   private void __post_187(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6750225](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.group-name.) must be a non-empty string");
      } else {
         var3.setGroupName(var2);
      }
   }
   ...
   private void __post_160(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var11 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6710648](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.caching-element.caching-element.caching-element.caching-element.cmr-field.) must be a non-empty string");
      } else {
   ...
   private void __post_165(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6715785](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.query-method.method-name.) must be a non-empty string");
      } else {
   ...
   private void __post_170(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6720851](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.caching-name.) must be a non-empty string");
      } else {
         EjbQlQueryBean var7 = var3.getEjbQlQuery();
   ...
   private void __post_142(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6691703](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-group.group-name.) must be a non-empty string");
      } else {
         var3.setGroupName(var2);
      }
   }
   ...
   private void __post_184(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6738803](.weblogic-rdbms-jar.weblogic-rdbms-relation.table-name.) must be a non-empty string");
      } else {
         var3.setTableName(var2);
      }
   }
   ...
   private void __post_191(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6754514](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.primary-key-table.) must be a non-empty string");
      } else {
   ...
   private void __post_140(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6689573](.weblogic-rdbms-jar.weblogic-rdbms-bean.table-map.optimistic-column.) must be a non-empty string");
      } else {
   ...
   private void __post_173(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6724335](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.sql-select-distinct.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6724335](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.sql-select-distinct.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_148(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6698043](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.cmr-field.) must be a non-empty string");
      } else {
         var3.setCmrField(var2);
      }
   }
   ...
   private void __post_146(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6695871](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-name.) must be a non-empty string");
      } else {
   ...
   private void __post_196(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6760035](.weblogic-rdbms-jar.validate-db-schema-with.) must be a non-empty string");
      } else {
   ...
   private void __post_154(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var9 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6704182](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.caching-element.caching-element.cmr-field.) must be a non-empty string");
      } else {
         var3.setCmrField(var2);
      }
   }
   ...
   private void __post_171(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6721969](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.max-elements.) must be a non-empty string");
      } else {
         try {
   ...
   private void __post_179(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6732283](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.generator-type.) must be a non-empty string");
      } else {
         String var7;
   ...
   private void __post_169(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6719737](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.group-name.) must be a non-empty string");
      } else {
         EjbQlQueryBean var7 = var3.getEjbQlQuery();
   ...
   private void __post_144(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6693711](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-group.cmr-field.) must be a non-empty string");
      } else {
   ...
   private void __post_194(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6757657](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.column-map.key-column.) must be a non-empty string");
      } else {
   ...
   private void __post_143(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6692707](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-group.cmp-field.) must be a non-empty string");
      } else {
   ...
   private void __post_137(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6684157](.weblogic-rdbms-jar.weblogic-rdbms-bean.table-map.field-map.dbms-column-type.) must be a non-empty string");
      } else if (!"OracleClob".equals(var2) && !"OracleBlob".equals(var2) && !"LongString".equals(var2) && !"SybaseBinary".equals(var2)) {
         throw new SAXValidationException("PAction[6684157](.weblogic-rdbms-jar.weblogic-rdbms-bean.table-map.field-map.dbms-column-type.) must be one of the values: OracleClob,OracleBlob,LongString,SybaseBinary");
      } else {
         String var8 = var2;
   ...
   private void __post_186(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6749182](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-name.) must be a non-empty string");
      } else {
   ...
   private void __post_157(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var10 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6707450](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.caching-element.caching-element.caching-element.cmr-field.) must be a non-empty string");
      } else {
         var3.setCmrField(var2);
      }
   }
   ...
   private void __post_190(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6753488](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.foreign-key-table.) must be a non-empty string");
      } else {
   ...
   private void __post_176(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6728149](.weblogic-rdbms-jar.weblogic-rdbms-bean.lock-order.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
   ...
   private void __post_183(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6737796](.weblogic-rdbms-jar.weblogic-rdbms-relation.relation-name.) must be a non-empty string");
      } else {
   ...
   private void __post_175(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6727066](.weblogic-rdbms-jar.weblogic-rdbms-bean.use-select-for-update.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6727066](.weblogic-rdbms-jar.weblogic-rdbms-bean.use-select-for-update.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_151(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var8 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6701070](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.caching-element.cmr-field.) must be a non-empty string");
      } else {
         var3.setCmrField(var2);
      }
   }
   ...
   private void __post_130(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6676405](.weblogic-rdbms-jar.weblogic-rdbms-bean.ejb-name.) must be a non-empty string");
      } else {
   ...
   private void __post_177(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6729296](.weblogic-rdbms-jar.weblogic-rdbms-bean.check-exists-on-method.) must be a non-empty string");
      } else {
