...
public final class WebLogicCmp20Loader_WLS810 extends CMPDDParser implements XMLProcessor, InProcessor {
   private static final boolean debug = true;
   private static final boolean verbose = true;
   private static final Map paths = new HashMap();
   private ProcessorDriver driver;
   private static final String publicId = "-//BEA Systems, Inc.//DTD WebLogic 8.1.0 EJB RDBMS Persistence//EN";
   private static final String localDTDResourceName = "/weblogic/ejb/container/cmp/rdbms/weblogic-rdbms20-persistence-810.dtd";

   public ProcessorDriver getDriver() {
      return this.driver;
   }

   public WebLogicCmp20Loader_WLS810() {
      this(true);
   }

   public WebLogicCmp20Loader_WLS810(boolean var1) {
      this.driver = new ProcessorDriver(this, "-//BEA Systems, Inc.//DTD WebLogic 8.1.0 EJB RDBMS Persistence//EN", "/weblogic/ejb/container/cmp/rdbms/weblogic-rdbms20-persistence-810.dtd", var1);
   }
   ...
   private void __post_177(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6351607](.weblogic-rdbms-jar.weblogic-rdbms-bean.instance-lock-order.) must be a non-empty string");
      } else if (!"AccessOrder".equalsIgnoreCase(var2) && !"ValueOrder".equalsIgnoreCase(var2)) {
         throw new SAXValidationException(fmt.INVALID_INSTANCE_LOCK_ORDER(this.getFileName(), var4.getEjbName(), var2));
      } else {
         var4.setInstanceLockOrder(var2);
      }
   }
   ...
   private void __post_199(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6378039](.weblogic-rdbms-jar.create-default-dbms-tables.) must be a non-empty string");
      } else {
         var3.setCreateDefaultDbmsTables(var2);
      }
   }
   ...
   private void __post_205(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      String var2 = Functions.value(var1);
      CompatibilityBean var3 = (CompatibilityBean)var1.getBoundObject("compatibilityBean");
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6385494](.weblogic-rdbms-jar.compatibility.allow-readonly-create-and-remove.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6385494](.weblogic-rdbms-jar.compatibility.allow-readonly-create-and-remove.) must be one of the values: True,False,true,false");
      } else {
         var3.setAllowReadonlyCreateAndRemove("true".equalsIgnoreCase(var2));
      }
   }
   ...
   private void __post_181(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6358695](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.generator-name.) must be a non-empty string");
      } else {
   ...
   private void __post_182(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6359704](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.key-cache-size.) must be a non-empty string");
      } else {
   ...
   private void __post_202(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6381135](.weblogic-rdbms-jar.database-type.) must be a non-empty string");
      } else {
         String var4;
         if ("DB2".equalsIgnoreCase(var2)) {
            ...
            if (!"DERBY".equalsIgnoreCase(var2)) {
               throw new SAXValidationException(fmt.ILLEGAL_DATABASETYPE_VALUE_VER71(var2));
            }
   ...
   private void __post_195(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6373888](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.column-map.foreign-key-column.) must be a non-empty string");
      } else {
   ...
   private void __post_168(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6482086](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.weblogic-ql.) must be a non-empty string");
      } else {
   ...
   private void __post_131(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6767375](.weblogic-rdbms-jar.weblogic-rdbms-bean.data-source-name.) must be a non-empty string");
      } else {
   ...
   private void __post_194(ProcessingContext var1) throws SAXProcessorException {
   ...
   private void __post_172(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6486522](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.include-updates.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6486522](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.include-updates.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_174(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6347704](.weblogic-rdbms-jar.weblogic-rdbms-bean.delay-database-insert-until.) must be a non-empty string");
         ...
         throw new SAXValidationException("PAction[6347704](.weblogic-rdbms-jar.weblogic-rdbms-bean.delay-database-insert-until.) must be one of the values: ejbCreate,ejbPostCreate,EjbCreate,EjbPostCreate,ejbcreate,ejbpostcreate,commit");
      } else {
         String var6 = null;
         if ("ejbcreate".equalsIgnoreCase(var2)) {
            var6 = "ejbCreate";
         } else if ("commit".equalsIgnoreCase(var2)) {
            log.logWarning(fmt.COMMIT_OPTION_FOR_delayDatabaseInsertUntil_IGNORED());
            var6 = "ejbPostCreate";
         } else {
            var6 = "ejbPostCreate";
         }
   ...
   private void __post_189(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6367656](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.group-name.) must be a non-empty string");
      } else {
         var3.setGroupName(var2);
      }
   }
   ...
   private void __post_160(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var11 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6799904](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.caching-element.caching-element.caching-element.caching-element.cmr-field.) must be a non-empty string");
      } else {
   ...
   private void __post_165(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6805042](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.query-method.method-name.) must be a non-empty string");
      } else {
   ...
   private void __post_170(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6484315](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.caching-name.) must be a non-empty string");
      } else {
         EjbQlQueryBean var7 = var3.getEjbQlQuery();
   ...
   private void __post_142(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6780940](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-group.group-name.) must be a non-empty string");
      } else {
         var3.setGroupName(var2);
      }
   }
   ...
   private void __post_186(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6364169](.weblogic-rdbms-jar.weblogic-rdbms-relation.table-name.) must be a non-empty string");
      } else {
         var3.setTableName(var2);
      }
   }
   ...
   private void __post_200(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6379058](.weblogic-rdbms-jar.default-dbms-tables-ddl.) must be a non-empty string");
      } else {
         var3.setDefaultDbmsTablesDdl(var2);
      }
   }
   ...
   private void __post_193(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6371731](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.primary-key-table.) must be a non-empty string");
      } else {
   ...
   private void __post_197(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6375857](.weblogic-rdbms-jar.order-database-operations.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6375857](.weblogic-rdbms-jar.order-database-operations.) must be one of the values: True,False,true,false");
      } else {
         var3.setOrderDatabaseOperations("true".equalsIgnoreCase(var2));
      }
   }
   ...
   private void __post_183(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6360801](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.select-first-sequence-key-before-update.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6360801](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.select-first-sequence-key-before-update.) must be one of the values: True,False,true,false");
      } else {
         boolean var7 = "true".equalsIgnoreCase(var2);
         var3.setSelectFirstSequenceKeyBeforeUpdate(var7);
      }
   }
   ...
   private void __post_140(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6778811](.weblogic-rdbms-jar.weblogic-rdbms-bean.table-map.optimistic-column.) must be a non-empty string");
      } else {
   ...
   private void __post_173(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6487761](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.sql-select-distinct.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6487761](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.sql-select-distinct.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_148(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6787288](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.cmr-field.) must be a non-empty string");
      } else {
         var3.setCmrField(var2);
      }
   }
   ...
   private void __post_146(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6785116](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-name.) must be a non-empty string");
      } else {
   ...
   private void __post_201(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6380084](.weblogic-rdbms-jar.validate-db-schema-with.) must be a non-empty string");
      } else if (!"TableQuery".equals(var2) && !"MetaData".equals(var2)) {
         throw new SAXValidationException("PAction[6380084](.weblogic-rdbms-jar.validate-db-schema-with.) must be one of the values: TableQuery,MetaData");
      } else {
   ...
   private void __post_154(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var9 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6793423](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.caching-element.caching-element.cmr-field.) must be a non-empty string");
      } else {
         var3.setCmrField(var2);
      }
   }
   ...
   private void __post_171(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6485432](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.max-elements.) must be a non-empty string");
      } else {
         try {
   ...
   private void __post_206(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6386671](.weblogic-rdbms-jar.compatibility.load-related-beans-from-db-in-post-create.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6386671](.weblogic-rdbms-jar.compatibility.load-related-beans-from-db-in-post-create.) must be one of the values: True,False,true,false");
      } else {
         var3.setLoadRelatedBeansFromDbInPostCreate("true".equalsIgnoreCase(var2));
      }
   }
   ...
   private void __post_180(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6356288](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.generator-type.) must be a non-empty string");
      } else {
         String var7;
         if ("Oracle".equalsIgnoreCase(var2)) {
            var7 = "Sequence";
            var6.setDatabaseType("Oracle");
         } else if ("DB2".equalsIgnoreCase(var2)) {
            var7 = "Sequence";
            var6.setDatabaseType("DB2");
         } else if ("Informix".equalsIgnoreCase(var2)) {
            var7 = "Sequence";
            var6.setDatabaseType("Informix");
            ...
            if (!"SQLServer2000".equalsIgnoreCase(var2) && !"SQL_SERVER_2000".equalsIgnoreCase(var2)) {
               if (!"NAMED_SEQUENCE_TABLE".equalsIgnoreCase(var2) && !"NamedSequenceTable".equalsIgnoreCase(var2)) {
                  throw new SAXValidationException(fmt.ILLEGAL_AUTOKEY_GENERATOR_VALUE(this.getFileName(), var5.getEjbName(), var2));
               }
   ...
   private void __post_169(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6483202](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.group-name.) must be a non-empty string");
      } else {
         EjbQlQueryBean var7 = var3.getEjbQlQuery();
   ...
   private void __post_144(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6782956](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-group.cmr-field.) must be a non-empty string");
      } else {
   ...
   private void __pre_203(ProcessingContext var1) {
      Object var2 = null;
      var1.addBoundObject(var2, "compatibilityBean");
   }

   private void __post_203(ProcessingContext var1) throws SAXProcessorException {
      CompatibilityBean var2 = (CompatibilityBean)var1.getBoundObject("compatibilityBean");
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      this.addBoundObject(var3.createCompatibility(), "compatibilityBean");
   }
   ...
   private void __post_196(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6374874](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.column-map.key-column.) must be a non-empty string");
      } else {
   ...
   private void __post_143(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6781952](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-group.cmp-field.) must be a non-empty string");
      } else {
   ...
   private void __post_198(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6376948](.weblogic-rdbms-jar.enable-batch-operations.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6376948](.weblogic-rdbms-jar.enable-batch-operations.) must be one of the values: True,False,true,false");
      } else {
         var3.setEnableBatchOperations("true".equalsIgnoreCase(var2));
      }
   }
   ...
   private void __post_137(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6773014](.weblogic-rdbms-jar.weblogic-rdbms-bean.table-map.field-map.dbms-column-type.) must be a non-empty string");
      } else if (!"OracleClob".equals(var2) && !"OracleBlob".equals(var2) && !"NClob".equals(var2) && !"NChar".equals(var2) && !"NVarchar2".equals(var2) && !"LongString".equals(var2) && !"SybaseBinary".equals(var2) && !"SQLXML".equals(var2)) {
         throw new SAXValidationException("PAction[6773014](.weblogic-rdbms-jar.weblogic-rdbms-bean.table-map.field-map.dbms-column-type.) must be one of the values: OracleClob,OracleBlob,NClob,NChar,NVarchar2,LongString,SybaseBinary,SQLXML");
      } else {
         String var8 = var2;
         if (var2.equals("OracleBlob")) {
            ...
            var7.setDatabaseType("Oracle");
            var8 = "NClob";
         } else if (var2.equals("NChar")) {
            var7.setDatabaseType("Oracle");
            var8 = "NChar";
         } else if (var2.equals("NVarchar2")) {
            var7.setDatabaseType("Oracle");
            var8 = "NVarchar2";
         }
   ...
   private void __post_188(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6366355](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-name.) must be a non-empty string");
      } else {
   ...
   private void __post_157(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var10 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6796691](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.caching-element.caching-element.caching-element.cmr-field.) must be a non-empty string");
      } else {
         var3.setCmrField(var2);
      }
   }
   ...
   private void __post_192(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6370704](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.foreign-key-table.) must be a non-empty string");
      } else {
   ...
   private void __post_176(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6350461](.weblogic-rdbms-jar.weblogic-rdbms-bean.lock-order.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
   ...
   private void __post_204(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6384323](.weblogic-rdbms-jar.compatibility.serialize-byte-array-to-oracle-blob.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6384323](.weblogic-rdbms-jar.compatibility.serialize-byte-array-to-oracle-blob.) must be one of the values: True,False,true,false");
      } else {
         var3.setSerializeByteArrayToOracleBlob("true".equalsIgnoreCase(var2));
      }
   }
   ...
   private void __post_185(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6363160](.weblogic-rdbms-jar.weblogic-rdbms-relation.relation-name.) must be a non-empty string");
      } else {
   ...
   private void __post_175(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6349378](.weblogic-rdbms-jar.weblogic-rdbms-bean.use-select-for-update.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6349378](.weblogic-rdbms-jar.weblogic-rdbms-bean.use-select-for-update.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_151(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var8 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6790311](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.caching-element.cmr-field.) must be a non-empty string");
      } else {
         var3.setCmrField(var2);
      }
   }
   ...
   private void __post_130(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6765257](.weblogic-rdbms-jar.weblogic-rdbms-bean.ejb-name.) must be a non-empty string");
      } else {
   ...
   private void __post_178(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6353434](.weblogic-rdbms-jar.weblogic-rdbms-bean.check-exists-on-method.) must be a non-empty string");
      } else {
         if ("true".equalsIgnoreCase(var2)) {
            var4.setCheckExistsOnMethod(true);
         } else {
            if (!"false".equalsIgnoreCase(var2)) {
               throw new SAXValidationException(fmt.ILLEGAL_VALUE_FOR_CHECK_EXISTS(this.getFileName(), var4.getEjbName(), var2));
            }
   ...
   static {
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-bean.instance-lock-order.", new Integer(177));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-bean.", new Integer(129));
      paths.put(".weblogic-rdbms-jar.create-default-dbms-tables.", new Integer(199));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-relation.", new Integer(184));
      paths.put(".weblogic-rdbms-jar.compatibility.allow-readonly-create-and-remove.", new Integer(205));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.generator-name.", new Integer(181));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.", new Integer(145));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.key-cache-size.", new Integer(182));
      paths.put(".weblogic-rdbms-jar.database-type.", new Integer(202));
      ...
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.column-map.foreign-key-column.", new Integer(195));
      ...
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.column-map.", new Integer(194));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.", new Integer(187));
      ...
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.db-cascade-delete.", new Integer(190));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.group-name.", new Integer(189));
      ...
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-relation.table-name.", new Integer(186));
      ...
      paths.put(".weblogic-rdbms-jar.default-dbms-tables-ddl.", new Integer(200));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.primary-key-table.", new Integer(193));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-bean.table-map.", new Integer(132));
      paths.put(".weblogic-rdbms-jar.order-database-operations.", new Integer(197));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.select-first-sequence-key-before-update.", new Integer(183));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-bean.table-map.optimistic-column.", new Integer(140));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.", new Integer(191));
      ...
      paths.put(".weblogic-rdbms-jar.validate-db-schema-with.", new Integer(201));
      ...
      paths.put(".weblogic-rdbms-jar.compatibility.load-related-beans-from-db-in-post-create.", new Integer(206));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.query-method.method-params.method-param.", new Integer(167));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.generator-type.", new Integer(180));
      ...
      paths.put(".weblogic-rdbms-jar.compatibility.", new Integer(203));
      ...
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.column-map.key-column.", new Integer(196));
      ...
      paths.put(".weblogic-rdbms-jar.enable-batch-operations.", new Integer(198));
      ...
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-name.", new Integer(188));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.", new Integer(179));
      ...
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.foreign-key-table.", new Integer(192));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-bean.lock-order.", new Integer(176));
      paths.put(".weblogic-rdbms-jar.compatibility.serialize-byte-array-to-oracle-blob.", new Integer(204));
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-relation.relation-name.", new Integer(185));
      ...
      paths.put(".weblogic-rdbms-jar.weblogic-rdbms-bean.check-exists-on-method.", new Integer(178));
   }
}
