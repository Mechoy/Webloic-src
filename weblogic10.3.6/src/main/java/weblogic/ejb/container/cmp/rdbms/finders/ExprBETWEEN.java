...
public class ExprBETWEEN extends BaseExpr implements Expr, ExpressionTypes {
   private int dbType = 0;
   private String ejbqlId;
   private String dealiasedEjbqlId;
   private Expr term1_clone = null;

   protected ExprBETWEEN(int var1, Expr var2, Expr var3, Expr var4) {
      super(var1, var2, var3, var4);
      this.debugClassName = "ExprBETWEEN  ";
   }
   ...
   protected Expr invertForNOT() throws ErrorCollectionException {
      ExprNOT_BETWEEN var1 = new ExprNOT_BETWEEN(77, this.term1, this.term2, this.term3);
      var1.setPreEJBQLFrom(this);
      var1.setMainEJBQL("NOT BETWEEN ");
