...
public final class ExprCORR_FOR extends BaseExpr implements Expr, ExpressionTypes {
   protected ExprCORR_FOR(int var1, Expr var2, Expr var3, String var4) {
   ...
   public void init_method() throws ErrorCollectionException {
      ...
      if (debugLogger.isDebugEnabled()) {
         debug("+++ SQLExp: processing old style 'loc FOR employee.loc' Correlation var: " + var3 + "  :  " + var4);
      }

      String var5 = this.globalContext.replaceIdAliases(var4);
      if (debugLogger.isDebugEnabled()) {
         debug("+++ SQLExp: set Correlation var: " + var3 + "  :  " + var5);
      }
   ...
   private static void debug(String var0) {
      debugLogger.debug("[ExprCORR_FOR] " + var0);
   }
}
