...
public final class WebLogicCmp11Loader_WLS510 extends CMPDDParser implements XMLProcessor, InProcessor {
   ...
   private void __post_129(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5940488](.weblogic-rdbms-bean.pool-name.) must be a non-empty string");
      } else {
   ...
   private void __post_131(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5943449](.weblogic-rdbms-bean.table-name.) must be a non-empty string");
      } else {
   ...
   private void __post_130(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5942467](.weblogic-rdbms-bean.schema-name.) must be a non-empty string");
      } else {
         var3.setTableName(var2);
      }
   }
   ...
   private void __post_134(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5946892](.weblogic-rdbms-bean.attribute-map.object-link.dbms-column.) must be a non-empty string");
      } else {
   ...
   private void __post_133(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5945871](.weblogic-rdbms-bean.attribute-map.object-link.bean-field.) must be a non-empty string");
      } else {
   ...
   private void __post_137(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5950077](.weblogic-rdbms-bean.finder-list.finder.method-params.method-param.) must be a non-empty string");
      } else {
   ...
   private void __post_136(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5949057](.weblogic-rdbms-bean.finder-list.finder.method-name.) must be a non-empty string");
      } else {
   ...
   private void __post_145(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6008001](.weblogic-rdbms-bean.options.transaction-isolation.) must be a non-empty string");
         ...
         throw new SAXValidationException("PAction[6008001](.weblogic-rdbms-bean.options.transaction-isolation.) must be one of the values: TRANSACTION_SERIALIZABLE,TRANSACTION_READ_COMMITTED,TRANSACTION_READ_UNCOMMITTED,TRANSACTION_REPEATABLE_READ");
      } else {
         Integer var6 = null;
