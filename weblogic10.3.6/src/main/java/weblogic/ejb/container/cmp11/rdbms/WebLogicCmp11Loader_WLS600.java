...
public final class WebLogicCmp11Loader_WLS600 extends CMPDDParser implements XMLProcessor, InProcessor {
   ...
   private void __post_138(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5936114](.weblogic-rdbms-jar.weblogic-rdbms-bean.finder.finder-name.) must be a non-empty string");
      } else {
   ...
   private void __post_144(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5944778](.weblogic-rdbms-jar.create-default-dbms-tables.) must be a non-empty string");
      } else {
   ...
   private void __post_136(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5933991](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-map.dbms-column.) must be a non-empty string");
      } else {
   ...
   private void __post_139(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5937125](.weblogic-rdbms-jar.weblogic-rdbms-bean.finder.finder-param.) must be a non-empty string");
      } else {
   ...
   private void __post_145(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5945992](.weblogic-rdbms-jar.validate-db-schema-with.) must be a non-empty string");
      } else {
   ...
   private void __post_131(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5928896](.weblogic-rdbms-jar.weblogic-rdbms-bean.pool-name.) must be a non-empty string");
      } else {
   ...
   private void __post_146(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5947008](.weblogic-rdbms-jar.database-type.) must be a non-empty string");
      } else if (!"DB2".equalsIgnoreCase(var2) && !"ORACLE".equalsIgnoreCase(var2) && !"SYBASE".equalsIgnoreCase(var2) && !"INFORMIX".equalsIgnoreCase(var2) && !"POINTBASE".equalsIgnoreCase(var2) && !"MYSQL".equalsIgnoreCase(var2) && !"SQL_SERVER".equalsIgnoreCase(var2) && !"SQLSERVER".equalsIgnoreCase(var2)) {
   ...
   private void __post_143(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5941179](.weblogic-rdbms-jar.weblogic-rdbms-bean.enable-tuned-updates.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[5941179](.weblogic-rdbms-jar.weblogic-rdbms-bean.enable-tuned-updates.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_133(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5930888](.weblogic-rdbms-jar.weblogic-rdbms-bean.table-name.) must be a non-empty string");
      } else {
   ...
   private void __post_132(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5929878](.weblogic-rdbms-jar.weblogic-rdbms-bean.data-source-name.) must be a non-empty string");
      } else {
   ...
   private void __post_135(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5932987](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-map.cmp-field.) must be a non-empty string");
      } else {
   ...
   private void __post_130(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5926824](.weblogic-rdbms-jar.weblogic-rdbms-bean.ejb-name.) must be a non-empty string");
      } else {
