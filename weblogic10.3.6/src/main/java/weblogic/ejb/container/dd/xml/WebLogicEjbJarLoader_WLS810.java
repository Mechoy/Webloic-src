...
public final class WebLogicEjbJarLoader_WLS810 extends DDLoader implements XMLProcessor, InProcessor {
   ...
   private void __post_131(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6800158](.weblogic-ejb-jar.weblogic-enterprise-bean.ejb-name.) must be a non-empty string");
      } else {
   ...
   private void __post_217(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6431890](.weblogic-ejb-jar.weblogic-enterprise-bean.iiop-security-descriptor.client-authentication.) must be a non-empty string");
      } else {
   ...
   private void __post_187(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6398407](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.stateless-clustering.stateless-bean-load-algorithm.) must be a non-empty string");
   ...
   private void __post_200(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6413491](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.home-is-clusterable.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6413491](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.home-is-clusterable.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_253(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6472201](.weblogic-ejb-jar.idempotent-methods.method.method-intf.) must be a non-empty string");
      } else if (!"home".equals(var2) && !"Home".equals(var2) && !"remote".equals(var2) && !"Remote".equals(var2)) {
         throw new SAXValidationException("PAction[6472201](.weblogic-ejb-jar.idempotent-methods.method.method-intf.) must be one of the values: home,Home,remote,Remote");
      } else {
         String var6 = var2;
   ...
   private void __post_264(ProcessingContext var1) throws SAXProcessorException {
      String var2 = Functions.value(var1);
   ...
   private void __post_179(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6389497](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.pool.max-beans-in-free-pool.) must be a non-empty string");
      } else {
         try {
   ...
   private void __post_218(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6432909](.weblogic-ejb-jar.weblogic-enterprise-bean.iiop-security-descriptor.identity-assertion.) must be a non-empty string");
      } else {
   ...
   private void __post_254(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      String var2 = Functions.value(var1);
      MethodBean var3 = (MethodBean)var1.getBoundObject("method");
      IdempotentMethodsBean var4 = (IdempotentMethodsBean)var1.getBoundObject("idemp");
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6473510](.weblogic-ejb-jar.idempotent-methods.method.method-name.) must be a non-empty string");
      } else {
   ...
   private void __post_156(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6363884](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache-ref.read-timeout-seconds.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
         } catch (Exception var8) {
   ...
   private void __post_216(ProcessingContext var1) throws SAXProcessorException {
      ...
      WeblogicEnterpriseBeanBean var3 = (WeblogicEnterpriseBeanBean)var1.getBoundObject("wlBean");
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      this.addBoundObject(var3.createIiopSecurityDescriptor(), "iiopd");
   }
   ...
   private void __post_189(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6400881](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.stateless-clustering.stateless-bean-methods-are-idempotent.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6400881](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.stateless-clustering.stateless-bean-methods-are-idempotent.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_195(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6408057](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-cache.cache-type.) must be a non-empty string");
      } else if (!"NRU".equals(var2) && !"LRU".equals(var2)) {
         throw new SAXValidationException("PAction[6408057](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-cache.cache-type.) must be one of the values: NRU,LRU");
      } else {
   ...
   private void __post_201(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6414584](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.home-load-algorithm.) must be a non-empty string");
      } else if (!"roundrobin".equals(var2) && !"RoundRobin".equals(var2) && !"round-robin".equals(var2) && !"random".equals(var2) && !"Random".equals(var2) && !"weightbased".equals(var2) && !"WeightBased".equals(var2) && !"weight-based".equals(var2) && !"RoundRobinAffinity".equals(var2) && !"round-robin-affinity".equals(var2) && !"RandomAffinity".equals(var2) && !"random-affinity".equals(var2) && !"WeightBasedAffinity".equals(var2) && !"weight-based-affinity".equals(var2)) {
         throw new SAXValidationException("PAction[6414584](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.home-load-algorithm.) must be one of the values: roundrobin,RoundRobin,round-robin,random,Random,weightbased,WeightBased,weight-based,RoundRobinAffinity,round-robin-affinity,RandomAffinity,random-affinity,WeightBasedAffinity,weight-based-affinity");
      } else {
   ...
   private void __post_262(ProcessingContext var1) throws SAXProcessorException {
   ...
   private void __post_151(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6358226](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache.concurrency-strategy.) must be a non-empty string");
      } else {
         try {
   ...
   private void __post_166(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6375276](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.persistence.persistence-use.type-identifier.) must be a non-empty string");
      } else {
   ...
   private void __post_167(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var7 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6376258](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.persistence.persistence-use.type-version.) must be a non-empty string");
      } else {
   ...
   private void __post_146(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6352641](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.pool.max-beans-in-free-pool.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
         } catch (Exception var8) {
   ...
   private void __post_197(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6410113](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.allow-concurrent-calls.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6410113](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.allow-concurrent-calls.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_183(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6393907](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.stateless-clustering.use-serverside-stubs.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6393907](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.stateless-clustering.use-serverside-stubs.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_245(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6462975](.weblogic-ejb-jar.transaction-isolation.method.method-intf.) must be a non-empty string");
         ...
         throw new SAXValidationException("PAction[6462975](.weblogic-ejb-jar.transaction-isolation.method.method-intf.) must be one of the values: home,Home,remote,Remote,LocalHome,localHome,localhome,local,Local");
      } else {
         String var6 = var2;
         if ("home".equalsIgnoreCase(var2)) {
            var6 = "Home";
   ...
   private void __post_176(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6386039](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.enable-dynamic-queries.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6386039](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.enable-dynamic-queries.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_141(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6347341](.weblogic-ejb-jar.weblogic-enterprise-bean.passivate-as-principal-name.) must be a non-empty string");
      } else {
   ...
   private void __post_160(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6368737](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache-ref.idle-timeout-seconds.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
         } catch (Exception var8) {
   ...
   private void __post_133(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6479405](.weblogic-ejb-jar.weblogic-enterprise-bean.dispatch-policy.) must be a non-empty string");
      } else {
   ...
   private void __post_220(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6435081](.weblogic-ejb-jar.weblogic-enterprise-bean.iiop-security-descriptor.transport-requirements.integrity.) must be a non-empty string");
      } else {
   ...
   private void __post_235(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6451361](.weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.ejb-local-reference-description.ejb-ref-name.) must be a non-empty string");
      } else {
   ...
   private void __post_258(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      String var2 = Functions.value(var1);
      SecurityRoleAssignmentBean var3 = (SecurityRoleAssignmentBean)var1.getBoundObject("sra");
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6477610](.weblogic-ejb-jar.security-role-assignment.role-name.) must be a non-empty string");
      } else {
   ...
   private void __post_154(ProcessingContext var1) throws SAXProcessorException {
      ...
      WeblogicEnterpriseBeanBean var4 = (WeblogicEnterpriseBeanBean)var1.getBoundObject("wlBean");
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      this.addBoundObject(var3.createEntityCacheRef(), "cacheRef");
   }
   ...
   private void __post_135(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6481508](.weblogic-ejb-jar.weblogic-enterprise-bean.remote-client-timeout.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
   ...
   private void __post_136(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6482632](.weblogic-ejb-jar.weblogic-enterprise-bean.clients-on-same-server.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6482632](.weblogic-ejb-jar.weblogic-enterprise-bean.clients-on-same-server.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_192(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6404699](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-cache.max-beans-in-cache.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
         } catch (Exception var8) {
   ...
   private void __post_265(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var3 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6493279](.weblogic-ejb-jar.enable-bean-class-redeploy.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[6493279](.weblogic-ejb-jar.enable-bean-class-redeploy.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_159(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6367616](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache-ref.estimated-bean-size.) must be a non-empty string");
      } else {
         try {
   ...
   private void __post_182(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6392880](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.stateless-clustering.home-call-router-class-name.) must be a non-empty string");
      } else {
   ...
   private void __post_170(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6379387](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-clustering.home-is-clusterable.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6379387](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-clustering.home-is-clusterable.) must be one of the values: true,True,false,False");
      } else {
         var3.setHomeIsClusterable("True".equalsIgnoreCase(var2));
      }
   }
   ...
   private void __post_147(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6353767](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.pool.initial-beans-in-free-pool.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
         } catch (Exception var8) {
   ...
   private void __post_137(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6483722](.weblogic-ejb-jar.weblogic-enterprise-bean.run-as-identity-principal.) must be a non-empty string");
      } else {
         var3.setRunAsPrincipalName(var2);
      }
   }
   ...
   private void __post_221(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6436065](.weblogic-ejb-jar.weblogic-enterprise-bean.iiop-security-descriptor.transport-requirements.confidentiality.) must be a non-empty string");
      } else {
   ...
   private void __post_157(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6365133](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache-ref.concurrency-strategy.) must be a non-empty string");
      } else {
         try {
            this.validateConcurrencyStrategy(var2);
         } catch (Exception var8) {
   ...
   private void __post_211(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6425397](.weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.pool.max-beans-in-free-pool.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
         } catch (Exception var8) {
   ...
   private void __post_208(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6422264](.weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.jms-client-id.) must be a non-empty string");
      } else {
   ...
   private void __post_213(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6427662](.weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.initial-context-factory.) must be a non-empty string");
      } else {
   ...
   private void __post_143(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6349368](.weblogic-ejb-jar.weblogic-enterprise-bean.local-jndi-name.) must be a non-empty string");
      } else {
   ...
   private void __post_226(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6441806](.weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.resource-description.res-ref-name.) must be a non-empty string");
      } else {
   ...
   private void __post_173(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6382657](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-clustering.use-serverside-stubs.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6382657](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-clustering.use-serverside-stubs.) must be one of the values: true,True,false,False");
      } else {
         var3.setUseServersideStubs("True".equalsIgnoreCase(var2));
      }
   }
   ...
   private void __post_203(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6416776](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.use-serverside-stubs.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6416776](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.use-serverside-stubs.) must be one of the values: true,True,false,False");
      } else {
         var3.setUseServersideStubs("True".equalsIgnoreCase(var2));
      }
   }
   ...
   private void __post_204(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6417868](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.replication-type.) must be a non-empty string");
      } else if (!"none".equals(var2) && !"None".equals(var2) && !"inmemory".equals(var2) && !"InMemory".equals(var2)) {
         throw new SAXValidationException("PAction[6417868](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.replication-type.) must be one of the values: none,None,inmemory,InMemory");
      } else {
   ...
   private void __post_207(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6421206](.weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.jms-polling-interval-seconds.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
   ...
   private void __post_212(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6426527](.weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.pool.initial-beans-in-free-pool.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
         } catch (Exception var8) {
   ...
   private void __post_185(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6396166](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.stateless-clustering.stateless-bean-is-clusterable.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6396166](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.stateless-clustering.stateless-bean-is-clusterable.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_134(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6480420](.weblogic-ejb-jar.weblogic-enterprise-bean.stick-to-first-server.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6480420](.weblogic-ejb-jar.weblogic-enterprise-bean.stick-to-first-server.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_222(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6437082](.weblogic-ejb-jar.weblogic-enterprise-bean.iiop-security-descriptor.transport-requirements.client-cert-authentication.) must be a non-empty string");
      } else {
   ...
   private void __post_198(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6411205](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.allow-remove-during-transaction.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6411205](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.allow-remove-during-transaction.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_132(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6802254](.weblogic-ejb-jar.weblogic-enterprise-bean.enable-call-by-reference.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6802254](.weblogic-ejb-jar.weblogic-enterprise-bean.enable-call-by-reference.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_138(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6484743](.weblogic-ejb-jar.weblogic-enterprise-bean.run-as-principal-name.) must be a non-empty string");
      } else {
         var3.setRunAsPrincipalName(var2);
      }
   }
   ...
   private void __post_152(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6359476](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache.cache-between-transactions.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6359476](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache.cache-between-transactions.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_244(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6461878](.weblogic-ejb-jar.transaction-isolation.method.ejb-name.) must be a non-empty string");
      } else {
         var3.setEjbName(var2.replace('/', '.'));
      }
   }
   ...
   private void __post_188(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6399581](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.stateless-clustering.stateless-bean-call-router-class-name.) must be a non-empty string");
      } else {
   ...
   private void __post_232(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6448160](.weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.ejb-reference-description.ejb-ref-name.) must be a non-empty string");
      } else {
         var3.setEjbRefName(var2);
      }
   }
   ...
   private void __post_186(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6397271](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.pool.initial-beans-in-free-pool.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
         } catch (Exception var8) {
   ...
   private void __post_168(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var7 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6377238](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.persistence.persistence-use.type-storage.) must be a non-empty string");
      } else {
   ...
   private void __post_230(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      String var2 = Functions.value(var1);
      ResourceEnvDescriptionBean var3 = (ResourceEnvDescriptionBean)var1.getBoundObject("resEnvDesc");
      WeblogicEnterpriseBeanBean var4 = (WeblogicEnterpriseBeanBean)var1.getBoundObject("wlBean");
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6445981](.weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.resource-env-description.jndi-name.) must be a non-empty string");
      } else {
   ...
   private void __post_227(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6442811](.weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.resource-description.jndi-name.) must be a non-empty string");
      } else {
         var3.setJNDIName(var2);
      }
   }
   ...
   private void __post_140(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6486784](.weblogic-ejb-jar.weblogic-enterprise-bean.remove-as-principal-name.) must be a non-empty string");
      } else {
   ...
   private void __post_149(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6356019](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache.max-beans-in-cache.) must be a non-empty string");
      } else {
         try {
            this.validateIntegerGreaterThanZero(var2);
         } catch (Exception var8) {
   ...
   private void __post_252(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6470591](.weblogic-ejb-jar.idempotent-methods.method.ejb-name.) must be a non-empty string");
      } else {
         var3.setEjbName(var2.replace('/', '.'));
      }
   }
   ...
   private void __post_194(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6406936](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-cache.session-timeout-seconds.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
         } catch (Exception var8) {
   ...
   private void __post_202(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6415745](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.home-call-router-class-name.) must be a non-empty string");
      } else {
         var3.setHomeCallRouterClassName(var2);
      }
   }
   ...
   private void __post_153(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6360601](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache.read-timeout-seconds.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
         } catch (Exception var8) {
   ...
   private void __post_243(ProcessingContext var1) throws SAXProcessorException {
      String var2 = Functions.value(var1);
      MethodBean var3 = (MethodBean)var1.getBoundObject("method");
      TransactionIsolationBean var4 = (TransactionIsolationBean)var1.getBoundObject("tiso");
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
   ...
   private void __post_206(ProcessingContext var1) throws SAXProcessorException {
   ...
   private void __post_184(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6394996](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.stateless-clustering.home-load-algorithm.) must be a non-empty string");
      } else if (!"roundrobin".equals(var2) && !"RoundRobin".equals(var2) && !"round-robin".equals(var2) && !"random".equals(var2) && !"Random".equals(var2) && !"weightbased".equals(var2) && !"WeightBased".equals(var2) && !"weight-based".equals(var2) && !"RoundRobinAffinity".equals(var2) && !"round-robin-affinity".equals(var2) && !"RandomAffinity".equals(var2) && !"random-affinity".equals(var2) && !"WeightBasedAffinity".equals(var2) && !"weight-based-affinity".equals(var2)) {
         throw new SAXValidationException("PAction[6394996](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.stateless-clustering.home-load-algorithm.) must be one of the values: roundrobin,RoundRobin,round-robin,random,Random,weightbased,WeightBased,weight-based,RoundRobinAffinity,round-robin-affinity,RandomAffinity,random-affinity,WeightBasedAffinity,weight-based-affinity");
      } else {
         var3.setHomeLoadAlgorithm(var2);
      }
   }
   ...
   private void __post_139(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6485763](.weblogic-ejb-jar.weblogic-enterprise-bean.create-as-principal-name.) must be a non-empty string");
      } else {
   ...
   private void __post_229(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6444961](.weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.resource-env-description.res-env-ref-name.) must be a non-empty string");
      } else {
   ...
   private void __post_181(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6391789](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.stateless-clustering.home-is-clusterable.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6391789](.weblogic-ejb-jar.weblogic-enterprise-bean.stateless-session-descriptor.stateless-clustering.home-is-clusterable.) must be one of the values: true,True,false,False");
      } else {
         var3.setHomeIsClusterable("True".equalsIgnoreCase(var2));
      }
   }
   ...
   private void __post_171(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6380475](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-clustering.home-load-algorithm.) must be a non-empty string");
      } else if (!"roundrobin".equals(var2) && !"RoundRobin".equals(var2) && !"round-robin".equals(var2) && !"random".equals(var2) && !"Random".equals(var2) && !"weightbased".equals(var2) && !"WeightBased".equals(var2) && !"weight-based".equals(var2) && !"RoundRobinAffinity".equals(var2) && !"round-robin-affinity".equals(var2) && !"RandomAffinity".equals(var2) && !"random-affinity".equals(var2) && !"WeightBasedAffinity".equals(var2) && !"weight-based-affinity".equals(var2)) {
         throw new SAXValidationException("PAction[6380475](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-clustering.home-load-algorithm.) must be one of the values: roundrobin,RoundRobin,round-robin,random,Random,weightbased,WeightBased,weight-based,RoundRobinAffinity,round-robin-affinity,RandomAffinity,random-affinity,WeightBasedAffinity,weight-based-affinity");
      } else {
         var3.setHomeLoadAlgorithm(var2);
      }
   }
   ...
   private void __post_163(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6372002](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.persistence.delay-updates-until-end-of-tx.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6372002](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.persistence.delay-updates-until-end-of-tx.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_214(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6428687](.weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.provider-url.) must be a non-empty string");
      } else {
         var3.setProviderUrl(var2);
      }
   }

   private void __pre_266(ProcessingContext var1) {
   }

   private void __post_266(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      String var2 = Functions.value(var1);
      WeblogicEjbJarBean var3 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6494367](.weblogic-ejb-jar.disable-warning.) must be a non-empty string");
         ...
         throw new SAXValidationException("PAction[6494367](.weblogic-ejb-jar.disable-warning.) must be one of the values: BEA-010054,BEA-010202,BEA-010001,BEA-010200,BEA-012034");
      } else {
   ...
   private void __post_155(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6362868](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache-ref.entity-cache-name.) must be a non-empty string");
      } else {
   ...
   private void __post_150(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6357111](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache.idle-timeout-seconds.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
         } catch (Exception var8) {
   ...
   private void __post_175(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6384918](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.invalidation-target.ejb-name.) must be a non-empty string");
      } else {
         var3.setEjbName(var2.replace('/', '.'));
      }
   }
   ...
   private void __post_162(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6370980](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.persistence.is-modified-method-name.) must be a non-empty string");
      } else {
   ...
   private void __post_233(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      String var2 = Functions.value(var1);
      EjbReferenceDescriptionBean var3 = (EjbReferenceDescriptionBean)var1.getBoundObject("ejbRefDesc");
      WeblogicEnterpriseBeanBean var4 = (WeblogicEnterpriseBeanBean)var1.getBoundObject("wlBean");
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6449172](.weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.ejb-reference-description.jndi-name.) must be a non-empty string");
      } else {
         var3.setJNDIName(var2);
      }
   }
   ...
   private void __post_172(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6381631](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-clustering.home-call-router-class-name.) must be a non-empty string");
      } else {
         var3.setHomeCallRouterClassName(var2);
      }
   }
   ...
   private void __post_215(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6429698](.weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.connection-factory-jndi-name.) must be a non-empty string");
      } else {
   ...
   private void __post_263(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      String var2 = Functions.value(var1);
      RunAsRoleAssignmentBean var3 = (RunAsRoleAssignmentBean)var1.getBoundObject("rara");
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6491509](.weblogic-ejb-jar.run-as-role-assignment.role-name.) must be a non-empty string");
      } else {
         var3.setRoleName(var2);
      }
   }
   ...
   private void __post_209(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6423273](.weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.destination-jndi-name.) must be a non-empty string");
      } else {
   ...
   private void __post_224(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6439262](.weblogic-ejb-jar.weblogic-enterprise-bean.transaction-descriptor.trans-timeout-seconds.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
         } catch (Exception var7) {
   ...
   private void __post_219(ProcessingContext var1) throws SAXProcessorException {
      ...
      WeblogicEnterpriseBeanBean var4 = (WeblogicEnterpriseBeanBean)var1.getBoundObject("wlBean");
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      this.addBoundObject(var3.createTransportRequirements(), "trd");
   }
   ...
   private void __post_236(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6452380](.weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.ejb-local-reference-description.jndi-name.) must be a non-empty string");
      } else {
         var3.setJNDIName(var2);
      }
   }
   ...
   private void __post_196(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6409095](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.persistent-store-dir.) must be a non-empty string");
      } else {
   ...
   private void __post_241(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6457247](.weblogic-ejb-jar.transaction-isolation.isolation-level.) must be a non-empty string");
      } else {
         String var5;
   ...
   private void __post_246(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var5 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6464443](.weblogic-ejb-jar.transaction-isolation.method.method-name.) must be a non-empty string");
      } else {
         var3.setMethodName(var2);
      }
   }
   ...
   private void __post_164(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6373099](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.persistence.finders-load-bean.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6373099](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.persistence.finders-load-bean.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_193(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6405814](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-cache.idle-timeout-seconds.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
         } catch (Exception var8) {
   ...
   private void __post_158(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6366523](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache-ref.cache-between-transactions.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6366523](.weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache-ref.cache-between-transactions.) must be one of the values: true,True,false,False");
      } else {
         var3.setCacheBetweenTransactions("True".equalsIgnoreCase(var2));
      }
   }
   ...
   private void __post_205(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var6 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6418935](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.passivate-during-replication.) must be a non-empty string");
      } else if (!"true".equals(var2) && !"True".equals(var2) && !"false".equals(var2) && !"False".equals(var2)) {
         throw new SAXValidationException("PAction[6418935](.weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.passivate-during-replication.) must be one of the values: true,True,false,False");
      } else {
   ...
   private void __post_142(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicEjbJarBean var4 = (WeblogicEjbJarBean)var1.getBoundObject("wlJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[6348364](.weblogic-ejb-jar.weblogic-enterprise-bean.jndi-name.) must be a non-empty string");
      } else {
         var3.setJNDIName(var2);
      }
   }
   ...
   private void __post_199(ProcessingContext var1) throws SAXProcessorException {
   ...
   static {
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.iiop-security-descriptor.client-authentication.", new Integer(217));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.home-is-clusterable.", new Integer(200));
      paths.put(".weblogic-ejb-jar.idempotent-methods.method.method-intf.", new Integer(253));
      paths.put(".weblogic-ejb-jar.run-as-role-assignment.run-as-principal-name.", new Integer(264));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.iiop-security-descriptor.identity-assertion.", new Integer(218));
      paths.put(".weblogic-ejb-jar.idempotent-methods.method.method-name.", new Integer(254));
      paths.put(".weblogic-ejb-jar.transaction-isolation.", new Integer(240));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.iiop-security-descriptor.", new Integer(216));
      paths.put(".weblogic-ejb-jar.idempotent-methods.method.", new Integer(250));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.home-load-algorithm.", new Integer(201));
      paths.put(".weblogic-ejb-jar.run-as-role-assignment.", new Integer(262));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.resource-env-description.", new Integer(228));
      ...
      paths.put(".weblogic-ejb-jar.security-role-assignment.global-role.", new Integer(260));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.pool.max-beans-in-free-pool.", new Integer(146));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.allow-concurrent-calls.", new Integer(197));
      ...
      paths.put(".weblogic-ejb-jar.transaction-isolation.method.method-intf.", new Integer(245));
      paths.put(".weblogic-ejb-jar.idempotent-methods.", new Integer(249));
      paths.put(".weblogic-ejb-jar.security-permission.description.", new Integer(238));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.iiop-security-descriptor.transport-requirements.integrity.", new Integer(220));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.ejb-local-reference-description.ejb-ref-name.", new Integer(235));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache.", new Integer(148));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.transaction-descriptor.", new Integer(223));
      paths.put(".weblogic-ejb-jar.security-role-assignment.role-name.", new Integer(258));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache-ref.", new Integer(154));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.pool.", new Integer(210));
      ...
      paths.put(".weblogic-ejb-jar.enable-bean-class-redeploy.", new Integer(265));
      ...
      paths.put(".weblogic-ejb-jar.idempotent-methods.method.method-params.", new Integer(255));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.iiop-security-descriptor.transport-requirements.confidentiality.", new Integer(221));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.ejb-local-reference-description.", new Integer(234));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.pool.max-beans-in-free-pool.", new Integer(211));
      paths.put(".weblogic-ejb-jar.security-role-assignment.externally-defined.", new Integer(261));
      paths.put(".weblogic-ejb-jar.security-permission.", new Integer(237));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.jms-client-id.", new Integer(208));
      paths.put(".weblogic-ejb-jar.transaction-isolation.method.method-params.", new Integer(247));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.initial-context-factory.", new Integer(213));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.local-jndi-name.", new Integer(143));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.resource-description.res-ref-name.", new Integer(226));
      ...
      paths.put(".weblogic-ejb-jar.transaction-isolation.method.", new Integer(242));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.use-serverside-stubs.", new Integer(203));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.replication-type.", new Integer(204));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-clustering.", new Integer(169));
      paths.put(".weblogic-ejb-jar.idempotent-methods.method.description.", new Integer(251));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.", new Integer(190));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.jms-polling-interval-seconds.", new Integer(207));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.pool.initial-beans-in-free-pool.", new Integer(212));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.iiop-security-descriptor.transport-requirements.client-cert-authentication.", new Integer(222));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.allow-remove-during-transaction.", new Integer(198));
      ...
      paths.put(".weblogic-ejb-jar.security-role-assignment.principal-name.", new Integer(259));
      ...
      paths.put(".weblogic-ejb-jar.transaction-isolation.method.ejb-name.", new Integer(244));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.ejb-reference-description.ejb-ref-name.", new Integer(232));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.resource-env-description.jndi-name.", new Integer(230));
      paths.put(".weblogic-ejb-jar.description.", new Integer(129));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.resource-description.jndi-name.", new Integer(227));
      ...
      paths.put(".weblogic-ejb-jar.idempotent-methods.method.ejb-name.", new Integer(252));
      ...
      paths.put(".weblogic-ejb-jar.idempotent-methods.method.method-params.method-param.", new Integer(256));
      paths.put(".weblogic-ejb-jar.transaction-isolation.method.method-params.method-param.", new Integer(248));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.home-call-router-class-name.", new Integer(202));
      paths.put(".weblogic-ejb-jar.security-role-assignment.", new Integer(257));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.entity-descriptor.entity-cache.read-timeout-seconds.", new Integer(153));
      paths.put(".weblogic-ejb-jar.transaction-isolation.method.description.", new Integer(243));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.", new Integer(206));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.resource-env-description.res-env-ref-name.", new Integer(229));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.provider-url.", new Integer(214));
      paths.put(".weblogic-ejb-jar.disable-warning.", new Integer(266));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.resource-description.", new Integer(225));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.ejb-reference-description.jndi-name.", new Integer(233));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.connection-factory-jndi-name.", new Integer(215));
      paths.put(".weblogic-ejb-jar.run-as-role-assignment.role-name.", new Integer(263));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.message-driven-descriptor.destination-jndi-name.", new Integer(209));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.transaction-descriptor.trans-timeout-seconds.", new Integer(224));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.iiop-security-descriptor.transport-requirements.", new Integer(219));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.ejb-local-reference-description.jndi-name.", new Integer(236));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.persistent-store-dir.", new Integer(196));
      paths.put(".weblogic-ejb-jar.transaction-isolation.isolation-level.", new Integer(241));
      paths.put(".weblogic-ejb-jar.security-permission.security-permission-spec.", new Integer(239));
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.reference-descriptor.ejb-reference-description.", new Integer(231));
      paths.put(".weblogic-ejb-jar.transaction-isolation.method.method-name.", new Integer(246));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.passivate-during-replication.", new Integer(205));
      ...
      paths.put(".weblogic-ejb-jar.weblogic-enterprise-bean.stateful-session-descriptor.stateful-session-clustering.", new Integer(199));
   }
}
