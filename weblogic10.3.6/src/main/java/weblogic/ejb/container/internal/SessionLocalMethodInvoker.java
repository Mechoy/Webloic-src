...
public final class SessionLocalMethodInvoker {
   static final long serialVersionUID = -6624625814686134066L;
   ...
   public static Object invoke(BaseLocalObject var0, MethodDescriptor var1, Object[] var2, int var3, String var4, Class<?> var5) throws Throwable {
      boolean var22;
         ...
         while(true) {
            ...
            if (!var9) {
               try {
                  ...
                  if (var38 instanceof EJBException) {
                     throw var38;
                  }

                  ((Invokable)var0).__WL_handleException(var3, var38);
                  throw new EJBException("Unexpected exception in " + var4 + ":" + PlatformConstants.EOL + StackTraceUtils.throwable2StackTrace(var38), var38);
               }
   ...
   static {
      ...
      _WLDF$INST_JPFLD_0 = InstrumentationSupport.createJoinPoint(_WLDF$INST_FLD_class, "SessionLocalMethodInvoker.java", "weblogic.ejb.container.internal.SessionLocalMethodInvoker", "invoke", "(Lweblogic/ejb/container/internal/BaseLocalObject;Lweblogic/ejb/container/internal/MethodDescriptor;[Ljava/lang/Object;ILjava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;", 20, InstrumentationSupport.makeMap(new String[]{"EJB_Diagnostic_Business_Method_Invoke_Wrapper_Around_Low"}, new PointcutHandlingInfo[]{InstrumentationSupport.createPointcutHandlingInfo((ValueHandlingInfo)null, (ValueHandlingInfo)null, new ValueHandlingInfo[]{null, InstrumentationSupport.createValueHandlingInfo("md", "weblogic.diagnostics.instrumentation.gathering.EJBMethodDescriptorRenderer", false, true), null, null, null, null})}), (boolean)1);
   }
}
