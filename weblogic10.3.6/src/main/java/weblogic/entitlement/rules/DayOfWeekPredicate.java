...
public abstract class DayOfWeekPredicate extends BasePredicate {
   ...
   public DayOfWeekPredicate(String var1, String var2) {
      super(var1, var2);
   }
   ...
   public void init(String[] var1) throws IllegalPredicateArgumentException {
      if (var1 != null && var1.length != 0) {
         if (var1.length > 2) {
            ...
            this.dayOfWeek = this.parseDayOfTheWeek(var1[0]);
   ...
   private DayOfWeek parseDayOfTheWeek(String var1) throws IllegalPredicateArgumentException {
      return (DayOfWeek)DAY_OF_WEEK_ARG.parseExprValue(var1);
   }
