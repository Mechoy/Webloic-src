...
public class LoggingTextFormatter {
   ...
   public LoggingTextFormatter(Locale var1) {
      this.l10n = L10nLookup.getLocalizer(var1, "weblogic.i18n.logging.LoggingTextLocalizer", LoggingTextFormatter.class.getClassLoader());
   }
   ...
   public static LoggingTextFormatter getInstance(Locale var0) {
      return new LoggingTextFormatter(var0);
   }
   ...
   public String consoleSeverityControlHint(String var1, String var2) {
      String var3 = "";
      String var4 = "consoleSeverityControlHint";
      String var5 = "Logging";
   ...
   public String someConsoleSeverity2Console(String var1) {
      String var2 = "";
      String var3 = "someConsoleSeverity2Console";
      String var4 = "Logging";
   ...
   public String someConsoleSeverity2Log(String var1) {
      String var2 = "";
      String var3 = "someConsoleSeverity2Log";
      String var4 = "Logging";
      Object[] var5 = new Object[]{var1};
      String var6 = MessageFormat.format(this.l10n.get(var3), var5);
      if (this.getExtendedFormat()) {
   ...
   public String everyConsoleSeverity2Console() {
      String var1 = "";
      String var2 = "everyConsoleSeverity2Console";
      String var3 = "Logging";
      Object[] var4 = new Object[0];
      String var5 = MessageFormat.format(this.l10n.get(var2), var4);
      if (this.getExtendedFormat()) {
   ...
   public String everyConsoleSeverity2Log() {
      String var1 = "";
      String var2 = "everyConsoleSeverity2Log";
      String var3 = "Logging";
      Object[] var4 = new Object[0];
      String var5 = MessageFormat.format(this.l10n.get(var2), var4);
      if (this.getExtendedFormat()) {
   ...
   public String noConsoleSeverity2Console() {
      String var1 = "";
      String var2 = "noConsoleSeverity2Console";
      String var3 = "Logging";
      Object[] var4 = new Object[0];
      String var5 = MessageFormat.format(this.l10n.get(var2), var4);
      if (this.getExtendedFormat()) {
   ...
   public String noConsoleSeverity2Log() {
      String var1 = "";
      String var2 = "noConsoleSeverity2Log";
      String var3 = "Logging";
      Object[] var4 = new Object[0];
      String var5 = MessageFormat.format(this.l10n.get(var2), var4);
      if (this.getExtendedFormat()) {
   ...
   public String getDomainLoggerDoesNotExistMsg() {
      String var1 = "";
      String var2 = "domainLoggerDoesNotExist";
      String var3 = "Logging";
      Object[] var4 = new Object[0];
      String var5 = MessageFormat.format(this.l10n.get(var2), var4);
      if (this.getExtendedFormat()) {
   ...
   public String getLog4jLoggerNotAvailableText() {
      String var1 = "";
      String var2 = "log4jLoggerNotAvailable";
      String var3 = "Logging";
      Object[] var4 = new Object[0];
      String var5 = MessageFormat.format(this.l10n.get(var2), var4);
      if (this.getExtendedFormat()) {
