...
public final class IIOPInputStream extends InputStream implements PeerInfoable, ServerChannelStream, StringInput, ObjectInput, ChunkInput, MsgInput, ValueInputStream {
   ...
   void addChunks(IIOPInputStream var1) {
      if (this.fragmentHead == null) {
         this.fragmentHead = this.fragmentTail = new Fragment(var1.getChunks(), var1.chunkPos);
      } else {
         this.fragmentTail.next = new Fragment(var1.getChunks(), var1.chunkPos);
   ...
   final long startEncapsulation(boolean var1) {
      ...
      if (var2 > 0) {
         ...
         if (this.chunking) {
            ...
            this.encapsulations.put(var3, new EncapsulationWrapper(var2, this.chunking, this.chunkLength, this.endTag));
            this.chunking = false;
            this.chunkLength = 0;
            this.endTag = 0;
         }
   ...
   public void endEncapsulation(long var1) {
      if (var1 != 0L) {
         ...
         var1 &= 536870911L;
         if (var3) {
            EncapsulationWrapper var4 = (EncapsulationWrapper)this.encapsulations.remove((int)var1);
            if (var4 == null) {
