...
public final class T3RemoteOutputStreamProxy_1036_WLStub extends Stub implements StubInfoIntf, OneWayOutputServer {
   ...
   public T3RemoteOutputStreamProxy_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
   ...
   private static synchronized void ensureInitialized(StubInfo var0) {
      if (!initialized) {
         ...
         md0 = new MethodDescriptor(m[0], class$weblogic$io$common$internal$OneWayOutputServer == null ? (class$weblogic$io$common$internal$OneWayOutputServer = class$("weblogic.io.common.internal.OneWayOutputServer")) : class$weblogic$io$common$internal$OneWayOutputServer, true, false, false, false, var0.getTimeOut(m[0]), var0.getRemoteRef().getObjectID());
         md1 = new MethodDescriptor(m[1], class$weblogic$io$common$internal$OneWayOutputServer == null ? (class$weblogic$io$common$internal$OneWayOutputServer = class$("weblogic.io.common.internal.OneWayOutputServer")) : class$weblogic$io$common$internal$OneWayOutputServer, true, false, false, false, var0.getTimeOut(m[1]), var0.getRemoteRef().getObjectID());
         md2 = new MethodDescriptor(m[2], class$weblogic$io$common$internal$OneWayOutputServer == null ? (class$weblogic$io$common$internal$OneWayOutputServer = class$("weblogic.io.common.internal.OneWayOutputServer")) : class$weblogic$io$common$internal$OneWayOutputServer, true, false, false, false, var0.getTimeOut(m[2]), var0.getRemoteRef().getObjectID());
         initialized = true;
      }
   }
   ...
   public final void flush(int var1) {
   ...
   public final void write(int var1, byte[] var2) {
