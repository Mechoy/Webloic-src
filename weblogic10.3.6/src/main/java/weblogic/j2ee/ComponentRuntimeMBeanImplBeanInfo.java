...
public class ComponentRuntimeMBeanImplBeanInfo extends WebLogicMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = ComponentRuntimeMBean.class;

   public ComponentRuntimeMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = ComponentRuntimeMBeanImpl.class;
      ...
      var2.setValue("interfaceclassname", "weblogic.management.runtime.ComponentRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("DeploymentState")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("DeploymentState", ComponentRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("ModuleId")) {
         var3 = "getModuleId";
         var4 = null;
         var2 = new PropertyDescriptor("ModuleId", ComponentRuntimeMBean.class, var3, (String)var4);
      ...
      if (BeanInfoHelper.isVersionCompliant("9.0.0.0", (String)null, this.targetVersion) && !var1.containsKey("WorkManagerRuntimes")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("WorkManagerRuntimes", ComponentRuntimeMBean.class, var3, (String)var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = ComponentRuntimeMBean.class.getMethod("preDeregister");
