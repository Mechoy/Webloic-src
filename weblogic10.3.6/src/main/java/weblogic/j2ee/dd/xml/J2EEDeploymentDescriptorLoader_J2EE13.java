...
public final class J2EEDeploymentDescriptorLoader_J2EE13 extends J2EEDeploymentDescriptorLoader implements XMLProcessor, InProcessor {
   ...
   public J2EEDeploymentDescriptorLoader_J2EE13(boolean var1) {
      this.driver = new ProcessorDriver(this, "-//Sun Microsystems, Inc.//DTD J2EE Application 1.3//EN", "/weblogic/j2ee/dd/xml/application_1_3.dtd", var1);
   }
   ...
   private void __post_135(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      RoleDescriptor var3 = (RoleDescriptor)var1.getBoundObject("rd");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[5917428](.application.security-role.role-name.) must be a non-empty string");
      } else {
         var3.setName(var2);
      }
   }
   ...
   private void __pre_137(ProcessingContext var1) {
      ResourceAdapterModuleDescriptor var2 = new ResourceAdapterModuleDescriptor();
      var1.addBoundObject(var2, "ra");
   }

   private void __post_137(ProcessingContext var1) throws SAXProcessorException {
      String var2 = Functions.value(var1);
      ResourceAdapterModuleDescriptor var3 = (ResourceAdapterModuleDescriptor)var1.getBoundObject("ra");
      var3.setURI(var2);
      this.dd.addConnectorModule(var3);
      super.setCurrentModuleContext(var3);
   }
   ...
   static {
      ...
      paths.put(".application.module.web.context-root.", new Integer(142));
      paths.put(".application.display-name.", new Integer(130));
      paths.put(".application.module.ejb.", new Integer(138));
      paths.put(".application.module.connector.", new Integer(137));
      paths.put(".application.module.java.", new Integer(139));
      paths.put(".application.security-role.", new Integer(133));
      paths.put(".application.icon.large-icon.", new Integer(132));
      paths.put(".application.module.web.", new Integer(140));
      ...
      paths.put(".application.module.web.web-uri.", new Integer(141));
   }
}
