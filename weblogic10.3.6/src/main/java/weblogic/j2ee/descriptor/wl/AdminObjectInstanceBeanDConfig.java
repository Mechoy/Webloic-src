...
public class AdminObjectInstanceBeanDConfig extends BasicDConfigBean {
   ...
   public AdminObjectInstanceBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (AdminObjectInstanceBean)var2;
      this.beanTree = var2;
