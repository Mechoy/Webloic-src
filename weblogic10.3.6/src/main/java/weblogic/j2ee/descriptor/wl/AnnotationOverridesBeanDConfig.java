...
public class AnnotationOverridesBeanDConfig extends BasicDConfigBeanRoot {
   ...
   public AnnotationOverridesBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (AnnotationOverridesBean)var2;
      this.beanTree = var2;
   ...
   public AnnotationOverridesBeanDConfig(DDBeanRoot var1, WebLogicDeploymentConfiguration var2, DescriptorBean var3, String var4, DescriptorSupport var5) throws InvalidModuleException, IOException {
      super(var1, var2, var4, var5);
      this.beanTree = var3;
      this.beanTreeNode = (AnnotationOverridesBean)var3;
   ...
   public AnnotationOverridesBeanDConfig(DDBeanRoot var1, WebLogicDeploymentConfiguration var2, String var3, DescriptorSupport var4) throws InvalidModuleException, IOException {
