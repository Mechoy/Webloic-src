...
public class ApplicationEntityCacheBeanDConfig extends BasicDConfigBean {
   ...
   public ApplicationEntityCacheBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (ApplicationEntityCacheBean)var2;
      this.beanTree = var2;
   ...
   public void initKeyPropertyValue(String var1) {
      this.setEntityCacheName(var1);
   }

   public String getDCBProperties() {
      StringBuffer var1 = new StringBuffer();
      var1.append("EntityCacheName: ");
      var1.append(this.beanTreeNode.getEntityCacheName());
      var1.append("\n");
   ...
   public void setCachingStrategy(String var1) {
      this.beanTreeNode.setCachingStrategy(var1);
