...
public class ApplicationParamBeanDConfig extends BasicDConfigBean {
   ...
   public ApplicationParamBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (ApplicationParamBean)var2;
      this.beanTree = var2;
   ...
   public void initKeyPropertyValue(String var1) {
      this.setParamName(var1);
   }

   public String getDCBProperties() {
      StringBuffer var1 = new StringBuffer();
      var1.append("ParamName: ");
      var1.append(this.beanTreeNode.getParamName());
      var1.append("\n");
