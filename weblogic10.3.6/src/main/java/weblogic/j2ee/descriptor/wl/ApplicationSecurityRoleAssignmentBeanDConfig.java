...
public class ApplicationSecurityRoleAssignmentBeanDConfig extends BasicDConfigBean {
   ...
   public ApplicationSecurityRoleAssignmentBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (ApplicationSecurityRoleAssignmentBean)var2;
      this.beanTree = var2;
