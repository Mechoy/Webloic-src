...
public class BufferingConfigBeanDConfig extends BasicDConfigBean {
   ...
   public BufferingConfigBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (BufferingConfigBean)var2;
      this.beanTree = var2;
   ...
   public void setRetryDelay(String var1) {
      this.beanTreeNode.setRetryDelay(var1);
