...
public class CapacityBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private CapacityBean beanTreeNode;

   public CapacityBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (CapacityBean)var2;
      this.beanTree = var2;
