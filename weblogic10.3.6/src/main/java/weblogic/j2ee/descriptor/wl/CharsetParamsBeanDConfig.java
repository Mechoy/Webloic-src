...
public class CharsetParamsBeanDConfig extends BasicDConfigBean {
   ...
   public CharsetParamsBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (CharsetParamsBean)var2;
      this.beanTree = var2;
