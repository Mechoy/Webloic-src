...
public class ClientSAFBeanDConfig extends BasicDConfigBeanRoot {
   private static final boolean debug = Debug.isDebug("config");
   private ClientSAFBean beanTreeNode;

   public ClientSAFBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (ClientSAFBean)var2;
      this.beanTree = var2;
   ...
   public ClientSAFBeanDConfig(DDBeanRoot var1, WebLogicDeploymentConfiguration var2, DescriptorBean var3, String var4, DescriptorSupport var5) throws InvalidModuleException, IOException {
      super(var1, var2, var4, var5);
      this.beanTree = var3;
      this.beanTreeNode = (ClientSAFBean)var3;
   ...
   public ClientSAFBeanDConfig(DDBeanRoot var1, WebLogicDeploymentConfiguration var2, String var3, DescriptorSupport var4) throws InvalidModuleException, IOException {
      ...
      try {
         ...
         this.beanTree = DescriptorParser.getWLSEditableDescriptorBean(ClientSAFBean.class);
         this.beanTreeNode = (ClientSAFBean)this.beanTree;
         this.customInit();
   ...
   public DefaultPersistentStoreBean getPersistentStore() {
      return this.beanTreeNode.getPersistentStore();
   }

   public DefaultSAFAgentBean getSAFAgent() {
      return this.beanTreeNode.getSAFAgent();
   }
