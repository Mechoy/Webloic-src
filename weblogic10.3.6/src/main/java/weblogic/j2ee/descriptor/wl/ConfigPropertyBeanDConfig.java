...
public class ConfigPropertyBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private ConfigPropertyBean beanTreeNode;

   public ConfigPropertyBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (ConfigPropertyBean)var2;
      this.beanTree = var2;
