...
public class ContextCaseBeanDConfig extends BasicDConfigBean {
   ...
   public ContextCaseBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (ContextCaseBean)var2;
      this.beanTree = var2;
   ...
   public void initKeyPropertyValue(String var1) {
      this.setRequestClassName(var1);
   }

   public String getDCBProperties() {
      StringBuffer var1 = new StringBuffer();
      var1.append("RequestClassName: ");
      var1.append(this.beanTreeNode.getRequestClassName());
      var1.append("\n");
