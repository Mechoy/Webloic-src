...
public class CustomModuleBeanDConfig extends BasicDConfigBean {
   ...
   public CustomModuleBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (CustomModuleBean)var2;
      this.beanTree = var2;
   ...
   public void setProviderName(String var1) {
      this.beanTreeNode.setProviderName(var1);
