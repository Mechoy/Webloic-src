...
public class DatabaseSpecificSqlBeanDConfig extends BasicDConfigBean {
   ...
   public DatabaseSpecificSqlBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (DatabaseSpecificSqlBean)var2;
      this.beanTree = var2;
