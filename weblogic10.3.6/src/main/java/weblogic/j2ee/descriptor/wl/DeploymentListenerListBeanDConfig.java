...
public class DeploymentListenerListBeanDConfig extends BasicDConfigBean {
   ...
   public DeploymentListenerListBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (DeploymentListenerListBean)var2;
      this.beanTree = var2;
   ...
   public void setDeploymentListeners(String[] var1) {
      this.beanTreeNode.setDeploymentListeners(var1);
