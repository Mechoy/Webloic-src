...
public class DistributedDestinationMemberBeanDConfig extends BasicDConfigBean {
   ...
   public DistributedDestinationMemberBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (DistributedDestinationMemberBean)var2;
      this.beanTree = var2;
   ...
   public void setWeight(int var1) {
      this.beanTreeNode.setWeight(var1);
   ...
   public void setPhysicalDestinationName(String var1) {
      this.beanTreeNode.setPhysicalDestinationName(var1);
