...
public class DriverParamsBeanDConfig extends BasicDConfigBean {
   ...
   public DriverParamsBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (DriverParamsBean)var2;
      this.beanTree = var2;
   ...
   public void setRowPrefetchEnabled(boolean var1) {
      this.beanTreeNode.setRowPrefetchEnabled(var1);
