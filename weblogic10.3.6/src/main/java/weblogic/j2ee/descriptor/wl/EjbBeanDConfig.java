...
public class EjbBeanDConfig extends BasicDConfigBean {
   ...
   public EjbBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (EjbBean)var2;
      this.beanTree = var2;
   ...
   public void setStartMdbsWithApplication(boolean var1) {
      this.beanTreeNode.setStartMdbsWithApplication(var1);
