...
public class FieldGroupBeanDConfig extends BasicDConfigBean {
   ...
   public FieldGroupBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (FieldGroupBean)var2;
      this.beanTree = var2;
   ...
   public void initKeyPropertyValue(String var1) {
      this.setGroupName(var1);
   }

   public String getDCBProperties() {
      StringBuffer var1 = new StringBuffer();
      var1.append("GroupName: ");
      var1.append(this.beanTreeNode.getGroupName());
      var1.append("\n");
   ...
   public void setCmpFields(String[] var1) {
      this.beanTreeNode.setCmpFields(var1);
   ...
   public void setCmrFields(String[] var1) {
      this.beanTreeNode.setCmrFields(var1);
