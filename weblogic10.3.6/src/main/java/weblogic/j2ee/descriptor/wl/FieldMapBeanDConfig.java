...
public class FieldMapBeanDConfig extends BasicDConfigBean {
   ...
   public FieldMapBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (FieldMapBean)var2;
      this.beanTree = var2;
   ...
   public void initKeyPropertyValue(String var1) {
      this.setCmpField(var1);
   }

   public String getDCBProperties() {
      StringBuffer var1 = new StringBuffer();
      var1.append("CmpField: ");
      var1.append(this.beanTreeNode.getCmpField());
      var1.append("\n");
   ...
   public void setCmpField(String var1) {
      this.beanTreeNode.setCmpField(var1);
   ...
   public void setDbmsColumn(String var1) {
      this.beanTreeNode.setDbmsColumn(var1);
   ...
   public void setDbmsColumnType(String var1) {
      this.beanTreeNode.setDbmsColumnType(var1);
   ...
   public void setDbmsDefaultValue(boolean var1) {
      this.beanTreeNode.setDbmsDefaultValue(var1);
