...
public class InterceptionPointBeanDConfig extends BasicDConfigBean {
   ...
   public InterceptionPointBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (InterceptionPointBean)var2;
      this.beanTree = var2;
   ...
   public void setNameSegment(String[] var1) {
      this.beanTreeNode.setNameSegment(var1);
