...
public class JavaEEPropertyBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private JavaEEPropertyBean beanTreeNode;

   public JavaEEPropertyBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (JavaEEPropertyBean)var2;
      this.beanTree = var2;
