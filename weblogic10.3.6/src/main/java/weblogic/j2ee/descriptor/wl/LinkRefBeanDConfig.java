...
public class LinkRefBeanDConfig extends BasicDConfigBean {
   ...
   public LinkRefBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (LinkRefBean)var2;
      this.beanTree = var2;
   ...
   public void setConnectionFactoryName(String var1) {
      this.beanTreeNode.setConnectionFactoryName(var1);
   ...
   public void setRaLinkRef(String var1) {
      this.beanTreeNode.setRaLinkRef(var1);
