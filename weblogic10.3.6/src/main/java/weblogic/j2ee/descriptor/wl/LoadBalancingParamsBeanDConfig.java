...
public class LoadBalancingParamsBeanDConfig extends BasicDConfigBean {
   ...
   public LoadBalancingParamsBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (LoadBalancingParamsBean)var2;
      this.beanTree = var2;
   ...
   public void setLoadBalancingEnabled(boolean var1) {
      this.beanTreeNode.setLoadBalancingEnabled(var1);
   ...
   public void setServerAffinityEnabled(boolean var1) {
      this.beanTreeNode.setServerAffinityEnabled(var1);
