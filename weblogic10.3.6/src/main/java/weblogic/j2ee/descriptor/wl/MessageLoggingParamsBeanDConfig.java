...
public class MessageLoggingParamsBeanDConfig extends BasicDConfigBean {
   ...
   public MessageLoggingParamsBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (MessageLoggingParamsBean)var2;
      this.beanTree = var2;
   ...
   public void setMessageLoggingEnabled(boolean var1) {
      this.beanTreeNode.setMessageLoggingEnabled(var1);
   ...
   public void setMessageLoggingFormat(String var1) {
      this.beanTreeNode.setMessageLoggingFormat(var1);
