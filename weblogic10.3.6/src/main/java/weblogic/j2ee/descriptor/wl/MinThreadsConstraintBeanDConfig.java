...
public class MinThreadsConstraintBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private MinThreadsConstraintBean beanTreeNode;

   public MinThreadsConstraintBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (MinThreadsConstraintBean)var2;
      this.beanTree = var2;
