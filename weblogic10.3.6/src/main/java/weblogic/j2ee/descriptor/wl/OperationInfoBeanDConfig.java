...
public class OperationInfoBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private OperationInfoBean beanTreeNode;

   public OperationInfoBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (OperationInfoBean)var2;
      this.beanTree = var2;
