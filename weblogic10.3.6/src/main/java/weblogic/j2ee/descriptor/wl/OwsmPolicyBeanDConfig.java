...
public class OwsmPolicyBeanDConfig extends BasicDConfigBean {
   ...
   public OwsmPolicyBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (OwsmPolicyBean)var2;
      this.beanTree = var2;
   ...
   public void setCategory(String var1) {
      this.beanTreeNode.setCategory(var1);
