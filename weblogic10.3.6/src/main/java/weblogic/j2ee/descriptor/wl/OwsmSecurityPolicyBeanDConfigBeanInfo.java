...
public class OwsmSecurityPolicyBeanDConfigBeanInfo extends SimpleBeanInfo {
   ...
   public PropertyDescriptor[] getPropertyDescriptors() {
      if (pds != null) {
         ...
         try {
            PropertyDescriptor var1 = new PropertyDescriptor("Uri", Class.forName("weblogic.j2ee.descriptor.wl.OwsmSecurityPolicyBeanDConfig"), "getUri", "setUri");
            ...
            var2.add(var1);
            var1 = new PropertyDescriptor("Status", Class.forName("weblogic.j2ee.descriptor.wl.OwsmSecurityPolicyBeanDConfig"), "getStatus", "setStatus");
            var1.setValue("dependency", false);
            var1.setValue("declaration", false);
            var1.setValue("configurable", true);
