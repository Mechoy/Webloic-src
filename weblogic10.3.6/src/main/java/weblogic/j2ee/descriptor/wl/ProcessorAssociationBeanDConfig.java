...
public class ProcessorAssociationBeanDConfig extends BasicDConfigBean {
   ...
   public ProcessorAssociationBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (ProcessorAssociationBean)var2;
      this.beanTree = var2;
