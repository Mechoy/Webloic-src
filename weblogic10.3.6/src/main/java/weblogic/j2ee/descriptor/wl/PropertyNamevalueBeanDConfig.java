...
public class PropertyNamevalueBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private PropertyNamevalueBean beanTreeNode;

   public PropertyNamevalueBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (PropertyNamevalueBean)var2;
      this.beanTree = var2;
