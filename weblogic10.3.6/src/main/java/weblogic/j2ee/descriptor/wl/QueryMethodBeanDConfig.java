...
public class QueryMethodBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private QueryMethodBean beanTreeNode;

   public QueryMethodBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (QueryMethodBean)var2;
      this.beanTree = var2;
