...
public class ResourceDescriptionBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private ResourceDescriptionBean beanTreeNode;

   public ResourceDescriptionBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (ResourceDescriptionBean)var2;
      this.beanTree = var2;
   ...
   public void initKeyPropertyValue(String var1) {
      this.setResRefName(var1);
   }

   public String getDCBProperties() {
      StringBuffer var1 = new StringBuffer();
      var1.append("ResRefName: ");
      var1.append(this.beanTreeNode.getResRefName());
      var1.append("\n");
   ...
   public String getResRefName() {
      return this.beanTreeNode.getResRefName();
   }

   public void setResRefName(String var1) {
      this.beanTreeNode.setResRefName(var1);
      this.firePropertyChange(new PropertyChangeEvent(this, "ResRefName", (Object)null, (Object)null));
