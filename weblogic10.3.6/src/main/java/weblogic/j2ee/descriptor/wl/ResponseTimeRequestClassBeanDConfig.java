...
public class ResponseTimeRequestClassBeanDConfig extends BasicDConfigBean {
   ...
   public ResponseTimeRequestClassBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (ResponseTimeRequestClassBean)var2;
      this.beanTree = var2;
   ...
   public void setGoalMs(int var1) {
      this.beanTreeNode.setGoalMs(var1);
