...
public class RetryMethodsOnRollbackBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private RetryMethodsOnRollbackBean beanTreeNode;

   public RetryMethodsOnRollbackBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (RetryMethodsOnRollbackBean)var2;
      this.beanTree = var2;
   ...
   public void setRetryCount(int var1) {
      this.beanTreeNode.setRetryCount(var1);
