...
public class SAFLoginContextBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private SAFLoginContextBean beanTreeNode;

   public SAFLoginContextBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (SAFLoginContextBean)var2;
      this.beanTree = var2;
   ...
   public String getLoginURL() {
      return this.beanTreeNode.getLoginURL();
   }

   public void setLoginURL(String var1) {
      this.beanTreeNode.setLoginURL(var1);
      this.firePropertyChange(new PropertyChangeEvent(this, "LoginURL", (Object)null, (Object)null));
