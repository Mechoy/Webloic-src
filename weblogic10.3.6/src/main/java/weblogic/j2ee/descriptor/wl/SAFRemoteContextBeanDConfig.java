...
public class SAFRemoteContextBeanDConfig extends BasicDConfigBean {
   ...
   public SAFRemoteContextBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (SAFRemoteContextBean)var2;
      this.beanTree = var2;
   ...
   public void setCompressionThreshold(int var1) {
      this.beanTreeNode.setCompressionThreshold(var1);
   ...
   public void setReplyToSAFRemoteContextName(String var1) {
      this.beanTreeNode.setReplyToSAFRemoteContextName(var1);
