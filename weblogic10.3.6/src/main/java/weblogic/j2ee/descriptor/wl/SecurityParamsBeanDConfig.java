...
public class SecurityParamsBeanDConfig extends BasicDConfigBean {
   ...
   public SecurityParamsBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (SecurityParamsBean)var2;
      this.beanTree = var2;
   ...
   public void setAttachJMSXUserId(boolean var1) {
      this.beanTreeNode.setAttachJMSXUserId(var1);
