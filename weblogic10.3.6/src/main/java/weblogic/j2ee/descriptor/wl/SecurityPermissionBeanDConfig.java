...
public class SecurityPermissionBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private SecurityPermissionBean beanTreeNode;

   public SecurityPermissionBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (SecurityPermissionBean)var2;
      this.beanTree = var2;
   ...
   public void setSecurityPermissionSpec(String var1) {
      this.beanTreeNode.setSecurityPermissionSpec(var1);
