...
public class ServletDescriptorBeanDConfig extends BasicDConfigBean {
   ...
   public ServletDescriptorBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (ServletDescriptorBean)var2;
      this.beanTree = var2;
   ...
   public void initKeyPropertyValue(String var1) {
      this.setServletName(var1);
   }

   public String getDCBProperties() {
      StringBuffer var1 = new StringBuffer();
      var1.append("ServletName: ");
      var1.append(this.beanTreeNode.getServletName());
      var1.append("\n");
   ...
   public void setServletName(String var1) {
      this.beanTreeNode.setServletName(var1);
   ...
   public void setInitAsPrincipalName(String var1) {
      this.beanTreeNode.setInitAsPrincipalName(var1);
   ...
   public void setDestroyAsPrincipalName(String var1) {
      this.beanTreeNode.setDestroyAsPrincipalName(var1);
