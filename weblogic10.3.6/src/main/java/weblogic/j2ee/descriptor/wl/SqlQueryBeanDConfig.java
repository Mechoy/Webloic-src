...
public class SqlQueryBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private SqlQueryBean beanTreeNode;

   public SqlQueryBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (SqlQueryBean)var2;
      this.beanTree = var2;
   ...
   public DatabaseSpecificSqlBean[] getDatabaseSpecificSqls() {
      return this.beanTreeNode.getDatabaseSpecificSqls();
   }
}
