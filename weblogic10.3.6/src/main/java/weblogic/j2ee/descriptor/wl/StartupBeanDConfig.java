...
public class StartupBeanDConfig extends BasicDConfigBean {
   ...
   public StartupBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (StartupBean)var2;
      this.beanTree = var2;
   ...
   public void setStartupClass(String var1) {
      this.beanTreeNode.setStartupClass(var1);
   ...
   public void setStartupUri(String var1) {
      this.beanTreeNode.setStartupUri(var1);
