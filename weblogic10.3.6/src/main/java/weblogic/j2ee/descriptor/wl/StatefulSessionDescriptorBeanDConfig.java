...
public class StatefulSessionDescriptorBeanDConfig extends BasicDConfigBean {
   ...
   public StatefulSessionDescriptorBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (StatefulSessionDescriptorBean)var2;
      this.beanTree = var2;
   ...
   public void setAllowConcurrentCalls(boolean var1) {
      this.beanTreeNode.setAllowConcurrentCalls(var1);
      this.firePropertyChange(new PropertyChangeEvent(this, "AllowConcurrentCalls", (Object)null, (Object)null));
      this.setModified(true);
   }
   ...
   public void setAllowRemoveDuringTransaction(boolean var1) {
      this.beanTreeNode.setAllowRemoveDuringTransaction(var1);
