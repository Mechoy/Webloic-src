...
public class StatelessSessionDescriptorBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private StatelessSessionDescriptorBean beanTreeNode;

   public StatelessSessionDescriptorBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (StatelessSessionDescriptorBean)var2;
      this.beanTree = var2;
   ...
   public StatelessClusteringBean getStatelessClustering() {
      return this.beanTreeNode.getStatelessClustering();
   }
