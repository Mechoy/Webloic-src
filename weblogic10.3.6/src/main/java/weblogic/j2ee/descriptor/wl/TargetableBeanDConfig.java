...
public class TargetableBeanDConfig extends BasicDConfigBean {
   ...
   public TargetableBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (TargetableBean)var2;
      this.beanTree = var2;
   ...
   public void setDefaultTargetingEnabled(boolean var1) {
      this.beanTreeNode.setDefaultTargetingEnabled(var1);
