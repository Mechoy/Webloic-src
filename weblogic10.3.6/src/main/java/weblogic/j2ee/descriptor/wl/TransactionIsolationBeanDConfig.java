...
public class TransactionIsolationBeanDConfig extends BasicDConfigBean {
   ...
   public TransactionIsolationBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (TransactionIsolationBean)var2;
      this.beanTree = var2;
