...
public class TransactionParamsBeanDConfig extends BasicDConfigBean {
   ...
   public TransactionParamsBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (TransactionParamsBean)var2;
      this.beanTree = var2;
   ...
   public void setXAConnectionFactoryEnabled(boolean var1) {
      this.beanTreeNode.setXAConnectionFactoryEnabled(var1);
