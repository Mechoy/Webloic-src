...
public class UniformDistributedQueueBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private UniformDistributedQueueBean beanTreeNode;

   public UniformDistributedQueueBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (UniformDistributedQueueBean)var2;
      this.beanTree = var2;
