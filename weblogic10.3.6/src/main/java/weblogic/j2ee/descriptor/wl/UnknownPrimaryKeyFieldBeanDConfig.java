...
public class UnknownPrimaryKeyFieldBeanDConfig extends BasicDConfigBean {
   ...
   public UnknownPrimaryKeyFieldBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (UnknownPrimaryKeyFieldBean)var2;
      this.beanTree = var2;
