...
public class WeblogicConnectorExtensionBeanDConfigBeanInfo extends SimpleBeanInfo {
   ...
   public PropertyDescriptor[] getPropertyDescriptors() {
      if (pds != null) {
         ...
         try {
            PropertyDescriptor var1 = new PropertyDescriptor("LinkRef", Class.forName("weblogic.j2ee.descriptor.wl.WeblogicConnectorExtensionBeanDConfig"), "getLinkRef", (String)null);
            ...
            var2.add(var1);
            var1 = new PropertyDescriptor("Proxy", Class.forName("weblogic.j2ee.descriptor.wl.WeblogicConnectorExtensionBeanDConfig"), "getProxy", (String)null);
            var1.setValue("dependency", false);
            var1.setValue("declaration", false);
            var1.setValue("configurable", false);
            var1.setValue("key", false);
            var1.setValue("dynamic", false);
            var2.add(var1);
            var1 = new PropertyDescriptor("SecondaryDescriptors", Class.forName("weblogic.j2ee.descriptor.wl.WeblogicConnectorExtensionBeanDConfig"), "getSecondaryDescriptors", (String)null);
