...
public class WorkManagerShutdownTriggerBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private WorkManagerShutdownTriggerBean beanTreeNode;

   public WorkManagerShutdownTriggerBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (WorkManagerShutdownTriggerBean)var2;
      this.beanTree = var2;
