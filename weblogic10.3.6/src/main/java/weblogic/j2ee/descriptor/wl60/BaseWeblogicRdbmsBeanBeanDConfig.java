...
public class BaseWeblogicRdbmsBeanBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private BaseWeblogicRdbmsBeanBean beanTreeNode;

   public BaseWeblogicRdbmsBeanBeanDConfig(DDBean var1, DescriptorBean var2, DConfigBean var3) throws ConfigurationException {
      super(var1);
      this.beanTreeNode = (BaseWeblogicRdbmsBeanBean)var2;
      this.beanTree = var2;
