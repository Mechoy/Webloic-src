...
public class MultiDataSourceRuntimeMBeanImplBeanInfo extends ComponentRuntimeMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = JDBCMultiDataSourceRuntimeMBean.class;

   public MultiDataSourceRuntimeMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = MultiDataSourceRuntimeMBeanImpl.class;
      ...
      String var3 = (new String("This class is used for monitoring a WebLogic JDBC Multi Data Source and its associated data sources. ")).intern();
      var2.setShortDescription(var3);
      var2.setValue("description", var3);
      var2.setValue("interfaceclassname", "weblogic.management.runtime.JDBCMultiDataSourceRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("DeploymentState")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("DeploymentState", JDBCMultiDataSourceRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("ModuleId")) {
         var3 = "getModuleId";
         var4 = null;
         var2 = new PropertyDescriptor("ModuleId", JDBCMultiDataSourceRuntimeMBean.class, var3, (String)var4);
      ...
      if (BeanInfoHelper.isVersionCompliant("9.0.0.0", (String)null, this.targetVersion) && !var1.containsKey("WorkManagerRuntimes")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("WorkManagerRuntimes", JDBCMultiDataSourceRuntimeMBean.class, var3, (String)var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = JDBCMultiDataSourceRuntimeMBean.class.getMethod("preDeregister");
