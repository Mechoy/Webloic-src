...
public class InformixJDBC4DriverURLHelper extends JDBCURLHelper {
   public String getURL() throws JDBCDriverInfoException {
      ...
      if (!this.isValid(var1.getDbmsHost())) {
         ...
         return "jdbc:informix-sqli://" + var1.getDbmsHost() + ":" + var1.getDbmsPort() + "/" + var1.getDbmsName() + ":informixServer=" + this.getInformixServer(var1);
      }
   }
   ...
   public Properties getProperties() throws JDBCDriverInfoException {
      ...
      var2.put("ifxIFXHOST", var1.getDbmsHost());
      var2.put("serverName", this.getInformixServer(var1));
      return var2;
   }
