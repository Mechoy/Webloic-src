...
public class JMSBaseConnectionFactory implements AdapterConnectionFactory {
   ...
   public TargetConnection getTargetConnection(ConnectionSpec var1) throws ResourceException {
      JMSConnectionSpec var2 = (JMSConnectionSpec)var1;
      JMSConnectionRequestInfo var3 = new JMSConnectionRequestInfo(var2.getUser(), var2.getPassword(), 2, var2.getUrl(), var2.getInitialContextFactory(), (String)null, var2.getFactoryJndi(), var2.getDestJndi(), var2.getDestType(), var2.getClasspath(), var2.getPreserveMsgProperty());
