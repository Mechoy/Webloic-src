...
public class JMSConnectionSpec implements ConnectionSpec {
   ...
   public JMSConnectionSpec(String var1, String var2, String var3, String var4, String var5, String var6, String var7, String var8, String var9, boolean var10, String var11) {
      this.user = var1;
      this.password = var2;
      this.url = var3;
      this.icFactory = var4;
