...
public class JMSManagedConnectionFactory implements ManagedConnectionFactory, Serializable {
      ...
      try {
         ...
         if (var7 == null) {
            if (var2 == null) {
               ...
               var6 = new JMSConnectionSpec((String)null, (String)null, var8.getUrl(), var8.getInitialContextFactory(), var8.getSelector(), var8.getFactoryJndi(), var8.getDestJndi(), var8.getDestType(), var8.getName(), var8.getDurability(), var8.getClasspath());
               var5 = var8.getType();
            }
         } else {
            ...
            if (var2 == null) {
               ...
               var6 = new JMSConnectionSpec(var14, var10, var8.getUrl(), var8.getInitialContextFactory(), var8.getSelector(), var8.getFactoryJndi(), var8.getDestJndi(), var8.getDestType(), var8.getName(), var8.getDurability(), var8.getClasspath());
               var5 = var8.getType();
            }
         }
   ...
   private AdapterConnection createConnectionInternal(ConnectionSpec var1, int var2) throws JMSException {
      ...
      try {
         ...
         var14 = (ClassLoader)this.classLoaders.get(var13);
         if (var14 == null) {
            var14 = new IsolatingClassLoader("JMS Interop Adapter Class Loader", getClassPath(var13), ISOLATING_PACKAGES, true);
            this.classLoaders.put(var13, var14);
         }

         var3 = new JMSBaseConnection(var11, var12, this, this.clientName, var6, var18, var4, var7, var8, var9, var10, (ClassLoader)var14);
