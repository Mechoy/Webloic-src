...
public final class StreamMessageImpl extends MessageImpl implements StreamMessage, Externalizable {
   ...
   public StreamMessageImpl(StreamMessage var1) throws IOException, javax.jms.JMSException {
      this(var1, (javax.jms.Destination)null, (javax.jms.Destination)null);
   }

   public StreamMessageImpl(StreamMessage var1, javax.jms.Destination var2, javax.jms.Destination var3) throws IOException, javax.jms.JMSException {
   ...
   private byte readType() throws javax.jms.JMSException {
      ...
      if (this.readingByteArray) {
         ...
         try {
            ...
            throw new MessageEOFException(this.readPastEnd3(0), var2);
         } catch (IOException var3) {
            throw new JMSException(this.streamReadError(0), var3);
         }
      }
   }
   ...
   public boolean readBoolean() throws javax.jms.JMSException {
      ...
      try {
         ...
         throw new MessageEOFException(this.readPastEnd3(10), var3);
      } catch (IOException var4) {
         throw new JMSException(this.streamReadError(10), var4);
      }
   }
   ...
   public byte readByte() throws javax.jms.JMSException {
      ...
      try {
         ...
         throw new MessageEOFException(this.readPastEnd3(20), var5);
   ...
   public short readShort() throws javax.jms.JMSException {
      ...
      try {
         ...
         throw new MessageEOFException(this.readPastEnd3(40), var5);
      } catch (IOException var6) {
   ...
   public char readChar() throws javax.jms.JMSException {
      ...
      try {
         ...
         throw new MessageEOFException(this.readPastEnd3(60), var3);
      } catch (IOException var4) {
         throw new JMSException(this.streamReadError(60), var4);
      }
   }
   ...
   public int readInt() throws javax.jms.JMSException {
      ...
      try {
         ...
         throw new MessageEOFException(this.readPastEnd3(70), var5);
      } catch (IOException var6) {
   ...
   public long readLong() throws javax.jms.JMSException {
      ...
      try {
         ...
         throw new MessageEOFException(this.readPastEnd3(80), var5);
      } catch (IOException var6) {
   ...
   public float readFloat() throws javax.jms.JMSException {
      ...
      try {
         ...
         throw new MessageEOFException(this.readPastEnd3(90), var5);
      } catch (IOException var6) {
   ...
   public double readDouble() throws javax.jms.JMSException {
      ...
      try {
         ...
         throw new MessageEOFException(this.readPastEnd3(100), var5);
      } catch (IOException var6) {
   ...
   public String readString() throws javax.jms.JMSException {
      ...
      try {
         ...
         throw new MessageEOFException(this.readPastEnd(), var3);
      } catch (IOException var4) {
         throw new JMSException(this.streamReadError(), var4);
      }
   }
   ...
   public int readBytes(byte[] var1) throws javax.jms.JMSException {
      ...
      if (var1 == null) {
         ...
         try {
            ...
            throw new MessageEOFException(this.readPastEnd(), var5);
         } catch (IOException var6) {
            throw new JMSException(this.streamReadError(), var6);
         } catch (ArrayIndexOutOfBoundsException var7) {
            throw new JMSException(JMSClientExceptionLogger.logStreamReadErrorIndexLoggable().getMessage(), var7);
         } catch (ArrayStoreException var8) {
            throw new JMSException(JMSClientExceptionLogger.logStreamReadErrorStoreLoggable().getMessage(), var8);
         }
      }
   }
