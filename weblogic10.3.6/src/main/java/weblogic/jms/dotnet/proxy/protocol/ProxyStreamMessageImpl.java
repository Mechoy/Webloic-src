...
public final class ProxyStreamMessageImpl extends ProxyMessageImpl {
   ...
   public ProxyStreamMessageImpl(StreamMessage var1) throws JMSException {
      super(var1);
      this.payload = ((StreamMessageImpl)var1).getPayload();
   }
   ...
   public void populateJMSMessage(StreamMessage var1) throws JMSException {
      super.populateJMSMessage(var1);
      ((StreamMessageImpl)var1).setPayload(this.payload);
   }
