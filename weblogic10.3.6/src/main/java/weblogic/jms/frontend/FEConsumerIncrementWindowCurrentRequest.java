...
public final class FEConsumerIncrementWindowCurrentRequest extends Request implements Externalizable {
   ...
   public FEConsumerIncrementWindowCurrentRequest(JMSID var1, int var2, boolean var3) {
      super(var1, 3082);
   ...
   public FEConsumerIncrementWindowCurrentRequest() {
   }
