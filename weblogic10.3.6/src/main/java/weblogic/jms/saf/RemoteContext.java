...
public class RemoteContext implements JMSModuleManagedEntity, BeanListenerCustomizer {
   ...
   public RemoteContext(SAFRemoteContextBean var1, String var2) throws ModuleException {
      this.safRemoteContextBean = var1;
   ...
   public void activate(JMSBean var1) throws ModuleException {
      this.safRemoteContextBean = var1.lookupSAFRemoteContext(this.getEntityName());
      this.safRemoteContextBeanListener = JMSSAFManager.initializeGenericBeanListener((DescriptorBean)this.safRemoteContextBean, this, this, safRemoteContextBeanSignatures, (HashMap)null);
   ...
   public void setReplyToSAFRemoteContextName(String var1) {
      this.replyToSAFRemoteContextName = var1;
   }
