...
public class SAFRemoteEndpointRuntimeMBeanImplBeanInfo extends SAFRemoteEndpointCustomizerBeanInfo {
   public static Class INTERFACE_CLASS = JMSRemoteEndpointRuntimeMBean.class;

   public SAFRemoteEndpointRuntimeMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }

   public SAFRemoteEndpointRuntimeMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = SAFRemoteEndpointRuntimeMBeanImpl.class;
      ...
      String var3 = (new String("This class is used for monitoring a WebLogic SAF remote endpoint for a JMS imported destination.  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX\" on <a href=\"http://www.oracle.com/technology/products/weblogic/index.html\" shape=\"rect\">http://www.oracle.com/technology/products/weblogic/index.html</a>.</p> ")).intern();
      var2.setShortDescription(var3);
      var2.setValue("description", var3);
      var2.setValue("interfaceclassname", "weblogic.management.runtime.JMSRemoteEndpointRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("BytesCurrentCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("BytesCurrentCount", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("BytesHighCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("BytesHighCount", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("BytesPendingCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("BytesPendingCount", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("BytesReceivedCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("BytesReceivedCount", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("BytesThresholdTime")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("BytesThresholdTime", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("DowntimeHigh")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("DowntimeHigh", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("DowntimeTotal")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("DowntimeTotal", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("EndpointType")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("EndpointType", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("FailedMessagesTotal")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("FailedMessagesTotal", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("LastException")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("LastException", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("LastTimeConnected")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("LastTimeConnected", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("LastTimeFailedToConnect")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("LastTimeFailedToConnect", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MessagesCurrentCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MessagesCurrentCount", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MessagesHighCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MessagesHighCount", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MessagesPendingCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MessagesPendingCount", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MessagesReceivedCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MessagesReceivedCount", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MessagesThresholdTime")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MessagesThresholdTime", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("OperationState")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("OperationState", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("URL")) {
         var3 = "getURL";
         var4 = null;
         var2 = new PropertyDescriptor("URL", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
         var1.put("URL", var2);
      ...
      if (!var1.containsKey("UptimeHigh")) {
         var3 = "getUptimeHigh";
         var4 = null;
         var2 = new PropertyDescriptor("UptimeHigh", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("UptimeTotal")) {
         var3 = "getUptimeTotal";
         var4 = null;
         var2 = new PropertyDescriptor("UptimeTotal", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("PausedForForwarding")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("PausedForForwarding", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("PausedForIncoming")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("PausedForIncoming", JMSRemoteEndpointRuntimeMBean.class, var3, (String)var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("getCursorStartPosition", String.class);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("getMessage", String.class, String.class);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("preDeregister");
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("sort", String.class, Long.class, String[].class, Boolean[].class);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("getCursorEndPosition", String.class);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("getMessage", String.class, Long.class);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("getItems", String.class, Long.class, Integer.class);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("getNext", String.class, Integer.class);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("pauseIncoming");
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("getPrevious", String.class, Integer.class);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("resumeIncoming");
      var8 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var8)) {
         var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
         var1.put(var8, var2);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("getCursorSize", String.class);
      var4 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var4);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("closeCursor", String.class);
      var4 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var4);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("pauseForwarding");
      var8 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var8)) {
         var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
         var1.put(var8, var2);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("resumeForwarding");
      var8 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var8)) {
         var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
         var1.put(var8, var2);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("expireAll");
      var8 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var8)) {
         var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
         var1.put(var8, var2);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("purge");
      var8 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var8)) {
         var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
         var1.put(var8, var2);
      ...
      var3 = JMSRemoteEndpointRuntimeMBean.class.getMethod("getMessages", String.class, Integer.class);
