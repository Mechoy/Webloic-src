package weblogic.jndi.factories.https;
...
public class httpsURLContextFactory implements ObjectFactory {
   ...
   public Object getObjectInstance(Object var1, Name var2, Context var3, Hashtable var4) throws NamingException {
      ...
      return new HTTPSContext(var4, var5);
   }
   ...
   private static class HTTPSContext extends AbstractURLContext {
      private Hashtable env;
      private ServerURL url;

      public HTTPSContext(Hashtable var1, String var2) throws InvalidNameException {
         this.env = var1;
         if (var2 != null) {
            try {
