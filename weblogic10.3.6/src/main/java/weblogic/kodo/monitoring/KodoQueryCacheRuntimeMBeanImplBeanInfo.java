...
public class KodoQueryCacheRuntimeMBeanImplBeanInfo extends WebLogicMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = KodoQueryCacheRuntimeMBean.class;

   public KodoQueryCacheRuntimeMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = KodoQueryCacheRuntimeMBeanImpl.class;
      ...
      var2.setValue("interfaceclassname", "weblogic.management.runtime.KodoQueryCacheRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("CacheHitCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("CacheHitCount", KodoQueryCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("CacheHitRatio")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("CacheHitRatio", KodoQueryCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("CacheMissCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("CacheMissCount", KodoQueryCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("Statistics")) {
         var3 = "getStatistics";
         var4 = null;
         var2 = new PropertyDescriptor("Statistics", KodoQueryCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TotalCurrentEntries")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TotalCurrentEntries", KodoQueryCacheRuntimeMBean.class, var3, (String)var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = KodoQueryCacheRuntimeMBean.class.getMethod("preDeregister");
      ...
      var3 = KodoQueryCacheRuntimeMBean.class.getMethod("clear");
