...
public class KodoQueryCompilationCacheRuntimeMBeanImplBeanInfo extends WebLogicMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = KodoQueryCompilationCacheRuntimeMBean.class;

   public KodoQueryCompilationCacheRuntimeMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = KodoQueryCompilationCacheRuntimeMBeanImpl.class;
      ...
      var2.setValue("interfaceclassname", "weblogic.management.runtime.KodoQueryCompilationCacheRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("TotalCurrentEntries")) {
         String var3 = "getTotalCurrentEntries";
         Object var4 = null;
         var2 = new PropertyDescriptor("TotalCurrentEntries", KodoQueryCompilationCacheRuntimeMBean.class, var3, (String)var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = KodoQueryCompilationCacheRuntimeMBean.class.getMethod("clear");
      ...
      var3 = KodoQueryCompilationCacheRuntimeMBean.class.getMethod("preDeregister");
