...
public final class _MBeanHome_Stub extends Stub implements MBeanHome {
   // $FF: synthetic field
   ...
   private static String[] _type_ids = new String[]{"RMI:weblogic.management.MBeanHome:0000000000000000"};
   // $FF: synthetic field
