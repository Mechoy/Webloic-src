...
public final class _RemoteNotificationListener_Stub extends Stub implements RemoteNotificationListener {
   private static String[] _type_ids = new String[]{"RMI:weblogic.management.RemoteNotificationListener:0000000000000000"};
   // $FF: synthetic field
