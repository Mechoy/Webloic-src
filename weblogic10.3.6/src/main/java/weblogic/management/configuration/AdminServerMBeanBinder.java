...
public class AdminServerMBeanBinder extends ConfigurationMBeanBinder implements AttributeBinder {
   private AdminServerMBeanImpl bean;

   protected AdminServerMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (AdminServerMBeanImpl)var1;
   }

   public AdminServerMBeanBinder() {
      super(new AdminServerMBeanImpl());
      this.bean = (AdminServerMBeanImpl)this.getBean();
   }
