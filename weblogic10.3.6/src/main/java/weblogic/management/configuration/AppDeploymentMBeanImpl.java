...
public class AppDeploymentMBeanImpl extends BasicDeploymentMBeanImpl implements AppDeploymentMBean, Serializable {
   ...
   public AppDeploymentMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
   ...
   public void setValidateDDSecurityData(boolean var1) {
   ...
   public void setInstallDir(String var1) {
      var1 = var1 == null ? null : var1.trim();
      String var2 = this._InstallDir;
      this._InstallDir = var1;
   ...
   public void setSecurityDDModel(String var1) {
      var1 = var1 == null ? null : var1.trim();
      String[] var2 = new String[]{"DDOnly", "CustomRoles", "CustomRolesAndPolicies", "Advanced"};
      var1 = weblogic.descriptor.beangen.LegalChecks.checkInEnum("SecurityDDModel", var1, var2);
   ...
   public void setBackgroundDeployment(boolean var1) {
      this._BackgroundDeployment = var1;
   }
   ...
   public void setOnDemandContextPaths(String[] var1) {
      var1 = var1 == null ? new String[0] : var1;
      var1 = this._getHelper()._trimElements(var1);
      this._OnDemandContextPaths = var1;
   }
   ...
   public void setOnDemandDisplayRefresh(boolean var1) {
      this._OnDemandDisplayRefresh = var1;
   }
   ...
   public void putValue(String var1, Object var2) {
      ...
      if (var1.equals("AbsoluteInstallDir")) {
      ...
      } else if (var1.equals("AltDescriptorPath")) {
         var4 = this._AltDescriptorPath;
         this._AltDescriptorPath = (String)var2;
         this._postSet(21, var4, this._AltDescriptorPath);
      } else if (var1.equals("AltWLSDescriptorPath")) {
         var4 = this._AltWLSDescriptorPath;
         this._AltWLSDescriptorPath = (String)var2;
         this._postSet(22, var4, this._AltWLSDescriptorPath);
      } else if (var1.equals("AppMBean")) {
         ApplicationMBean var9 = this._AppMBean;
         this._AppMBean = (ApplicationMBean)var2;
         this._postSet(25, var9, this._AppMBean);
         ...
         boolean var5;
         if (var1.equals("AutoDeployedApp")) {
            var5 = this._AutoDeployedApp;
            this._AutoDeployedApp = (Boolean)var2;
            this._postSet(28, var5, this._AutoDeployedApp);
         } else if (var1.equals("BackgroundDeployment")) {
            var5 = this._BackgroundDeployment;
            this._BackgroundDeployment = (Boolean)var2;
            this._postSet(27, var5, this._BackgroundDeployment);
         } else {
            byte[] var7;
            if (var1.equals("DeploymentPlan")) {
               var7 = this._DeploymentPlan;
               this._DeploymentPlan = (byte[])((byte[])var2);
               this._postSet(41, var7, this._DeploymentPlan);
            } else if (var1.equals("DeploymentPlanDescriptor")) {
               DeploymentPlanBean var8 = this._DeploymentPlanDescriptor;
               this._DeploymentPlanDescriptor = (DeploymentPlanBean)var2;
               this._postSet(29, var8, this._DeploymentPlanDescriptor);
            } else if (var1.equals("DeploymentPlanExternalDescriptors")) {
               var7 = this._DeploymentPlanExternalDescriptors;
               this._DeploymentPlanExternalDescriptors = (byte[])((byte[])var2);
               this._postSet(42, var7, this._DeploymentPlanExternalDescriptors);
            } else if (var1.equals("InstallDir")) {
               var4 = this._InstallDir;
               this._InstallDir = (String)var2;
               this._postSet(14, var4, this._InstallDir);
            } else if (var1.equals("InternalApp")) {
               var5 = this._InternalApp;
               this._InternalApp = (Boolean)var2;
               this._postSet(26, var5, this._InternalApp);
            ...
            } else if (var1.equals("OnDemandContextPaths")) {
               String[] var6 = this._OnDemandContextPaths;
               this._OnDemandContextPaths = (String[])((String[])var2);
               this._postSet(30, var6, this._OnDemandContextPaths);
            } else if (var1.equals("OnDemandDisplayRefresh")) {
               var5 = this._OnDemandDisplayRefresh;
               this._OnDemandDisplayRefresh = (Boolean)var2;
               this._postSet(31, var5, this._OnDemandDisplayRefresh);
               ...
               var4 = this._SecurityDDModel;
               this._SecurityDDModel = (String)var2;
               this._postSet(19, var4, this._SecurityDDModel);
               ...
               var5 = this._ValidateDDSecurityData;
               this._ValidateDDSecurityData = (Boolean)var2;
               this._postSet(18, var5, this._ValidateDDSecurityData);
      ...
      public int getPropertyIndex(String var1) {
         switch (var1.length()) {
            ...
            case 20:
               ...
               break;
            case 21:
               if (var1.equals("background-deployment")) {
                  return 27;
               }
               break;
            case 22:
               ...
               if (var1.equals("on-demand-context-path")) {
                  return 30;
               }
               break;
            case 24:
               ...
               break;
            case 25:
               if (var1.equals("on-demand-display-refresh")) {
                  return 31;
               }
               break;
            case 26:
   ...
   protected static class Helper extends BasicDeploymentMBeanImpl.Helper {
      ...
      protected Helper(AppDeploymentMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      public int getPropertyIndex(String var1) {
         if (var1.equals("AbsoluteInstallDir")) {
            ...
            return var1.equals("ValidateDDSecurityData") ? 18 : super.getPropertyIndex(var1);
         }
      }
      ...
      protected long computeHashValue(CRC32 var1) {
         try {
            ...
            if (this.bean.isInstallDirSet()) {
               var2.append("InstallDir");
               var2.append(String.valueOf(this.bean.getInstallDir()));
            }
            ...
            if (this.bean.isOnDemandContextPathsSet()) {
               var2.append("OnDemandContextPaths");
               var2.append(Arrays.toString(ArrayUtils.copyAndSort(this.bean.getOnDemandContextPaths())));
            }
            ...
            if (this.bean.isBackgroundDeploymentSet()) {
               var2.append("BackgroundDeployment");
               var2.append(String.valueOf(this.bean.isBackgroundDeployment()));
            }
            ...
            if (this.bean.isOnDemandDisplayRefreshSet()) {
               var2.append("OnDemandDisplayRefresh");
               var2.append(String.valueOf(this.bean.isOnDemandDisplayRefresh()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            AppDeploymentMBeanImpl var2 = (AppDeploymentMBeanImpl)var1;
            ...
            this.computeDiff("InstallDir", this.bean.getInstallDir(), var2.getInstallDir(), false);
            ...
            this.computeDiff("SecurityDDModel", this.bean.getSecurityDDModel(), var2.getSecurityDDModel(), false);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            AppDeploymentMBeanImpl var3 = (AppDeploymentMBeanImpl)var1.getSourceBean();
            AppDeploymentMBeanImpl var4 = (AppDeploymentMBeanImpl)var1.getProposedBean();
            String var5 = var2.getPropertyName();
            int var6 = var2.getUpdateType();
            if (!var2.isDerivedUpdate()) {
               if (!var5.equals("AbsoluteInstallDir") && !var5.equals("AbsolutePlanDir") && !var5.equals("AbsolutePlanPath") && !var5.equals("AbsoluteSourcePath")) {
                  if (var5.equals("AltDescriptorPath")) {
                     ...
                     } else if (!var5.equals("DeploymentPlan") && !var5.equals("DeploymentPlanDescriptor") && !var5.equals("DeploymentPlanExternalDescriptors")) {
                        if (var5.equals("InstallDir")) {
                           var3.setInstallDir(var4.getInstallDir());
                           var3._conditionalUnset(var2.isUnsetUpdate(), 14);
                        } else if (!var5.equals("LocalInstallDir") && !var5.equals("LocalPlanDir") && !var5.equals("LocalPlanPath") && !var5.equals("LocalSourcePath")) {
                           if (var5.equals("Name")) {
                              var3.setName(var4.getName());
                              var3._conditionalUnset(var2.isUnsetUpdate(), 2);
                           } else if (!var5.equals("OnDemandContextPaths")) {
                              if (var5.equals("PlanDir")) {
                                 ...
                                 if (var5.equals("SecurityDDModel")) {
                                 ...
                                 } else if (!var5.equals("AutoDeployedApp") && !var5.equals("BackgroundDeployment") && !var5.equals("InternalApp") && !var5.equals("OnDemandDisplayRefresh")) {
                                    if (var5.equals("ValidateDDSecurityData")) {
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            AppDeploymentMBeanImpl var5 = (AppDeploymentMBeanImpl)var1;
            super.finishCopy(var5, var2, var3);
            if ((var3 == null || !var3.contains("AltDescriptorPath")) && this.bean.isAltDescriptorPathSet()) {
               var5.setAltDescriptorPath(this.bean.getAltDescriptorPath());
            }

            if ((var3 == null || !var3.contains("AltWLSDescriptorPath")) && this.bean.isAltWLSDescriptorPathSet()) {
            ...
            if ((var3 == null || !var3.contains("InstallDir")) && this.bean.isInstallDirSet()) {
               var5.setInstallDir(this.bean.getInstallDir());
            }
