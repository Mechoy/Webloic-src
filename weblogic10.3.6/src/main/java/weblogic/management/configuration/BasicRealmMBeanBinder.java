...
public class BasicRealmMBeanBinder extends ConfigurationMBeanBinder implements AttributeBinder {
   private BasicRealmMBeanImpl bean;

   protected BasicRealmMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (BasicRealmMBeanImpl)var1;
   }

   public BasicRealmMBeanBinder() {
      super(new BasicRealmMBeanImpl());
      this.bean = (BasicRealmMBeanImpl)this.getBean();
   }
