...
public class BasicRealmMBeanImpl extends ConfigurationMBeanImpl implements BasicRealmMBean, Serializable {
   private String _RealmClassName;
   private static SchemaHelper2 _schemaHelper;

   public BasicRealmMBeanImpl() {
      this._initializeProperty(-1);
   }

   public BasicRealmMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
      this._initializeProperty(-1);
   }
   ...
   protected static class Helper extends ConfigurationMBeanImpl.Helper {
      private BasicRealmMBeanImpl bean;

      protected Helper(BasicRealmMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            BasicRealmMBeanImpl var2 = (BasicRealmMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            BasicRealmMBeanImpl var3 = (BasicRealmMBeanImpl)var1.getSourceBean();
            BasicRealmMBeanImpl var4 = (BasicRealmMBeanImpl)var1.getProposedBean();
            String var5 = var2.getPropertyName();
            int var6 = var2.getUpdateType();
            if (!var2.isDerivedUpdate()) {
               if (var5.equals("RealmClassName")) {
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            BasicRealmMBeanImpl var5 = (BasicRealmMBeanImpl)var1;
