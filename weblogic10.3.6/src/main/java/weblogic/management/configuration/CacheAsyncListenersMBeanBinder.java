...
public class CacheAsyncListenersMBeanBinder extends ConfigurationMBeanBinder implements AttributeBinder {
   private CacheAsyncListenersMBeanImpl bean;

   protected CacheAsyncListenersMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (CacheAsyncListenersMBeanImpl)var1;
   }

   public CacheAsyncListenersMBeanBinder() {
      super(new CacheAsyncListenersMBeanImpl());
      this.bean = (CacheAsyncListenersMBeanImpl)this.getBean();
   }
