...
public class ClassDeploymentMBeanBinder extends DeploymentMBeanBinder implements AttributeBinder {
   private ClassDeploymentMBeanImpl bean;

   protected ClassDeploymentMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (ClassDeploymentMBeanImpl)var1;
   }

   public ClassDeploymentMBeanBinder() {
      super(new ClassDeploymentMBeanImpl());
      this.bean = (ClassDeploymentMBeanImpl)this.getBean();
   }
