...
public class CoherenceClusterSystemResourceMBeanBinder extends SystemResourceMBeanBinder implements AttributeBinder {
   private CoherenceClusterSystemResourceMBeanImpl bean;

   protected CoherenceClusterSystemResourceMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (CoherenceClusterSystemResourceMBeanImpl)var1;
   }

   public CoherenceClusterSystemResourceMBeanBinder() {
      super(new CoherenceClusterSystemResourceMBeanImpl());
      this.bean = (CoherenceClusterSystemResourceMBeanImpl)this.getBean();
   }
         ...
         if (!(this instanceof SecurityReadOnlyMBeanBinder) && var2 != null && var2.toString().trim().length() == 0) {
            ...
            if (var1 != null) {
               if (var1.equals("CustomClusterConfigurationFileName")) {
                  throw new AssertionError("can't set read-only property CustomClusterConfigurationFileName");
               }
               ...
               if (var1.equals("DescriptorFileName")) {
                  ...
                  try {
                     this.bean.setUsingCustomClusterConfigurationFile(Boolean.valueOf((String)var2));
