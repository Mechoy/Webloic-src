...
public class CoherenceServerStartMBeanImplBeanInfo extends ManagedExternalServerStartMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = CoherenceServerStartMBean.class;

   public CoherenceServerStartMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = CoherenceServerStartMBeanImpl.class;
      ...
      var2.setValue("interfaceclassname", "weblogic.management.configuration.CoherenceServerStartMBean");
