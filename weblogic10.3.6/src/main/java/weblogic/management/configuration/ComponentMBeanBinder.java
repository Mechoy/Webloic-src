...
public class ComponentMBeanBinder extends DeploymentMBeanBinder implements AttributeBinder {
   private ComponentMBeanImpl bean;

   protected ComponentMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (ComponentMBeanImpl)var1;
   }

   public ComponentMBeanBinder() {
      super(new ComponentMBeanImpl());
      this.bean = (ComponentMBeanImpl)this.getBean();
   }
