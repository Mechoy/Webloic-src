...
public class ComponentMBeanImpl extends DeploymentMBeanImpl implements ComponentMBean, Serializable {
   private TargetMBean[] _ActivatedTargets;
   private ApplicationMBean _Application;
   private String _Name;
   private TargetMBean[] _Targets;
   private String _URI;
   private Component _customizer;
   private static SchemaHelper2 _schemaHelper;

   public ComponentMBeanImpl() {
      try {
         this._customizer = new Component(this);
   ...
   public ComponentMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
            ...
            if (var3.contains(var5)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(var5, TargetMBean.class, new ReferenceManager.Resolver(this, 7) {
                  public void resolveReference(Object var1) {
                     try {
                        ComponentMBeanImpl.this.addTarget((TargetMBean)var1);
         ...
         if (var1[var2] != null) {
            ResolvedReference var3 = new ResolvedReference(this, 7, (AbstractDescriptorBean)var1[var2]) {
               protected Object getPropertyValue() {
                  return ComponentMBeanImpl.this.getTargets();
               }
            };
   ...
   public void putValue(String var1, Object var2) {
      ...
      if (var1.equals("ActivatedTargets")) {
         ...
         } else if (var1.equals("URI")) {
            var4 = this._URI;
            this._URI = (String)var2;
            this._postSet(10, var4, this._URI);
         } else if (var1.equals("customizer")) {
            Component var3 = this._customizer;
            this._customizer = (Component)var2;
         } else {
   ...
   protected static class Helper extends DeploymentMBeanImpl.Helper {
      private ComponentMBeanImpl bean;

      protected Helper(ComponentMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      public int getPropertyIndex(String var1) {
         if (var1.equals("ActivatedTargets")) {
            ...
            return var1.equals("URI") ? 10 : super.getPropertyIndex(var1);
         }
      }
      ...
      protected long computeHashValue(CRC32 var1) {
         try {
            ...
            if (this.bean.isURISet()) {
               var2.append("URI");
               var2.append(String.valueOf(this.bean.getURI()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            ComponentMBeanImpl var2 = (ComponentMBeanImpl)var1;
            this.computeDiff("Name", this.bean.getName(), var2.getName(), false);
            this.computeDiff("Targets", this.bean.getTargets(), var2.getTargets(), true);
            this.computeDiff("URI", this.bean.getURI(), var2.getURI(), true);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            ComponentMBeanImpl var3 = (ComponentMBeanImpl)var1.getSourceBean();
            ComponentMBeanImpl var4 = (ComponentMBeanImpl)var1.getProposedBean();
            ...
            if (!var2.isDerivedUpdate()) {
               if (!var5.equals("ActivatedTargets") && !var5.equals("Application")) {
                  ...
                  } else if (var5.equals("URI")) {
                     var3.setURI(var4.getURI());
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            ComponentMBeanImpl var5 = (ComponentMBeanImpl)var1;
            ...
            if ((var3 == null || !var3.contains("URI")) && this.bean.isURISet()) {
               var5.setURI(this.bean.getURI());
            }
