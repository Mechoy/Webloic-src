...
public class ConfigurationExtensionMBeanBinder extends ConfigurationMBeanBinder implements AttributeBinder {
   private ConfigurationExtensionMBeanImpl bean;

   protected ConfigurationExtensionMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (ConfigurationExtensionMBeanImpl)var1;
   }

   public ConfigurationExtensionMBeanBinder() {
      super(new ConfigurationExtensionMBeanImpl());
      this.bean = (ConfigurationExtensionMBeanImpl)this.getBean();
   }
