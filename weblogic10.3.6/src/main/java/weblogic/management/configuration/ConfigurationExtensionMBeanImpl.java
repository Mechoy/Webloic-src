...
public class ConfigurationExtensionMBeanImpl extends ConfigurationMBeanImpl implements ConfigurationExtensionMBean, Serializable {
   ...
   public ConfigurationExtensionMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
   ...
   public void putValue(String var1, Object var2) {
      ...
      if (var1.equals("DescriptorFileName")) {
         ...
         this._postSet(7, var4, this._DescriptorFileName);
      } else if (var1.equals("Name")) {
         var4 = this._Name;
         this._Name = (String)var2;
         this._postSet(2, var4, this._Name);
      } else if (var1.equals("customizer")) {
         ConfigurationExtension var3 = this._customizer;
         this._customizer = (ConfigurationExtension)var2;
      } else {
   ...
   protected static class Helper extends ConfigurationMBeanImpl.Helper {
      ...
      protected Helper(ConfigurationExtensionMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            ConfigurationExtensionMBeanImpl var2 = (ConfigurationExtensionMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            ConfigurationExtensionMBeanImpl var3 = (ConfigurationExtensionMBeanImpl)var1.getSourceBean();
            ConfigurationExtensionMBeanImpl var4 = (ConfigurationExtensionMBeanImpl)var1.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            ConfigurationExtensionMBeanImpl var5 = (ConfigurationExtensionMBeanImpl)var1;
