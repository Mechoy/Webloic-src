...
import weblogic.management.WebLogicMBeanBinder;
import weblogic.management.internal.mbean.SecurityReadOnlyMBeanBinder;
import weblogic.utils.codegen.AttributeBinder;

public class ConfigurationMBeanBinder extends WebLogicMBeanBinder implements AttributeBinder {
   private ConfigurationMBeanImpl bean;

   protected ConfigurationMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (ConfigurationMBeanImpl)var1;
   }

   public ConfigurationMBeanBinder() {
      super(new ConfigurationMBeanImpl());
      this.bean = (ConfigurationMBeanImpl)this.getBean();
   }
