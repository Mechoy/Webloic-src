...
public class ConnectorComponentMBeanImplBeanInfo extends ComponentMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = ConnectorComponentMBean.class;

   public ConnectorComponentMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }

   public ConnectorComponentMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = ConnectorComponentMBeanImpl.class;
      ...
      String var3 = (new String("This bean defines a Resource Adapter.  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX.\"</p> ")).intern();
      var2.setShortDescription(var3);
      var2.setValue("description", var3);
      String[] var4 = new String[]{BeanInfoHelper.encodeEntities("Deployer")};
      var2.setValue("rolesAllowed", var4);
      var2.setValue("interfaceclassname", "weblogic.management.configuration.ConnectorComponentMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (BeanInfoHelper.isVersionCompliant("7.0.0.0", (String)null, this.targetVersion) && !var1.containsKey("ActivatedTargets")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("ActivatedTargets", ConnectorComponentMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Application")) {
         ...
         var2 = new PropertyDescriptor("Application", ConnectorComponentMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", ConnectorComponentMBean.class, var3, var4);
         var1.put("Name", var2);
      ...
      if (!var1.containsKey("Targets")) {
         ...
         var2 = new PropertyDescriptor("Targets", ConnectorComponentMBean.class, var3, var4);
   ...
   private void fillinCollectionMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = ConnectorComponentMBean.class.getMethod("addTarget", TargetMBean.class);
      ...
      var3 = ConnectorComponentMBean.class.getMethod("removeTarget", TargetMBean.class);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("7.0.0.0", (String)null, this.targetVersion)) {
         var3 = ConnectorComponentMBean.class.getMethod("activated", TargetMBean.class);
         var4 = new ParameterDescriptor[]{createParameterDescriptor("target", (String)null)};
         var5 = BeanInfoHelper.buildMethodKey(var3);
         if (!var1.containsKey(var5)) {
            var2 = new MethodDescriptor(var3, var4);
      ...
      var3 = ConnectorComponentMBean.class.getMethod("refreshDDsIfNeeded", String[].class);
      ...
      var3 = ConnectorComponentMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      var3 = ConnectorComponentMBean.class.getMethod("restoreDefaultValue", String.class);
      var4 = new ParameterDescriptor[]{createParameterDescriptor("attributeName", (String)null)};
      var5 = BeanInfoHelper.buildMethodKey(var3);
