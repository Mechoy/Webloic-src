...
public class DataSourceMBeanBinder extends DeploymentMBeanBinder implements AttributeBinder {
   private DataSourceMBeanImpl bean;

   protected DataSourceMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (DataSourceMBeanImpl)var1;
   }

   public DataSourceMBeanBinder() {
      super(new DataSourceMBeanImpl());
      this.bean = (DataSourceMBeanImpl)this.getBean();
   }
         ...
         if (!(this instanceof SecurityReadOnlyMBeanBinder) && var2 != null && var2.toString().trim().length() == 0) {
            ...
            if (var1 != null) {
               if (var1.equals("DataSourceLogFile")) {
                  try {
                     this.bean.setDataSourceLogFile((DataSourceLogFileMBean)((ReadOnlyMBeanBinder)var2).getBean());
                  ...
                  try {
                     this.bean.setRmiJDBCSecurity((String)var2);
