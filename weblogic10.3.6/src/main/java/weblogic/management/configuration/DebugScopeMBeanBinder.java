...
public class DebugScopeMBeanBinder extends ConfigurationMBeanBinder implements AttributeBinder {
   private DebugScopeMBeanImpl bean;

   protected DebugScopeMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (DebugScopeMBeanImpl)var1;
   }

   public DebugScopeMBeanBinder() {
      super(new DebugScopeMBeanImpl());
      this.bean = (DebugScopeMBeanImpl)this.getBean();
   }
