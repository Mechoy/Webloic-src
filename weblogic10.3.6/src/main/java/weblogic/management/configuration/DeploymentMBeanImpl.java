...
public class DeploymentMBeanImpl extends ConfigurationMBeanImpl implements DeploymentMBean, Serializable {
   ...
   public DeploymentMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
      this._initializeProperty(-1);
   }
            ...
            if (var3.contains(var5)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(var5, TargetMBean.class, new ReferenceManager.Resolver(this, 7) {
                  public void resolveReference(Object var1) {
                     try {
                        DeploymentMBeanImpl.this.addTarget((TargetMBean)var1);
   ...
   public void putValue(String var1, Object var2) {
      if (var1.equals("DeploymentOrder")) {
         ...
         this._postSet(8, var4, this._DeploymentOrder);
   ...
   protected static class Helper extends ConfigurationMBeanImpl.Helper {
      ...
      protected Helper(DeploymentMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            DeploymentMBeanImpl var2 = (DeploymentMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            DeploymentMBeanImpl var3 = (DeploymentMBeanImpl)var1.getSourceBean();
            DeploymentMBeanImpl var4 = (DeploymentMBeanImpl)var1.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            DeploymentMBeanImpl var5 = (DeploymentMBeanImpl)var1;
