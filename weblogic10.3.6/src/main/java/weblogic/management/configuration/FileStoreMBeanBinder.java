...
public class FileStoreMBeanBinder extends GenericFileStoreMBeanBinder implements AttributeBinder {
   private FileStoreMBeanImpl bean;

   protected FileStoreMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (FileStoreMBeanImpl)var1;
   }

   public FileStoreMBeanBinder() {
      super(new FileStoreMBeanImpl());
      this.bean = (FileStoreMBeanImpl)this.getBean();
   }
