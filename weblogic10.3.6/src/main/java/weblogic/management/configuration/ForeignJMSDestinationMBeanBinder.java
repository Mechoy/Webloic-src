...
public class ForeignJMSDestinationMBeanBinder extends ForeignJNDIObjectMBeanBinder implements AttributeBinder {
   private ForeignJMSDestinationMBeanImpl bean;

   protected ForeignJMSDestinationMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (ForeignJMSDestinationMBeanImpl)var1;
   }

   public ForeignJMSDestinationMBeanBinder() {
      super(new ForeignJMSDestinationMBeanImpl());
      this.bean = (ForeignJMSDestinationMBeanImpl)this.getBean();
   }
