...
public class ForeignJNDILinkMBeanBinder extends ConfigurationMBeanBinder implements AttributeBinder {
   private ForeignJNDILinkMBeanImpl bean;

   protected ForeignJNDILinkMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (ForeignJNDILinkMBeanImpl)var1;
   }

   public ForeignJNDILinkMBeanBinder() {
      super(new ForeignJNDILinkMBeanImpl());
      this.bean = (ForeignJNDILinkMBeanImpl)this.getBean();
   }
