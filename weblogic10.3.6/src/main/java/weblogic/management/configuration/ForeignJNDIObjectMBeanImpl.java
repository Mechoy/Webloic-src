...
public class ForeignJNDIObjectMBeanImpl extends ConfigurationMBeanImpl implements ForeignJNDIObjectMBean, Serializable {
   private String _LocalJNDIName;
   private String _RemoteJNDIName;
   private static SchemaHelper2 _schemaHelper;

   public ForeignJNDIObjectMBeanImpl() {
      this._initializeProperty(-1);
   }

   public ForeignJNDIObjectMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
      this._initializeProperty(-1);
   }
   ...
   protected static class Helper extends ConfigurationMBeanImpl.Helper {
      ...
      protected Helper(ForeignJNDIObjectMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            ForeignJNDIObjectMBeanImpl var2 = (ForeignJNDIObjectMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            ForeignJNDIObjectMBeanImpl var3 = (ForeignJNDIObjectMBeanImpl)var1.getSourceBean();
            ForeignJNDIObjectMBeanImpl var4 = (ForeignJNDIObjectMBeanImpl)var1.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            ForeignJNDIObjectMBeanImpl var5 = (ForeignJNDIObjectMBeanImpl)var1;
