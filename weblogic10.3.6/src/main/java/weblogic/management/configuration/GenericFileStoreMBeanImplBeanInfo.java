...
public class GenericFileStoreMBeanImplBeanInfo extends ConfigurationMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = GenericFileStoreMBean.class;

   public GenericFileStoreMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = GenericFileStoreMBeanImpl.class;
      ...
      String var3 = (new String("<p>This MBean defines common parameters for file stores. It is the parent of FileStoreMBean and the deprecated JMSFileStoreMBean.</p> ")).intern();
      var2.setShortDescription(var3);
      var2.setValue("description", var3);
      var2.setValue("interfaceclassname", "weblogic.management.configuration.GenericFileStoreMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("BlockSize")) {
         ...
         var2 = new PropertyDescriptor("BlockSize", GenericFileStoreMBean.class, var3, var4);
      ...
      if (!var1.containsKey("CacheDirectory")) {
         ...
         var2 = new PropertyDescriptor("CacheDirectory", GenericFileStoreMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Directory")) {
         ...
         var2 = new PropertyDescriptor("Directory", GenericFileStoreMBean.class, var3, var4);
      ...
      if (!var1.containsKey("InitialSize")) {
         ...
         var2 = new PropertyDescriptor("InitialSize", GenericFileStoreMBean.class, var3, var4);
      ...
      if (!var1.containsKey("IoBufferSize")) {
         ...
         var2 = new PropertyDescriptor("IoBufferSize", GenericFileStoreMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MaxFileSize")) {
         ...
         var2 = new PropertyDescriptor("MaxFileSize", GenericFileStoreMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MaxWindowBufferSize")) {
         ...
         var2 = new PropertyDescriptor("MaxWindowBufferSize", GenericFileStoreMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MinWindowBufferSize")) {
         ...
         var2 = new PropertyDescriptor("MinWindowBufferSize", GenericFileStoreMBean.class, var3, var4);
      ...
      if (!var1.containsKey("SynchronousWritePolicy")) {
         ...
         var2 = new PropertyDescriptor("SynchronousWritePolicy", GenericFileStoreMBean.class, var3, var4);
      ...
      if (!var1.containsKey("FileLockingEnabled")) {
         ...
         var2 = new PropertyDescriptor("FileLockingEnabled", GenericFileStoreMBean.class, var3, var4);
