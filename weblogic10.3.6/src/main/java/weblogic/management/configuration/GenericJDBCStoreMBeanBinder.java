...
public class GenericJDBCStoreMBeanBinder extends ConfigurationMBeanBinder implements AttributeBinder {
   private GenericJDBCStoreMBeanImpl bean;

   protected GenericJDBCStoreMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (GenericJDBCStoreMBeanImpl)var1;
   }

   public GenericJDBCStoreMBeanBinder() {
      super(new GenericJDBCStoreMBeanImpl());
      this.bean = (GenericJDBCStoreMBeanImpl)this.getBean();
   }
