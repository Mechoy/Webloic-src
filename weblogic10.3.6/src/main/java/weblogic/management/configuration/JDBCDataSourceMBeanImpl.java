...
public class JDBCDataSourceMBeanImpl extends DeploymentMBeanImpl implements JDBCDataSourceMBean, Serializable {
   ...
   public JDBCDataSourceMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
            ...
            if (var3.contains(var5)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(var5, TargetMBean.class, new ReferenceManager.Resolver(this, 7) {
                  public void resolveReference(Object var1) {
                     try {
                        JDBCDataSourceMBeanImpl.this.addTarget((TargetMBean)var1);
   ...
   public void setJDBCSystemResourceAsString(String var1) {
      if (var1 != null && var1.length() != 0) {
         ...
         this._getReferenceManager().registerUnresolvedReference(var1, JDBCSystemResourceMBean.class, new ReferenceManager.Resolver(this, 9) {
            public void resolveReference(Object var1) {
               try {
                  JDBCDataSourceMBeanImpl.this.setJDBCSystemResource((JDBCSystemResourceMBean)var1);
               } catch (RuntimeException var3) {
                  throw var3;
               } catch (Exception var4) {
                  throw new AssertionError("Impossible exception: " + var4);
   ...
   public void setWaitForConnectionEnabled(boolean var1) {
      boolean var2 = this._WaitForConnectionEnabled;
      this._WaitForConnectionEnabled = var1;
   ...
   public void setConnectionWaitPeriod(int var1) {
      weblogic.descriptor.beangen.LegalChecks.checkInRange("ConnectionWaitPeriod", (long)var1, 1L, 60L);
      int var2 = this._ConnectionWaitPeriod;
      this._ConnectionWaitPeriod = var1;
   ...
   public void putValue(String var1, Object var2) {
      ...
      if (var1.equals("ConnectionWaitPeriod")) {
         var6 = this._ConnectionWaitPeriod;
         this._ConnectionWaitPeriod = (Integer)var2;
         this._postSet(17, var6, this._ConnectionWaitPeriod);
         ...
         if (var1.equals("JNDIName")) {
            ...
            boolean var4;
            if (var1.equals("RowPrefetchEnabled")) {
               var4 = this._RowPrefetchEnabled;
               this._RowPrefetchEnabled = (Boolean)var2;
               this._postSet(13, var4, this._RowPrefetchEnabled);
            } else if (var1.equals("RowPrefetchSize")) {
               var6 = this._RowPrefetchSize;
               this._RowPrefetchSize = (Integer)var2;
               this._postSet(14, var6, this._RowPrefetchSize);
            } else if (var1.equals("StreamChunkSize")) {
               var6 = this._StreamChunkSize;
               this._StreamChunkSize = (Integer)var2;
               this._postSet(15, var6, this._StreamChunkSize);
               ...
               var4 = this._WaitForConnectionEnabled;
               this._WaitForConnectionEnabled = (Boolean)var2;
               this._postSet(16, var4, this._WaitForConnectionEnabled);
            } else if (var1.equals("customizer")) {
               JDBCDataSource var3 = this._customizer;
               this._customizer = (JDBCDataSource)var2;
            } else {
   ...
   public static void validateGeneration() {
      try {
         ...
         throw new DescriptorValidateException("The default value for the property  is zero-length. Properties annotated with false value on @legalZeroLength or @legalNull  should either have @required/@derivedDefault annotations or have a non-zero-length value on @default annotation. Refer annotation legalZeroLength on property JNDINameSeparator in JDBCDataSourceMBean" + var2.getMessage());
      }

      try {
         weblogic.descriptor.beangen.LegalChecks.checkNonNull("JNDINameSeparator", "JNDINameSeparator");
      } catch (IllegalArgumentException var1) {
         throw new DescriptorValidateException("The default value for the property  is null. Properties annotated with false value on @legalZeroLength or @legalNull  should either have @required/@derivedDefault annotations or have a non-null value on @default annotation. Refer annotation legalNull on property JNDINameSeparator in JDBCDataSourceMBean" + var1.getMessage());
      }
   }
      ...
      public int getPropertyIndex(String var1) {
         switch (var1.length()) {
            ...
            case 20:
               ...
               break;
            case 22:
               if (var1.equals("connection-wait-period")) {
                  return 17;
               }
               break;
            case 27:
               if (var1.equals("wait-for-connection-enabled")) {
                  return 16;
               }
         }
   ...
   protected static class Helper extends DeploymentMBeanImpl.Helper {
      ...
      protected Helper(JDBCDataSourceMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      public int getPropertyIndex(String var1) {
         if (var1.equals("ConnectionWaitPeriod")) {
            ...
            return var1.equals("WaitForConnectionEnabled") ? 16 : super.getPropertyIndex(var1);
         }
      }
      ...
      protected long computeHashValue(CRC32 var1) {
         try {
            ...
            if (this.bean.isConnectionWaitPeriodSet()) {
               var2.append("ConnectionWaitPeriod");
               var2.append(String.valueOf(this.bean.getConnectionWaitPeriod()));
            }
            ...
            if (this.bean.isWaitForConnectionEnabledSet()) {
               var2.append("WaitForConnectionEnabled");
               var2.append(String.valueOf(this.bean.isWaitForConnectionEnabled()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            JDBCDataSourceMBeanImpl var2 = (JDBCDataSourceMBeanImpl)var1;
            if (BootstrapProperties.INCLUDE_OBSOLETE_PROPS_IN_DIFF) {
               this.computeDiff("ConnectionWaitPeriod", this.bean.getConnectionWaitPeriod(), var2.getConnectionWaitPeriod(), false);
            }
            ...
            if (BootstrapProperties.INCLUDE_OBSOLETE_PROPS_IN_DIFF) {
               this.computeDiff("WaitForConnectionEnabled", this.bean.isWaitForConnectionEnabled(), var2.isWaitForConnectionEnabled(), false);
            }
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            JDBCDataSourceMBeanImpl var3 = (JDBCDataSourceMBeanImpl)var1.getSourceBean();
            JDBCDataSourceMBeanImpl var4 = (JDBCDataSourceMBeanImpl)var1.getProposedBean();
            String var5 = var2.getPropertyName();
            int var6 = var2.getUpdateType();
            if (!var2.isDerivedUpdate()) {
               if (var5.equals("ConnectionWaitPeriod")) {
                  var3.setConnectionWaitPeriod(var4.getConnectionWaitPeriod());
               ...
               } else if (var5.equals("WaitForConnectionEnabled")) {
                  var3.setWaitForConnectionEnabled(var4.isWaitForConnectionEnabled());
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            JDBCDataSourceMBeanImpl var5 = (JDBCDataSourceMBeanImpl)var1;
            super.finishCopy(var5, var2, var3);
            if (var2 && (var3 == null || !var3.contains("ConnectionWaitPeriod")) && this.bean.isConnectionWaitPeriodSet()) {
               var5.setConnectionWaitPeriod(this.bean.getConnectionWaitPeriod());
            }
            ...
            if (var2 && (var3 == null || !var3.contains("WaitForConnectionEnabled")) && this.bean.isWaitForConnectionEnabledSet()) {
               var5.setWaitForConnectionEnabled(this.bean.isWaitForConnectionEnabled());
            }
