...
public class JDBCPoolComponentMBeanBinder extends ComponentMBeanBinder implements AttributeBinder {
   private JDBCPoolComponentMBeanImpl bean;

   protected JDBCPoolComponentMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (JDBCPoolComponentMBeanImpl)var1;
   }

   public JDBCPoolComponentMBeanBinder() {
      super(new JDBCPoolComponentMBeanImpl());
      this.bean = (JDBCPoolComponentMBeanImpl)this.getBean();
   }
