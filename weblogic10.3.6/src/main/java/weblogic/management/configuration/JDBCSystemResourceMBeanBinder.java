...
public class JDBCSystemResourceMBeanBinder extends SystemResourceMBeanBinder implements AttributeBinder {
   private JDBCSystemResourceMBeanImpl bean;

   protected JDBCSystemResourceMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (JDBCSystemResourceMBeanImpl)var1;
   }

   public JDBCSystemResourceMBeanBinder() {
      super(new JDBCSystemResourceMBeanImpl());
      this.bean = (JDBCSystemResourceMBeanImpl)this.getBean();
   }
