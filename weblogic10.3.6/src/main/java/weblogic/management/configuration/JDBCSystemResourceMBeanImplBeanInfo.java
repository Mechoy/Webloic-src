...
public class JDBCSystemResourceMBeanImplBeanInfo extends SystemResourceMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = JDBCSystemResourceMBean.class;

   public JDBCSystemResourceMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }

   public JDBCSystemResourceMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = JDBCSystemResourceMBeanImpl.class;
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("DescriptorFileName")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("DescriptorFileName", JDBCSystemResourceMBean.class, var3, var4);
         var1.put("DescriptorFileName", var2);
         var2.setValue("description", "The name of the file containing this configuration.  This is a relative name rooted at DOMAIN_DIR/config.  By default the file resides in the jdbc subdirectory and derives its name from the bean name using the following pattern: <p> <beanName>.xml <p> Note that this is a read-only property that can only be set when the bean is created. <p> ");
      }

      if (!var1.containsKey("JDBCResource")) {
         var3 = "getJDBCResource";
         var4 = null;
         var2 = new PropertyDescriptor("JDBCResource", JDBCSystemResourceMBean.class, var3, var4);
         var1.put("JDBCResource", var2);
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", JDBCSystemResourceMBean.class, var3, var4);
         var1.put("Name", var2);
      ...
      if (!var1.containsKey("Resource")) {
         var3 = "getResource";
         var4 = null;
         var2 = new PropertyDescriptor("Resource", JDBCSystemResourceMBean.class, var3, var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = JDBCSystemResourceMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      var3 = JDBCSystemResourceMBean.class.getMethod("restoreDefaultValue", String.class);
