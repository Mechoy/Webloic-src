...
public class JMSConnectionConsumerMBeanBinder extends ConfigurationMBeanBinder implements AttributeBinder {
   private JMSConnectionConsumerMBeanImpl bean;

   protected JMSConnectionConsumerMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (JMSConnectionConsumerMBeanImpl)var1;
   }

   public JMSConnectionConsumerMBeanBinder() {
      super(new JMSConnectionConsumerMBeanImpl());
      this.bean = (JMSConnectionConsumerMBeanImpl)this.getBean();
   }
         ...
         if (!(this instanceof SecurityReadOnlyMBeanBinder) && var2 != null && var2.toString().trim().length() == 0) {
            ...
            if (var1 != null) {
               if (var1.equals("Destination")) {
                  try {
                     this.bean.setDestination((String)var2);
