...
public class JMSDestCommonMBeanImplBeanInfo extends ConfigurationMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = JMSDestCommonMBean.class;

   public JMSDestCommonMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = JMSDestCommonMBeanImpl.class;
      ...
      String var3 = (new String("This class represents common JMS destination and JMS template methods. <p>A JMS destination identifies either a queue (Point-To-Point) or a topic (Pub/Sub) for a JMS server. A JMS template provides an efficient means of defining multiple destinations with similar attribute settings.</p>  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX.\"</p> ")).intern();
      var2.setShortDescription(var3);
      var2.setValue("description", var3);
      var2.setValue("interfaceclassname", "weblogic.management.configuration.JMSDestCommonMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("BytesMaximum")) {
         ...
         var2 = new PropertyDescriptor("BytesMaximum", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("BytesThresholdHigh")) {
         ...
         var2 = new PropertyDescriptor("BytesThresholdHigh", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("BytesThresholdLow")) {
         ...
         var2 = new PropertyDescriptor("BytesThresholdLow", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("DeliveryModeOverride")) {
         ...
         var2 = new PropertyDescriptor("DeliveryModeOverride", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("DestinationKeys")) {
         ...
         var2 = new PropertyDescriptor("DestinationKeys", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("ErrorDestination")) {
         ...
         var2 = new PropertyDescriptor("ErrorDestination", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("ExpirationLoggingPolicy")) {
         ...
         var2 = new PropertyDescriptor("ExpirationLoggingPolicy", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("ExpirationPolicy")) {
         ...
         var2 = new PropertyDescriptor("ExpirationPolicy", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MaximumMessageSize")) {
         ...
         var2 = new PropertyDescriptor("MaximumMessageSize", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MessagesMaximum")) {
         ...
         var2 = new PropertyDescriptor("MessagesMaximum", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MessagesThresholdHigh")) {
         ...
         var2 = new PropertyDescriptor("MessagesThresholdHigh", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MessagesThresholdLow")) {
         ...
         var2 = new PropertyDescriptor("MessagesThresholdLow", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("PriorityOverride")) {
         ...
         var2 = new PropertyDescriptor("PriorityOverride", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("RedeliveryDelayOverride")) {
         ...
         var2 = new PropertyDescriptor("RedeliveryDelayOverride", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("RedeliveryLimit")) {
         ...
         var2 = new PropertyDescriptor("RedeliveryLimit", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("TimeToDeliverOverride")) {
         ...
         var2 = new PropertyDescriptor("TimeToDeliverOverride", JMSDestCommonMBean.class, var3, var4);
      ...
      if (!var1.containsKey("TimeToLiveOverride")) {
         ...
         var2 = new PropertyDescriptor("TimeToLiveOverride", JMSDestCommonMBean.class, var3, var4);
   ...
   private void fillinCollectionMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = JMSDestCommonMBean.class.getMethod("addDestinationKey", JMSDestinationKeyMBean.class);
      ...
      var3 = JMSDestCommonMBean.class.getMethod("removeDestinationKey", JMSDestinationKeyMBean.class);
