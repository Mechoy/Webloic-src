...
public class JMSDestinationKeyMBeanImplBeanInfo extends ConfigurationMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = JMSDestinationKeyMBean.class;

   public JMSDestinationKeyMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }

   public JMSDestinationKeyMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = JMSDestinationKeyMBeanImpl.class;
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("Direction")) {
         ...
         var2 = new PropertyDescriptor("Direction", JMSDestinationKeyMBean.class, var3, var4);
         var1.put("Direction", var2);
         var2.setValue("description", "<p>The direction (Ascending or Descending) in which this key will sort messages. Select <tt>Ascending</tt> for a FIFO (first in, first out) sort order. Select <tt>Descending</tt> for a LIFO (last in, first out) sort order.</p>  <p><i>Note:</i> This attribute is not dynamically configurable.</p> ");
         setPropertyDescriptorDefault(var2, "Ascending");
         var2.setValue("legalValues", new Object[]{"Ascending", "Descending"});
         var2.setValue("dynamic", Boolean.FALSE);
      }

      if (!var1.containsKey("KeyType")) {
         var3 = "getKeyType";
         var4 = null;
         if (!this.readOnly) {
            var4 = "setKeyType";
         ...
         var2 = new PropertyDescriptor("KeyType", JMSDestinationKeyMBean.class, var3, var4);
         var1.put("KeyType", var2);
         var2.setValue("description", "<p>The expected sort key type for this JMS destination key. (This field is ignored for message header field keys, which have an implied type.)</p> ");
         setPropertyDescriptorDefault(var2, "String");
         var2.setValue("legalValues", new Object[]{"Boolean", "Byte", "Short", "Int", "Long", "Float", "Double", "String"});
         var2.setValue("dynamic", Boolean.FALSE);
      }
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", JMSDestinationKeyMBean.class, var3, var4);
         var1.put("Name", var2);
      ...
      if (!var1.containsKey("Notes")) {
         ...
         var2 = new PropertyDescriptor("Notes", JMSDestinationKeyMBean.class, var3, var4);
         var1.put("Notes", var2);
      ...
      if (!var1.containsKey("Property")) {
         ...
         var2 = new PropertyDescriptor("Property", JMSDestinationKeyMBean.class, var3, var4);
         var1.put("Property", var2);
         var2.setValue("description", "<p>The message property name or the name of a message header field on which to sort. Message header field keys start with the letters \"JMS\" and ignore the Key Type field. (For better performance, use message header fields as sorting keys, rather than message properties.)</p>  <p style=\"font-style: italic\"><b>Range of Values</b>: The JMS Property name (including user properties) or message header fields that can be sorted on are:</p>  <ul> <li> <p>JMSMessageID</p> </li>  <li> <p>JMSTimestamp</p> </li>  <li> <p>JMSCorrelationID</p> </li>  <li> <p>JMSPriority</p> </li>  <li> <p>JMSExpiration</p> </li>  <li> <p>JMSType</p> </li>  <li> <p>JMSRedelivered</p> </li>  <li> <p>JMSDeliveryTime</p> </li> </ul>  <p><i>Note:</i> This attribute is not dynamically configurable.</p> ");
         var2.setValue("legalNull", Boolean.TRUE);
         var2.setValue("dynamic", Boolean.FALSE);
      }
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = JMSDestinationKeyMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      var3 = JMSDestinationKeyMBean.class.getMethod("restoreDefaultValue", String.class);
