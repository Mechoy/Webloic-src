...
public class JMSDistributedDestinationMBeanImpl extends JMSVirtualDestinationMBeanImpl implements JMSDistributedDestinationMBean, Serializable {
   ...
   private JMSDistributedDestination _customizer;
   private static SchemaHelper2 _schemaHelper;

   public JMSDistributedDestinationMBeanImpl() {
      try {
         this._customizer = new JMSDistributedDestination(this);
   ...
   public JMSDistributedDestinationMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
            ...
            if (var3.contains(var5)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(var5, TargetMBean.class, new ReferenceManager.Resolver(this, 7) {
                  public void resolveReference(Object var1) {
                     try {
                        JMSDistributedDestinationMBeanImpl.this.addTarget((TargetMBean)var1);
         ...
         if (var1[var2] != null) {
            ResolvedReference var3 = new ResolvedReference(this, 7, (AbstractDescriptorBean)var1[var2]) {
               protected Object getPropertyValue() {
                  return JMSDistributedDestinationMBeanImpl.this.getTargets();
               }
            };
   ...
   public void setTemplateAsString(String var1) {
      if (var1 != null && var1.length() != 0) {
         ...
         this._getReferenceManager().registerUnresolvedReference(var1, JMSTemplateMBean.class, new ReferenceManager.Resolver(this, 11) {
            public void resolveReference(Object var1) {
               try {
                  JMSDistributedDestinationMBeanImpl.this.setTemplate((JMSTemplateMBean)var1);
               } catch (RuntimeException var3) {
                  throw var3;
               } catch (Exception var4) {
                  throw new AssertionError("Impossible exception: " + var4);
   ...
   public String getType() {
      return "JMSDistributedDestination";
   }
   ...
   public void putValue(String var1, Object var2) {
      ...
      if (var1.equals("JMSTemplate")) {
         ...
         if (var1.equals("JNDIName")) {
            ...
            JMSDistributedDestination var3 = this._customizer;
            this._customizer = (JMSDistributedDestination)var2;
         } else {
   ...
   public static class SchemaHelper2 extends JMSVirtualDestinationMBeanImpl.SchemaHelper2 implements SchemaHelper {
   ...
   protected static class Helper extends JMSVirtualDestinationMBeanImpl.Helper {
      private JMSDistributedDestinationMBeanImpl bean;

      protected Helper(JMSDistributedDestinationMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            JMSDistributedDestinationMBeanImpl var2 = (JMSDistributedDestinationMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            JMSDistributedDestinationMBeanImpl var3 = (JMSDistributedDestinationMBeanImpl)var1.getSourceBean();
            JMSDistributedDestinationMBeanImpl var4 = (JMSDistributedDestinationMBeanImpl)var1.getProposedBean();
            String var5 = var2.getPropertyName();
            int var6 = var2.getUpdateType();
            if (!var2.isDerivedUpdate()) {
               if (var5.equals("JMSTemplate")) {
                  if (var6 == 2) {
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            JMSDistributedDestinationMBeanImpl var5 = (JMSDistributedDestinationMBeanImpl)var1;
