...
public class JMSDistributedQueueMBeanImplBeanInfo extends JMSDistributedDestinationMBeanImplBeanInfo {
   ...
   public JMSDistributedQueueMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = JMSDistributedQueueMBeanImpl.class;
      ...
      var2.setValue("deprecated", "9.0.0.0 Replaced by {@link weblogic.j2ee.descriptor.wl.DistributedQueueBean} ");
      String[] var3 = new String[]{BeanInfoHelper.encodeEntities("weblogic.j2ee.descriptor.wl.UniformDistributedQueueBean")};
      var2.setValue("see", var3);
      var2.setValue("package", "weblogic.management.configuration");
      String var4 = (new String("This class represents a JMS distributed queue, which is comprised of multiple physical JMS queues as members of a single distributed set of queues that can be served by multiple WebLogic Server instances within a cluster.  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX.\"</p> ")).intern();
      ...
      var2.setValue("interfaceclassname", "weblogic.management.configuration.JMSDistributedQueueMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      String var3;
      String var4;
      if (!var1.containsKey("ForwardDelay")) {
         var3 = "getForwardDelay";
         var4 = null;
         if (!this.readOnly) {
            var4 = "setForwardDelay";
         }

         var2 = new PropertyDescriptor("ForwardDelay", JMSDistributedQueueMBean.class, var3, var4);
         var1.put("ForwardDelay", var2);
         ...
         var2.setValue("secureValue", new Integer(-1));
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion) && !var1.containsKey("JMSDistributedQueueMembers")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("JMSDistributedQueueMembers", JMSDistributedQueueMBean.class, var3, var4);
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion) && !var1.containsKey("JMSTemplate")) {
         ...
         var2 = new PropertyDescriptor("JMSTemplate", JMSDistributedQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("JNDIName")) {
         ...
         var2 = new PropertyDescriptor("JNDIName", JMSDistributedQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("LoadBalancingPolicy")) {
         ...
         var2 = new PropertyDescriptor("LoadBalancingPolicy", JMSDistributedQueueMBean.class, var3, var4);
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion) && !var1.containsKey("Members")) {
         ...
         var2 = new PropertyDescriptor("Members", JMSDistributedQueueMBean.class, var3, var4);
         var1.put("Members", var2);
         var2.setValue("description", "<p>All the members for this distributed queue.</p> ");
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", JMSDistributedQueueMBean.class, var3, var4);
         var1.put("Name", var2);
      ...
      if (!var1.containsKey("Notes")) {
         ...
         var2 = new PropertyDescriptor("Notes", JMSDistributedQueueMBean.class, var3, var4);
         var1.put("Notes", var2);
      ...
      if (!var1.containsKey("ResetDeliveryCountOnForward")) {
         var3 = "getResetDeliveryCountOnForward";
         var4 = null;
         if (!this.readOnly) {
            var4 = "setResetDeliveryCountOnForward";
         }

         var2 = new PropertyDescriptor("ResetDeliveryCountOnForward", JMSDistributedQueueMBean.class, var3, var4);
         var1.put("ResetDeliveryCountOnForward", var2);
         var2.setValue("description", "<p>Determines whether or not the delivery count is reset during message forwarding between distributed queue members.</p>  <p>The default value of true resets the delivery counts on messages when they are forwarded to another distributed queue member.</p> ");
      ...
      if (!var1.containsKey("Targets")) {
         ...
         var2 = new PropertyDescriptor("Targets", JMSDistributedQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Template")) {
         ...
         var2 = new PropertyDescriptor("Template", JMSDistributedQueueMBean.class, var3, var4);
   ...
   private void fillinFactoryMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         var3 = JMSDistributedQueueMBean.class.getMethod("createJMSTemplate", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         var3 = JMSDistributedQueueMBean.class.getMethod("destroyJMSTemplate", JMSTemplateMBean.class);
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         var3 = JMSDistributedQueueMBean.class.getMethod("createJMSDistributedQueueMember", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         var3 = JMSDistributedQueueMBean.class.getMethod("createJMSDistributedQueueMember", String.class, JMSDistributedQueueMemberMBean.class);
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         var3 = JMSDistributedQueueMBean.class.getMethod("destroyJMSDistributedQueueMember", JMSDistributedQueueMemberMBean.class);
   ...
   private void fillinCollectionMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      ...
      String var5;
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         var3 = JMSDistributedQueueMBean.class.getMethod("addMember", JMSDistributedQueueMemberMBean.class);
         ...
         if (!var1.containsKey(var5)) {
            ...
            var2.setValue("obsolete", "9.0.0.0");
            var1.put(var5, var2);
            var2.setValue("description", "<p>Add a member to this distributed queue.</p> ");
      ...
      var3 = JMSDistributedQueueMBean.class.getMethod("addTarget", TargetMBean.class);
      ...
      String[] var6;
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         var3 = JMSDistributedQueueMBean.class.getMethod("removeMember", JMSDistributedQueueMemberMBean.class);
         var4 = new ParameterDescriptor[]{createParameterDescriptor("member", "the JMSDistributedQueueMember to remove from the distributed queue ")};
         var5 = BeanInfoHelper.buildMethodKey(var3);
         if (!var1.containsKey(var5)) {
            var2 = new MethodDescriptor(var3, var4);
            var6 = new String[]{BeanInfoHelper.encodeEntities("IllegalArgumentException if the specified member is not a member of this distributed queue")};
            var2.setValue("throws", var6);
            var2.setValue("obsolete", "9.0.0.0");
            var1.put(var5, var2);
            var2.setValue("description", "<p>Remove a member from this distributed queue.</p> ");
            var2.setValue("role", "collection");
            var2.setValue("property", "Members");
            var2.setValue("obsolete", "9.0.0.0");
         }
      ...
      var3 = JMSDistributedQueueMBean.class.getMethod("removeTarget", TargetMBean.class);
   ...
   private void fillinFinderMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = JMSDistributedQueueMBean.class.getMethod("lookupJMSDistributedQueueMember", String.class);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      ...
      String var5;
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         var3 = JMSDistributedQueueMBean.class.getMethod("destroyJMSDistributedQueueMember", String.class, JMSDistributedQueueMemberMBean.class);
         var4 = new ParameterDescriptor[]{createParameterDescriptor("name", "name "), createParameterDescriptor("member", "JMSDistributedQueueMember ")};
         var5 = BeanInfoHelper.buildMethodKey(var3);
         if (!var1.containsKey(var5)) {
            var2 = new MethodDescriptor(var3, var4);
            var2.setValue("obsolete", "9.0.0.0");
      ...
      var3 = JMSDistributedQueueMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      var3 = JMSDistributedQueueMBean.class.getMethod("restoreDefaultValue", String.class);
      var4 = new ParameterDescriptor[]{createParameterDescriptor("attributeName", (String)null)};
      var5 = BeanInfoHelper.buildMethodKey(var3);
