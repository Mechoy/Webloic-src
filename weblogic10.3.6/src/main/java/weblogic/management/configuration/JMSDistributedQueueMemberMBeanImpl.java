...
public class JMSDistributedQueueMemberMBeanImpl extends JMSDistributedDestinationMemberMBeanImpl implements JMSDistributedQueueMemberMBean, Serializable {
   ...
   private int _Weight;
   private JMSDistributedQueueMember _customizer;
   ...
   public JMSDistributedQueueMemberMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
   ...
   public String getJMSQueueAsString() {
      AbstractDescriptorBean var1 = (AbstractDescriptorBean)this.getJMSQueue();
   ...
   public void setJMSQueueAsString(String var1) {
      if (var1 != null && var1.length() != 0) {
         var1 = var1 == null ? null : var1.trim();
         this._getReferenceManager().registerUnresolvedReference(var1, JMSQueueMBean.class, new ReferenceManager.Resolver(this, 8) {
            public void resolveReference(Object var1) {
               try {
                  JMSDistributedQueueMemberMBeanImpl.this.setJMSQueue((JMSQueueMBean)var1);
         ...
         JMSQueueMBean var2 = this._JMSQueue;
         this._initializeProperty(8);
         this._postSet(8, var2, this._JMSQueue);
      }

   }

   public void setJMSQueue(JMSQueueMBean var1) throws InvalidAttributeValueException {
      if (var1 != null) {
      ...
      JMSQueueMBean var3 = this.getJMSQueue();
      this._customizer.setJMSQueue(var1);
   ...
   public void putValue(String var1, Object var2) {
      if (var1.equals("JMSQueue")) {
         JMSQueueMBean var6 = this._JMSQueue;
         this._JMSQueue = (JMSQueueMBean)var2;
         this._postSet(8, var6, this._JMSQueue);
      } else {
         String var5;
         if (var1.equals("Name")) {
            var5 = this._Name;
            ...
            JMSDistributedQueueMember var3 = this._customizer;
            this._customizer = (JMSDistributedQueueMember)var2;
         } else {
   ...
   protected static class Helper extends JMSDistributedDestinationMemberMBeanImpl.Helper {
      ...
      protected Helper(JMSDistributedQueueMemberMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected long computeHashValue(CRC32 var1) {
         try {
            ...
            if (this.bean.isJMSQueueSet()) {
               var2.append("JMSQueue");
               var2.append(String.valueOf(this.bean.getJMSQueue()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            JMSDistributedQueueMemberMBeanImpl var2 = (JMSDistributedQueueMemberMBeanImpl)var1;
            this.computeDiff("JMSQueue", this.bean.getJMSQueue(), var2.getJMSQueue(), true);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            JMSDistributedQueueMemberMBeanImpl var3 = (JMSDistributedQueueMemberMBeanImpl)var1.getSourceBean();
            JMSDistributedQueueMemberMBeanImpl var4 = (JMSDistributedQueueMemberMBeanImpl)var1.getProposedBean();
            String var5 = var2.getPropertyName();
            int var6 = var2.getUpdateType();
            if (!var2.isDerivedUpdate()) {
               if (var5.equals("JMSQueue")) {
                  var3.setJMSQueueAsString(var4.getJMSQueueAsString());
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            JMSDistributedQueueMemberMBeanImpl var5 = (JMSDistributedQueueMemberMBeanImpl)var1;
            super.finishCopy(var5, var2, var3);
            if ((var3 == null || !var3.contains("JMSQueue")) && this.bean.isJMSQueueSet()) {
               var5._unSet(var5, 8);
               var5.setJMSQueueAsString(this.bean.getJMSQueueAsString());
            }
      ...
      protected void inferSubTree(Class var1, Object var2) {
         ...
         Object var3 = null;
         this.inferSubTree(this.bean.getJMSQueue(), var1, var2);
      }
   }
}
