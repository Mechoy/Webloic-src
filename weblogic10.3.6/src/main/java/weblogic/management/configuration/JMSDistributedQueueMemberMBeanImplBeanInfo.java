...
public class JMSDistributedQueueMemberMBeanImplBeanInfo extends JMSDistributedDestinationMemberMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = JMSDistributedQueueMemberMBean.class;

   public JMSDistributedQueueMemberMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }

   public JMSDistributedQueueMemberMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = JMSDistributedQueueMemberMBeanImpl.class;
      ...
      var2.setValue("deprecated", "9.0.0.0 Replaced by {@link weblogic.j2ee.descriptor.wl.DistributedQueueMemberBean} ");
      String[] var3 = new String[]{BeanInfoHelper.encodeEntities("weblogic.j2ee.descriptor.wl.UniformDistributedQueueMemberBean")};
      var2.setValue("see", var3);
      var2.setValue("package", "weblogic.management.configuration");
      String var4 = (new String("This class represents a JMS distributed queue member, which represents a physical JMS queue as a member of a single distributed set of queues that can be served by multiple WebLogic Server instances within a cluster.  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX.\"</p> ")).intern();
      ...
      var2.setValue("interfaceclassname", "weblogic.management.configuration.JMSDistributedQueueMemberMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("JMSQueue")) {
         ...
         var2 = new PropertyDescriptor("JMSQueue", JMSDistributedQueueMemberMBean.class, var3, var4);
         var1.put("JMSQueue", var2);
         var2.setValue("description", "<p>The physical JMS queue that is associated with this member of the distributed queue set.</p> ");
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", JMSDistributedQueueMemberMBean.class, var3, var4);
         var1.put("Name", var2);
      ...
      if (!var1.containsKey("Notes")) {
         ...
         var2 = new PropertyDescriptor("Notes", JMSDistributedQueueMemberMBean.class, var3, var4);
         var1.put("Notes", var2);
      ...
      if (!var1.containsKey("Weight")) {
         ...
         var2 = new PropertyDescriptor("Weight", JMSDistributedQueueMemberMBean.class, var3, var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = JMSDistributedQueueMemberMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      var3 = JMSDistributedQueueMemberMBean.class.getMethod("restoreDefaultValue", String.class);
