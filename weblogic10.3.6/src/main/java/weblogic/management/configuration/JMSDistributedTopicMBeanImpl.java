...
public class JMSDistributedTopicMBeanImpl extends JMSDistributedDestinationMBeanImpl implements JMSDistributedTopicMBean, Serializable {
   ...
   private JMSDistributedTopic _customizer;
   ...
   public JMSDistributedTopicMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
      ...
      if (var1 != null && var1.length() != 0) {
         ...
         for(int var4 = 0; var4 < var13.length; ++var4) {
            ...
            if (var3.contains(var5)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(var5, JMSDistributedTopicMemberMBean.class, new ReferenceManager.Resolver(this, 13) {
                  public void resolveReference(Object var1) {
                     try {
                        JMSDistributedTopicMBeanImpl.this.addMember((JMSDistributedTopicMemberMBean)var1);
         ...
         while(true) {
            while(var14.hasNext()) {
               ...
               for(int var8 = 0; var8 < var7; ++var8) {
                  JMSDistributedTopicMemberMBean var9 = var6[var8];
         ...
         JMSDistributedTopicMemberMBean[] var2 = this._Members;
         ...
         for(int var4 = 0; var4 < var13.length; ++var4) {
            ...
            if (var3.contains(var5)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(var5, TargetMBean.class, new ReferenceManager.Resolver(this, 7) {
                  public void resolveReference(Object var1) {
                     try {
                        JMSDistributedTopicMBeanImpl.this.addTarget((TargetMBean)var1);
                     } catch (RuntimeException var3) {
                        throw var3;
                     } catch (Exception var4) {
                        throw new AssertionError("Impossible exception: " + var4);
   ...
   public void setMembers(JMSDistributedTopicMemberMBean[] var1) throws InvalidAttributeValueException {
      Object var3 = var1 == null ? new JMSDistributedTopicMemberMBeanImpl[0] : var1;
      JMSDistributedTopicMemberMBean[] var2 = this.getMembers();
      this._customizer.setMembers((JMSDistributedTopicMemberMBean[])var3);
   ...
   public boolean addMember(JMSDistributedTopicMemberMBean var1) throws InvalidAttributeValueException, DistributedManagementException {
   ...
   public boolean removeMember(JMSDistributedTopicMemberMBean var1) throws InvalidAttributeValueException, DistributedManagementException {
   ...
   public void setTemplateAsString(String var1) {
      if (var1 != null && var1.length() != 0) {
         ...
         this._getReferenceManager().registerUnresolvedReference(var1, JMSTemplateMBean.class, new ReferenceManager.Resolver(this, 11) {
            public void resolveReference(Object var1) {
               try {
                  JMSDistributedTopicMBeanImpl.this.setTemplate((JMSTemplateMBean)var1);
               } catch (RuntimeException var3) {
                  throw var3;
               } catch (Exception var4) {
                  throw new AssertionError("Impossible exception: " + var4);
   ...
   public void destroyJMSDistributedTopicMember(String var1, JMSDistributedTopicMemberMBean var2) {
      this._customizer.destroyJMSDistributedTopicMember(var1, var2);
   }
   ...
   public void putValue(String var1, Object var2) {
      JMSDistributedTopicMemberMBean[] var7;
      if (var1.equals("JMSDistributedTopicMembers")) {
         var7 = this._JMSDistributedTopicMembers;
         this._JMSDistributedTopicMembers = (JMSDistributedTopicMemberMBean[])((JMSDistributedTopicMemberMBean[])var2);
         this._postSet(14, var7, this._JMSDistributedTopicMembers);
      } else {
         ...
         if (var1.equals("JMSTemplate")) {
            ...
            if (var1.equals("JNDIName")) {
               ...
               this._postSet(9, var6, this._JNDIName);
            } else if (var1.equals("LoadBalancingPolicy")) {
               var6 = this._LoadBalancingPolicy;
               this._LoadBalancingPolicy = (String)var2;
               this._postSet(12, var6, this._LoadBalancingPolicy);
            } else if (var1.equals("Members")) {
               var7 = this._Members;
               this._Members = (JMSDistributedTopicMemberMBean[])((JMSDistributedTopicMemberMBean[])var2);
               this._postSet(13, var7, this._Members);
               ...
               JMSDistributedTopic var3 = this._customizer;
               this._customizer = (JMSDistributedTopic)var2;
            } else {
   ...
   protected static class Helper extends JMSDistributedDestinationMBeanImpl.Helper {
      ...
      protected Helper(JMSDistributedTopicMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected long computeHashValue(CRC32 var1) {
         try {
            ...
            for(int var7 = 0; var7 < this.bean.getJMSDistributedTopicMembers().length; ++var7) {
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            JMSDistributedTopicMBeanImpl var2 = (JMSDistributedTopicMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            JMSDistributedTopicMBeanImpl var3 = (JMSDistributedTopicMBeanImpl)var1.getSourceBean();
            JMSDistributedTopicMBeanImpl var4 = (JMSDistributedTopicMBeanImpl)var1.getProposedBean();
            String var5 = var2.getPropertyName();
            int var6 = var2.getUpdateType();
            if (!var2.isDerivedUpdate()) {
               if (var5.equals("JMSDistributedTopicMembers")) {
                  if (var6 == 2) {
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            JMSDistributedTopicMBeanImpl var5 = (JMSDistributedTopicMBeanImpl)var1;
            super.finishCopy(var5, var2, var3);
            if (var2 && (var3 == null || !var3.contains("JMSDistributedTopicMembers")) && this.bean.isJMSDistributedTopicMembersSet() && !var5._isSet(14)) {
               JMSDistributedTopicMemberMBean[] var6 = this.bean.getJMSDistributedTopicMembers();
               JMSDistributedTopicMemberMBean[] var7 = new JMSDistributedTopicMemberMBean[var6.length];

               for(int var8 = 0; var8 < var7.length; ++var8) {
                  var7[var8] = (JMSDistributedTopicMemberMBean)((JMSDistributedTopicMemberMBean)this.createCopy((AbstractDescriptorBean)var6[var8], var2));
               }

               var5.setJMSDistributedTopicMembers(var7);
            }
