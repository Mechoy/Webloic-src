...
public class JMSDistributedTopicMemberMBeanBinder extends JMSDistributedDestinationMemberMBeanBinder implements AttributeBinder {
   private JMSDistributedTopicMemberMBeanImpl bean;

   protected JMSDistributedTopicMemberMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (JMSDistributedTopicMemberMBeanImpl)var1;
   }

   public JMSDistributedTopicMemberMBeanBinder() {
      super(new JMSDistributedTopicMemberMBeanImpl());
      this.bean = (JMSDistributedTopicMemberMBeanImpl)this.getBean();
   }
         ...
         if (!(this instanceof SecurityReadOnlyMBeanBinder) && var2 != null && var2.toString().trim().length() == 0) {
            ...
            if (var1 != null) {
               if (var1.equals("JMSTopic")) {
                  this.bean.setJMSTopicAsString((String)var2);
