...
public class JMSInteropModuleMBeanImpl extends JMSSystemResourceMBeanImpl implements JMSInteropModuleMBean, Serializable {
   private TargetMBean[] _Targets;
   private static SchemaHelper2 _schemaHelper;

   public JMSInteropModuleMBeanImpl() {
      this._initializeProperty(-1);
   }

   public JMSInteropModuleMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
      this._initializeProperty(-1);
   }
            ...
            if (var3.contains(var5)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(var5, TargetMBean.class, new ReferenceManager.Resolver(this, 7) {
                  public void resolveReference(Object var1) {
                     try {
                        JMSInteropModuleMBeanImpl.this.addTarget((TargetMBean)var1);
   ...
   public static class SchemaHelper2 extends JMSSystemResourceMBeanImpl.SchemaHelper2 implements SchemaHelper {
   ...
   protected static class Helper extends JMSSystemResourceMBeanImpl.Helper {
      private JMSInteropModuleMBeanImpl bean;

      protected Helper(JMSInteropModuleMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            JMSInteropModuleMBeanImpl var2 = (JMSInteropModuleMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            JMSInteropModuleMBeanImpl var3 = (JMSInteropModuleMBeanImpl)var1.getSourceBean();
            JMSInteropModuleMBeanImpl var4 = (JMSInteropModuleMBeanImpl)var1.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            JMSInteropModuleMBeanImpl var5 = (JMSInteropModuleMBeanImpl)var1;
