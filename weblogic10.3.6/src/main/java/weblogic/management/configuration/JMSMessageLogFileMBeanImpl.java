...
public class JMSMessageLogFileMBeanImpl extends LogFileMBeanImpl implements JMSMessageLogFileMBean, Serializable {
   ...
   private JMSMessageLogFile _customizer;
   ...
   public JMSMessageLogFileMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
   ...
   public String getFileName() {
      if (!this._isSet(8)) {
         try {
            return "logs/jmsServers/" + this.getName() + "/" + "jms.messages.log";
         } catch (NullPointerException var2) {
         }
      }
   ...
   public void putValue(String var1, Object var2) {
      ...
      if (var1.equals("FileName")) {
         ...
         JMSMessageLogFile var3 = this._customizer;
         this._customizer = (JMSMessageLogFile)var2;
      } else {
   ...
   protected static class Helper extends LogFileMBeanImpl.Helper {
      ...
      protected Helper(JMSMessageLogFileMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            JMSMessageLogFileMBeanImpl var2 = (JMSMessageLogFileMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            JMSMessageLogFileMBeanImpl var3 = (JMSMessageLogFileMBeanImpl)var1.getSourceBean();
            JMSMessageLogFileMBeanImpl var4 = (JMSMessageLogFileMBeanImpl)var1.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            JMSMessageLogFileMBeanImpl var5 = (JMSMessageLogFileMBeanImpl)var1;
