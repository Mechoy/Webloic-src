...
public class JMSMessageLogFileMBeanImplBeanInfo extends LogFileMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = JMSMessageLogFileMBean.class;

   public JMSMessageLogFileMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }

   public JMSMessageLogFileMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = JMSMessageLogFileMBeanImpl.class;
      ...
      String var3 = (new String("This defines the configuration aspects of the logs for a jms server.  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX.\"</p> ")).intern();
      var2.setShortDescription(var3);
      var2.setValue("description", var3);
      var2.setValue("interfaceclassname", "weblogic.management.configuration.JMSMessageLogFileMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", JMSMessageLogFileMBean.class, var3, var4);
         var1.put("Name", var2);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = JMSMessageLogFileMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      var3 = JMSMessageLogFileMBean.class.getMethod("restoreDefaultValue", String.class);
      ...
      var3 = JMSMessageLogFileMBean.class.getMethod("computeLogFilePath");
