...
public class JMSQueueMBeanBinder extends JMSDestinationMBeanBinder implements AttributeBinder {
   private JMSQueueMBeanImpl bean;

   protected JMSQueueMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (JMSQueueMBeanImpl)var1;
   }

   public JMSQueueMBeanBinder() {
      super(new JMSQueueMBeanImpl());
      this.bean = (JMSQueueMBeanImpl)this.getBean();
   }
