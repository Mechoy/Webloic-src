...
public class JMSQueueMBeanImpl extends JMSDestinationMBeanImpl implements JMSQueueMBean, Serializable {
   ...
   public JMSQueueMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
            ...
            if (var3.contains(var5)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(var5, JMSDestinationKeyMBean.class, new ReferenceManager.Resolver(this, 7) {
                  public void resolveReference(Object var1) {
                     try {
                        JMSQueueMBeanImpl.this.addDestinationKey((JMSDestinationKeyMBean)var1);
   ...
   public void setTemplateAsString(String var1) {
      if (var1 != null && var1.length() != 0) {
         ...
         this._getReferenceManager().registerUnresolvedReference(var1, JMSTemplateMBean.class, new ReferenceManager.Resolver(this, 25) {
            public void resolveReference(Object var1) {
               try {
                  JMSQueueMBeanImpl.this.setTemplate((JMSTemplateMBean)var1);
               } catch (RuntimeException var3) {
                  throw var3;
               } catch (Exception var4) {
                  throw new AssertionError("Impossible exception: " + var4);
   ...
   public void setErrorDestinationAsString(String var1) {
      if (var1 != null && var1.length() != 0) {
         ...
         this._getReferenceManager().registerUnresolvedReference(var1, JMSDestinationMBean.class, new ReferenceManager.Resolver(this, 17) {
            public void resolveReference(Object var1) {
               try {
                  JMSQueueMBeanImpl.this.setErrorDestination((JMSDestinationMBean)var1);
               } catch (RuntimeException var3) {
                  throw var3;
               } catch (Exception var4) {
                  throw new AssertionError("Impossible exception: " + var4);
      ...
      if (var1.equals("BytesMaximum")) {
         ...
         if (var1.equals("DeliveryModeOverride")) {
            ...
            if (var1.equals("MaximumMessageSize")) {
               ...
               JMSQueue var3 = this._customizer;
               this._customizer = (JMSQueue)var2;
            } else {
   ...
   protected static class Helper extends JMSDestinationMBeanImpl.Helper {
      ...
      protected Helper(JMSQueueMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            JMSQueueMBeanImpl var2 = (JMSQueueMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            JMSQueueMBeanImpl var3 = (JMSQueueMBeanImpl)var1.getSourceBean();
            JMSQueueMBeanImpl var4 = (JMSQueueMBeanImpl)var1.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            JMSQueueMBeanImpl var5 = (JMSQueueMBeanImpl)var1;
