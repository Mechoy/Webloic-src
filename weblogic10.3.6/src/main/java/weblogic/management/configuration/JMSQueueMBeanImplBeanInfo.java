...
public class JMSQueueMBeanImplBeanInfo extends JMSDestinationMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = JMSQueueMBean.class;

   public JMSQueueMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      var2.setValue("deprecated", "9.0.0.0 Replaced by {@link weblogic.j2ee.descriptor.wl.QueueBean} ");
      var2.setValue("package", "weblogic.management.configuration");
      String var3 = (new String("This class represents a JMS queue (Point-To-Point) destination for a JMS server.  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX.\"</p> ")).intern();
      var2.setShortDescription(var3);
      var2.setValue("description", var3);
      String[] var4 = new String[]{BeanInfoHelper.encodeEntities("Deployer")};
      var2.setValue("rolesAllowed", var4);
      var2.setValue("interfaceclassname", "weblogic.management.configuration.JMSQueueMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("BytesMaximum")) {
         ...
         var2 = new PropertyDescriptor("BytesMaximum", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("BytesThresholdHigh")) {
         ...
         var2 = new PropertyDescriptor("BytesThresholdHigh", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("BytesThresholdLow")) {
         ...
         var2 = new PropertyDescriptor("BytesThresholdLow", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("DeliveryModeOverride")) {
         ...
         var2 = new PropertyDescriptor("DeliveryModeOverride", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("DestinationKeys")) {
         ...
         var2 = new PropertyDescriptor("DestinationKeys", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("ErrorDestination")) {
         ...
         var2 = new PropertyDescriptor("ErrorDestination", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("ExpirationLoggingPolicy")) {
         ...
         var2 = new PropertyDescriptor("ExpirationLoggingPolicy", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("ExpirationPolicy")) {
         ...
         var2 = new PropertyDescriptor("ExpirationPolicy", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("JNDIName")) {
         ...
         var2 = new PropertyDescriptor("JNDIName", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MaximumMessageSize")) {
         ...
         var2 = new PropertyDescriptor("MaximumMessageSize", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MessagesMaximum")) {
         ...
         var2 = new PropertyDescriptor("MessagesMaximum", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MessagesThresholdHigh")) {
         ...
         var2 = new PropertyDescriptor("MessagesThresholdHigh", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MessagesThresholdLow")) {
         ...
         var2 = new PropertyDescriptor("MessagesThresholdLow", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", JMSQueueMBean.class, var3, var4);
         var1.put("Name", var2);
      ...
      if (!var1.containsKey("Notes")) {
         ...
         var2 = new PropertyDescriptor("Notes", JMSQueueMBean.class, var3, var4);
         var1.put("Notes", var2);
      ...
      if (!var1.containsKey("PriorityOverride")) {
         ...
         var2 = new PropertyDescriptor("PriorityOverride", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("RedeliveryDelayOverride")) {
         ...
         var2 = new PropertyDescriptor("RedeliveryDelayOverride", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("RedeliveryLimit")) {
         ...
         var2 = new PropertyDescriptor("RedeliveryLimit", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("StoreEnabled")) {
         ...
         var2 = new PropertyDescriptor("StoreEnabled", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Template")) {
         ...
         var2 = new PropertyDescriptor("Template", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("TimeToDeliverOverride")) {
         ...
         var2 = new PropertyDescriptor("TimeToDeliverOverride", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("TimeToLiveOverride")) {
         ...
         var2 = new PropertyDescriptor("TimeToLiveOverride", JMSQueueMBean.class, var3, var4);
      ...
      if (!var1.containsKey("JNDINameReplicated")) {
         ...
         var2 = new PropertyDescriptor("JNDINameReplicated", JMSQueueMBean.class, var3, var4);
   ...
   private void fillinCollectionMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = JMSQueueMBean.class.getMethod("addDestinationKey", JMSDestinationKeyMBean.class);
      ...
      var3 = JMSQueueMBean.class.getMethod("removeDestinationKey", JMSDestinationKeyMBean.class);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = JMSQueueMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      var3 = JMSQueueMBean.class.getMethod("restoreDefaultValue", String.class);
