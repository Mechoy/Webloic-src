...
public class JMSSAFMessageLogFileMBeanBinder extends LogFileMBeanBinder implements AttributeBinder {
   private JMSSAFMessageLogFileMBeanImpl bean;

   protected JMSSAFMessageLogFileMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (JMSSAFMessageLogFileMBeanImpl)var1;
   }

   public JMSSAFMessageLogFileMBeanBinder() {
      super(new JMSSAFMessageLogFileMBeanImpl());
      this.bean = (JMSSAFMessageLogFileMBeanImpl)this.getBean();
   }
