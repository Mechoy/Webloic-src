...
import weblogic.management.mbeans.custom.JMSSAFMessageLogFile;
import weblogic.utils.collections.CombinedIterator;

public class JMSSAFMessageLogFileMBeanImpl extends LogFileMBeanImpl implements JMSSAFMessageLogFileMBean, Serializable {
   private String _FileName;
   private String _Name;
   private JMSSAFMessageLogFile _customizer;
   private static SchemaHelper2 _schemaHelper;

   public JMSSAFMessageLogFileMBeanImpl() {
      try {
         this._customizer = new JMSSAFMessageLogFile(this);
   ...
   public JMSSAFMessageLogFileMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
   ...
   public String getFileName() {
      if (!this._isSet(8)) {
         try {
            return "logs/safagents/" + this.getName() + "/" + "jms" + "/" + "jms.messages.log";
         } catch (NullPointerException var2) {
         }
      }
   ...
   public void putValue(String var1, Object var2) {
      ...
      if (var1.equals("FileName")) {
         ...
         JMSSAFMessageLogFile var3 = this._customizer;
         this._customizer = (JMSSAFMessageLogFile)var2;
      } else {
   ...
   protected static class Helper extends LogFileMBeanImpl.Helper {
      private JMSSAFMessageLogFileMBeanImpl bean;

      protected Helper(JMSSAFMessageLogFileMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            JMSSAFMessageLogFileMBeanImpl var2 = (JMSSAFMessageLogFileMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            JMSSAFMessageLogFileMBeanImpl var3 = (JMSSAFMessageLogFileMBeanImpl)var1.getSourceBean();
            JMSSAFMessageLogFileMBeanImpl var4 = (JMSSAFMessageLogFileMBeanImpl)var1.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            JMSSAFMessageLogFileMBeanImpl var5 = (JMSSAFMessageLogFileMBeanImpl)var1;
