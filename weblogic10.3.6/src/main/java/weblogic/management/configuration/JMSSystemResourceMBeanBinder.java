...
public class JMSSystemResourceMBeanBinder extends SystemResourceMBeanBinder implements AttributeBinder {
   private JMSSystemResourceMBeanImpl bean;

   protected JMSSystemResourceMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (JMSSystemResourceMBeanImpl)var1;
   }

   public JMSSystemResourceMBeanBinder() {
      super(new JMSSystemResourceMBeanImpl());
      this.bean = (JMSSystemResourceMBeanImpl)this.getBean();
   }
