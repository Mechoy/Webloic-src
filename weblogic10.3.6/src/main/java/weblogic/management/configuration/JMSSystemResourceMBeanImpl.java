...
public class JMSSystemResourceMBeanImpl extends SystemResourceMBeanImpl implements JMSSystemResourceMBean, Serializable {
   private String _DescriptorFileName;
   private JMSBean _JMSResource;
   private String _Name;
   private DescriptorBean _Resource;
   private JMSSystemResource _customizer;
   private static SchemaHelper2 _schemaHelper;

   public JMSSystemResourceMBeanImpl() {
      try {
         this._customizer = new JMSSystemResource(this);
   ...
   public JMSSystemResourceMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
   ...
   public String getDescriptorFileName() {
      if (!this._isSet(14)) {
         try {
            return JMSBeanHelper.constructDefaultJMSSystemFilename(this.getName());
   ...
   public JMSBean getJMSResource() {
      return this._customizer.getJMSResource();
   }
   ...
   public boolean isJMSResourceSet() {
   ...
   public void setJMSResource(JMSBean var1) throws InvalidAttributeValueException {
      this._JMSResource = var1;
   }
   ...
   public void _validate() throws IllegalArgumentException {
      super._validate();
      JMSModuleValidator.validateJMSSystemResource((JMSSystemResourceMBean)this);
   }
   ...
   public void putValue(String var1, Object var2) {
      ...
      if (var1.equals("DescriptorFileName")) {
      ...
      } else if (var1.equals("JMSResource")) {
         JMSBean var6 = this._JMSResource;
         this._JMSResource = (JMSBean)var2;
         this._postSet(16, var6, this._JMSResource);
         ...
         JMSSystemResource var3 = this._customizer;
         this._customizer = (JMSSystemResource)var2;
      } else {
   ...
   protected static class Helper extends SystemResourceMBeanImpl.Helper {
      private JMSSystemResourceMBeanImpl bean;

      protected Helper(JMSSystemResourceMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected long computeHashValue(CRC32 var1) {
         try {
            ...
            if (this.bean.isJMSResourceSet()) {
               var2.append("JMSResource");
               var2.append(String.valueOf(this.bean.getJMSResource()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            JMSSystemResourceMBeanImpl var2 = (JMSSystemResourceMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            JMSSystemResourceMBeanImpl var3 = (JMSSystemResourceMBeanImpl)var1.getSourceBean();
            JMSSystemResourceMBeanImpl var4 = (JMSSystemResourceMBeanImpl)var1.getProposedBean();
            ...
            if (!var2.isDerivedUpdate()) {
               ...
               } else if (!var5.equals("JMSResource")) {
                  if (var5.equals("Name")) {
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            JMSSystemResourceMBeanImpl var5 = (JMSSystemResourceMBeanImpl)var1;
