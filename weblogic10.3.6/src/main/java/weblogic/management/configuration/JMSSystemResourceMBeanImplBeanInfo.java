...
public class JMSSystemResourceMBeanImplBeanInfo extends SystemResourceMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = JMSSystemResourceMBean.class;

   public JMSSystemResourceMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }

   public JMSSystemResourceMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = JMSSystemResourceMBeanImpl.class;
      ...
      var2.setValue("interfaceclassname", "weblogic.management.configuration.JMSSystemResourceMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("DescriptorFileName")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("DescriptorFileName", JMSSystemResourceMBean.class, var3, var4);
         var1.put("DescriptorFileName", var2);
         var2.setValue("description", "<p>The name of the file that contains the module configuration. By default the file resides in the DOMAIN_DIR/config/jms directory.</p> <p>The module file derives its name from the bean name using the following pattern:</p> <p> <beanName>.xml </p> <p>Note that this is a read-only property that can only be set when the bean is created.</p> ");
      }

      if (!var1.containsKey("JMSResource")) {
         var3 = "getJMSResource";
         var4 = null;
         var2 = new PropertyDescriptor("JMSResource", JMSSystemResourceMBean.class, var3, var4);
         var1.put("JMSResource", var2);
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", JMSSystemResourceMBean.class, var3, var4);
         var1.put("Name", var2);
      ...
      if (!var1.containsKey("Resource")) {
         var3 = "getResource";
         var4 = null;
         var2 = new PropertyDescriptor("Resource", JMSSystemResourceMBean.class, var3, var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = JMSSystemResourceMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      var3 = JMSSystemResourceMBean.class.getMethod("restoreDefaultValue", String.class);
