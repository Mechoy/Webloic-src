...
public class JMSTemplateMBeanImplBeanInfo extends JMSDestCommonMBeanImplBeanInfo {
   ...
   public JMSTemplateMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = JMSTemplateMBeanImpl.class;
      ...
      var2.setValue("deprecated", "9.0.0.0 Replaced by {@link weblogic.j2ee.descriptor.wl.TemplateBean} ");
      var2.setValue("package", "weblogic.management.configuration");
      String var3 = (new String("This class represents a JMS template, which provides an efficient means of defining multiple destinations (queues and topics) with similar attribute settings.  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX.\"</p> ")).intern();
      var2.setShortDescription(var3);
      var2.setValue("description", var3);
      String[] var4 = new String[]{BeanInfoHelper.encodeEntities("Deployer")};
      var2.setValue("rolesAllowed", var4);
      var2.setValue("interfaceclassname", "weblogic.management.configuration.JMSTemplateMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("BytesMaximum")) {
         ...
         var2 = new PropertyDescriptor("BytesMaximum", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("BytesThresholdHigh")) {
         ...
         var2 = new PropertyDescriptor("BytesThresholdHigh", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("BytesThresholdLow")) {
         ...
         var2 = new PropertyDescriptor("BytesThresholdLow", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("DeliveryModeOverride")) {
         ...
         var2 = new PropertyDescriptor("DeliveryModeOverride", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Destinations")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("Destinations", JMSTemplateMBean.class, var3, var4);
         var1.put("Destinations", var2);
         var2.setValue("description", "<p>Returns a read-only array of the destinations for the JMS template.</p> ");
      ...
      if (!var1.containsKey("ErrorDestination")) {
         ...
         var2 = new PropertyDescriptor("ErrorDestination", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("ExpirationLoggingPolicy")) {
         ...
         var2 = new PropertyDescriptor("ExpirationLoggingPolicy", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("ExpirationPolicy")) {
         ...
         var2 = new PropertyDescriptor("ExpirationPolicy", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MaximumMessageSize")) {
         ...
         var2 = new PropertyDescriptor("MaximumMessageSize", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MessagesMaximum")) {
         ...
         var2 = new PropertyDescriptor("MessagesMaximum", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MessagesThresholdHigh")) {
         ...
         var2 = new PropertyDescriptor("MessagesThresholdHigh", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MessagesThresholdLow")) {
         ...
         var2 = new PropertyDescriptor("MessagesThresholdLow", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", JMSTemplateMBean.class, var3, var4);
         var1.put("Name", var2);
      ...
      if (!var1.containsKey("Notes")) {
         ...
         var2 = new PropertyDescriptor("Notes", JMSTemplateMBean.class, var3, var4);
         var1.put("Notes", var2);
      ...
      if (!var1.containsKey("PriorityOverride")) {
         ...
         var2 = new PropertyDescriptor("PriorityOverride", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("RedeliveryDelayOverride")) {
         ...
         var2 = new PropertyDescriptor("RedeliveryDelayOverride", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("RedeliveryLimit")) {
         ...
         var2 = new PropertyDescriptor("RedeliveryLimit", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("TimeToDeliverOverride")) {
         ...
         var2 = new PropertyDescriptor("TimeToDeliverOverride", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("TimeToLiveOverride")) {
         ...
         var2 = new PropertyDescriptor("TimeToLiveOverride", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("BytesPagingEnabled")) {
         ...
         var2 = new PropertyDescriptor("BytesPagingEnabled", JMSTemplateMBean.class, var3, var4);
      ...
      if (!var1.containsKey("MessagesPagingEnabled")) {
         ...
         var2 = new PropertyDescriptor("MessagesPagingEnabled", JMSTemplateMBean.class, var3, var4);
   ...
   private void fillinCollectionMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = JMSTemplateMBean.class.getMethod("addDestination", JMSDestinationMBean.class);
      ParameterDescriptor[] var4 = new ParameterDescriptor[]{createParameterDescriptor("destination", "a reference to  JMSDestinationMBean ")};
      String var5 = BeanInfoHelper.buildMethodKey(var3);
      MethodDescriptor var2;
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var4);
         var1.put(var5, var2);
         var2.setValue("description", "<p>Adds a destination to the JMS template.</p> ");
         var2.setValue("role", "collection");
         var2.setValue("property", "Destinations");
      }

      var3 = JMSTemplateMBean.class.getMethod("removeDestination", JMSDestinationMBean.class);
      var4 = new ParameterDescriptor[]{createParameterDescriptor("destination", "a reference to  JMSDestinationMBean ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var4);
         var1.put(var5, var2);
         var2.setValue("description", "<p>Removes a destination from the JMS template.</p> ");
         var2.setValue("role", "collection");
         var2.setValue("property", "Destinations");
      }
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = JMSTemplateMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      var3 = JMSTemplateMBean.class.getMethod("restoreDefaultValue", String.class);
