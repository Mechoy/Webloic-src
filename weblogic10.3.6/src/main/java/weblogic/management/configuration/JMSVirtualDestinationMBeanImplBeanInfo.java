...
public class JMSVirtualDestinationMBeanImplBeanInfo extends DeploymentMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = JMSVirtualDestinationMBean.class;

   public JMSVirtualDestinationMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }

   public JMSVirtualDestinationMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = JMSVirtualDestinationMBeanImpl.class;
      ...
      var2.setValue("deprecated", "9.0.0.0 Replaced by {@link weblogic.j2ee.descriptor.wl.DistributedDestinationBean} ");
      ...
      var2.setValue("interfaceclassname", "weblogic.management.configuration.JMSVirtualDestinationMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("JNDIName")) {
         ...
         var2 = new PropertyDescriptor("JNDIName", JMSVirtualDestinationMBean.class, var3, var4);
