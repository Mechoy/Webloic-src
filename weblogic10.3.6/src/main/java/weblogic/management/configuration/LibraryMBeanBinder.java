...
public class LibraryMBeanBinder extends AppDeploymentMBeanBinder implements AttributeBinder {
   private LibraryMBeanImpl bean;

   protected LibraryMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (LibraryMBeanImpl)var1;
   }

   public LibraryMBeanBinder() {
      super(new LibraryMBeanImpl());
      this.bean = (LibraryMBeanImpl)this.getBean();
   }
