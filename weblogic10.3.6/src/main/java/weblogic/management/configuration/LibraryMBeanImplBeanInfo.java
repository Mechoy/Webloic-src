...
public class LibraryMBeanImplBeanInfo extends AppDeploymentMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = LibraryMBean.class;

   public LibraryMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      var2.setValue("interfaceclassname", "weblogic.management.configuration.LibraryMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("AbsoluteInstallDir")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("AbsoluteInstallDir", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("AbsolutePlanDir")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("AbsolutePlanDir", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("AbsolutePlanPath")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("AbsolutePlanPath", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("AbsoluteSourcePath")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("AbsoluteSourcePath", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("AppMBean")) {
         var3 = "getAppMBean";
         var4 = null;
         var2 = new PropertyDescriptor("AppMBean", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("ApplicationIdentifier")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("ApplicationIdentifier", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("ApplicationName")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("ApplicationName", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("DeploymentPlan")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("DeploymentPlan", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("DeploymentPlanExternalDescriptors")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("DeploymentPlanExternalDescriptors", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("LocalInstallDir")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("LocalInstallDir", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("LocalPlanDir")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("LocalPlanDir", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("LocalPlanPath")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("LocalPlanPath", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("LocalSourcePath")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("LocalSourcePath", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", LibraryMBean.class, var3, var4);
         var1.put("Name", var2);
      ...
      if (!var1.containsKey("PlanDir")) {
         var3 = "getPlanDir";
         var4 = null;
         var2 = new PropertyDescriptor("PlanDir", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("PlanPath")) {
         var3 = "getPlanPath";
         var4 = null;
         var2 = new PropertyDescriptor("PlanPath", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("RootStagingDir")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("RootStagingDir", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("SourcePath")) {
         var3 = "getSourcePath";
         var4 = null;
         var2 = new PropertyDescriptor("SourcePath", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("StagingMode")) {
         var3 = "getStagingMode";
         var4 = null;
         var2 = new PropertyDescriptor("StagingMode", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("VersionIdentifier")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("VersionIdentifier", LibraryMBean.class, var3, var4);
      ...
      if (!var1.containsKey("AutoDeployedApp")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("AutoDeployedApp", LibraryMBean.class, var3, var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = LibraryMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      var3 = LibraryMBean.class.getMethod("restoreDefaultValue", String.class);
      ...
      var3 = LibraryMBean.class.getMethod("getStagingMode", String.class);
