...
public class MailSessionMBeanBinder extends RMCFactoryMBeanBinder implements AttributeBinder {
   private MailSessionMBeanImpl bean;

   protected MailSessionMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (MailSessionMBeanImpl)var1;
   }

   public MailSessionMBeanBinder() {
      super(new MailSessionMBeanImpl());
      this.bean = (MailSessionMBeanImpl)this.getBean();
   }
