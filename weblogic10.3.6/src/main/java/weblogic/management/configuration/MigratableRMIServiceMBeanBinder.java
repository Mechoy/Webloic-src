...
public class MigratableRMIServiceMBeanBinder extends DeploymentMBeanBinder implements AttributeBinder {
   private MigratableRMIServiceMBeanImpl bean;

   protected MigratableRMIServiceMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (MigratableRMIServiceMBeanImpl)var1;
   }

   public MigratableRMIServiceMBeanBinder() {
      super(new MigratableRMIServiceMBeanImpl());
      this.bean = (MigratableRMIServiceMBeanImpl)this.getBean();
   }
         ...
         if (!(this instanceof SecurityReadOnlyMBeanBinder) && var2 != null && var2.toString().trim().length() == 0) {
            ...
            if (var1 != null) {
               if (var1.equals("Argument")) {
                  try {
                     this.bean.setArgument((String)var2);
