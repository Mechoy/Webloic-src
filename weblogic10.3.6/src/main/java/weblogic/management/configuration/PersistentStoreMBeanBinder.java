...
public class PersistentStoreMBeanBinder extends DeploymentMBeanBinder implements AttributeBinder {
   private PersistentStoreMBeanImpl bean;

   protected PersistentStoreMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (PersistentStoreMBeanImpl)var1;
   }

   public PersistentStoreMBeanBinder() {
      super(new PersistentStoreMBeanImpl());
      this.bean = (PersistentStoreMBeanImpl)this.getBean();
   }
