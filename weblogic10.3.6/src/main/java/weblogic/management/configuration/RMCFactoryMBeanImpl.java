...
public class RMCFactoryMBeanImpl extends DeploymentMBeanImpl implements RMCFactoryMBean, Serializable {
   ...
   public RMCFactoryMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
      this._initializeProperty(-1);
   }
   ...
   public void setJNDIName(String var1) throws InvalidAttributeValueException {
      ...
      weblogic.descriptor.beangen.LegalChecks.checkNonEmptyString("JNDIName", var1);
   ...
   public void _validate() throws IllegalArgumentException {
      super._validate();
      weblogic.descriptor.beangen.LegalChecks.checkIsSet("JNDIName", this.isJNDINameSet());
   }
   ...
   protected static class Helper extends DeploymentMBeanImpl.Helper {
      ...
      protected Helper(RMCFactoryMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            RMCFactoryMBeanImpl var2 = (RMCFactoryMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            RMCFactoryMBeanImpl var3 = (RMCFactoryMBeanImpl)var1.getSourceBean();
            RMCFactoryMBeanImpl var4 = (RMCFactoryMBeanImpl)var1.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            RMCFactoryMBeanImpl var5 = (RMCFactoryMBeanImpl)var1;
