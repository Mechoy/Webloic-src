...
public class RMCFactoryMBeanImplBeanInfo extends DeploymentMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = RMCFactoryMBean.class;

   public RMCFactoryMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = RMCFactoryMBeanImpl.class;
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("JNDIName")) {
         ...
         var2 = new PropertyDescriptor("JNDIName", RMCFactoryMBean.class, var3, var4);
         var1.put("JNDIName", var2);
         var2.setValue("description", "<p>The JNDI Name associated with this resource.</p> ");
