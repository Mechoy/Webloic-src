...
public class RealmMBeanBinder extends ConfigurationMBeanBinder implements AttributeBinder {
         ...
         if (!(this instanceof SecurityReadOnlyMBeanBinder) && var2 != null && var2.toString().trim().length() == 0) {
            ...
            if (var1 != null) {
               if (var1.equals("CachingRealm")) {
                  this.bean.setCachingRealmAsString((String)var2);
               } else if (var1.equals("FileRealm")) {
                  this.bean.setFileRealmAsString((String)var2);
                  ...
                  try {
                     this.bean.setResultsBatchSize(Integer.valueOf((String)var2));
                  } catch (BeanAlreadyExistsException var6) {
                     System.out.println("Warning: multiple definitions with same name: " + var6.getMessage());
                  }
               } else if (var1.equals("EnumerationAllowed")) {
                  try {
                     this.bean.setEnumerationAllowed(Boolean.valueOf((String)var2));
