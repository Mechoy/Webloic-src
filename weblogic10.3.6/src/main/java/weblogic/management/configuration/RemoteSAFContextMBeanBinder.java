...
public class RemoteSAFContextMBeanBinder extends ConfigurationMBeanBinder implements AttributeBinder {
   ...
   protected RemoteSAFContextMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (RemoteSAFContextMBeanImpl)var1;
   }

   public RemoteSAFContextMBeanBinder() {
      super(new RemoteSAFContextMBeanImpl());
      this.bean = (RemoteSAFContextMBeanImpl)this.getBean();
   }
         ...
         if (!(this instanceof SecurityReadOnlyMBeanBinder) && var2 != null && var2.toString().trim().length() == 0) {
            ...
            if (var1 != null) {
               if (var1.equals("JndiInitialContextFactory")) {
                  try {
                     this.bean.setJndiInitialContextFactory((String)var2);
                  } catch (BeanAlreadyExistsException var10) {
                     System.out.println("Warning: multiple definitions with same name: " + var10.getMessage());
                  }
               } else if (var1.equals("JndiProperty")) {
                  try {
                     this.bean.setJndiProperty((String)var2);
