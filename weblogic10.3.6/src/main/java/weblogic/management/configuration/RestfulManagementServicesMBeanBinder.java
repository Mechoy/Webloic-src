...
public class RestfulManagementServicesMBeanBinder extends ConfigurationMBeanBinder implements AttributeBinder {
   private RestfulManagementServicesMBeanImpl bean;

   protected RestfulManagementServicesMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (RestfulManagementServicesMBeanImpl)var1;
   }

   public RestfulManagementServicesMBeanBinder() {
      super(new RestfulManagementServicesMBeanImpl());
      this.bean = (RestfulManagementServicesMBeanImpl)this.getBean();
   }
