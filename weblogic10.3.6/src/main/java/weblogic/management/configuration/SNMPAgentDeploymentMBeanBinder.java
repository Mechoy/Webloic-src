...
public class SNMPAgentDeploymentMBeanBinder extends SNMPAgentMBeanBinder implements AttributeBinder {
   private SNMPAgentDeploymentMBeanImpl bean;

   protected SNMPAgentDeploymentMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (SNMPAgentDeploymentMBeanImpl)var1;
   }

   public SNMPAgentDeploymentMBeanBinder() {
      super(new SNMPAgentDeploymentMBeanImpl());
      this.bean = (SNMPAgentDeploymentMBeanImpl)this.getBean();
   }
