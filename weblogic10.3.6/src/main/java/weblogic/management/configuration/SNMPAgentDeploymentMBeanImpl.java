...
public class SNMPAgentDeploymentMBeanImpl extends SNMPAgentMBeanImpl implements SNMPAgentDeploymentMBean, Serializable {
   ...
   public SNMPAgentDeploymentMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
      this._initializeProperty(-1);
   }
      ...
      if (var1 != null && var1.length() != 0) {
         ...
         for(int var4 = 0; var4 < var13.length; ++var4) {
            ...
            if (var3.contains(var5)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(var5, TargetMBean.class, new ReferenceManager.Resolver(this, 34) {
                  public void resolveReference(Object var1) {
                     try {
                        SNMPAgentDeploymentMBeanImpl.this.addTarget((TargetMBean)var1);
         ...
         this._initializeProperty(34);
         this._postSet(34, var2, this._Targets);
      }
   }
   ...
   public void setTargets(TargetMBean[] var1) throws InvalidAttributeValueException, DistributedManagementException {
      ...
      for(int var2 = 0; var2 < var1.length; ++var2) {
         if (var1[var2] != null) {
            ResolvedReference var3 = new ResolvedReference(this, 34, (AbstractDescriptorBean)var1[var2]) {
   ...
   protected static class Helper extends SNMPAgentMBeanImpl.Helper {
      ...
      protected Helper(SNMPAgentDeploymentMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      public int getPropertyIndex(String var1) {
         if (var1.equals("DeploymentOrder")) {
            ...
            return var1.equals("Targets") ? 34 : super.getPropertyIndex(var1);
         }
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            SNMPAgentDeploymentMBeanImpl var2 = (SNMPAgentDeploymentMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            SNMPAgentDeploymentMBeanImpl var3 = (SNMPAgentDeploymentMBeanImpl)var1.getSourceBean();
            SNMPAgentDeploymentMBeanImpl var4 = (SNMPAgentDeploymentMBeanImpl)var1.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            SNMPAgentDeploymentMBeanImpl var5 = (SNMPAgentDeploymentMBeanImpl)var1;
