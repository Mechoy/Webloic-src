...
public class SystemResourceMBeanBinder extends BasicDeploymentMBeanBinder implements AttributeBinder {
   private SystemResourceMBeanImpl bean;

   protected SystemResourceMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (SystemResourceMBeanImpl)var1;
   }

   public SystemResourceMBeanBinder() {
      super(new SystemResourceMBeanImpl());
      this.bean = (SystemResourceMBeanImpl)this.getBean();
   }
