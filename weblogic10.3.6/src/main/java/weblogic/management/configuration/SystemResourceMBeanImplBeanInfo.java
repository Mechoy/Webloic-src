...
public class SystemResourceMBeanImplBeanInfo extends BasicDeploymentMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = SystemResourceMBean.class;

   public SystemResourceMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }

   public SystemResourceMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = SystemResourceMBeanImpl.class;
      ...
      String var3 = (new String("A system resource is a resource whose definition is part of the system configuration rather than an application.  The descriptor for the resource is linked through config.xml but resides in a separate descriptor file.  The beans representing this descriptor are exposed through JMX  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX.\"</p> ")).intern();
      var2.setShortDescription(var3);
      var2.setValue("description", var3);
      var2.setValue("interfaceclassname", "weblogic.management.configuration.SystemResourceMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("DescriptorFileName")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("DescriptorFileName", SystemResourceMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", SystemResourceMBean.class, var3, var4);
         var1.put("Name", var2);
      ...
      if (!var1.containsKey("Resource")) {
         var3 = "getResource";
         var4 = null;
         var2 = new PropertyDescriptor("Resource", SystemResourceMBean.class, var3, var4);
      ...
      if (!var1.containsKey("SourcePath")) {
         ...
         var2 = new PropertyDescriptor("SourcePath", SystemResourceMBean.class, var3, var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = SystemResourceMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      var3 = SystemResourceMBean.class.getMethod("restoreDefaultValue", String.class);
