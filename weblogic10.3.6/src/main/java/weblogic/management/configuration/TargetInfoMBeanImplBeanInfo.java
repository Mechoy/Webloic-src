...
public class TargetInfoMBeanImplBeanInfo extends ConfigurationMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = TargetInfoMBean.class;

   public TargetInfoMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = TargetInfoMBeanImpl.class;
      ...
      String var3 = (new String("This bean represents any weblogic entity which can be targeted. A bean of this type does not imply that it can be deployed on a weblogic domain. For example, a module within an ear or a submodule within a JMS module. Deployments are represented by {@link BasicDeploymentMBean}.  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX.\"</p> ")).intern();
      var2.setShortDescription(var3);
      var2.setValue("description", var3);
      String[] var4 = new String[]{BeanInfoHelper.encodeEntities("Deployer")};
      var2.setValue("rolesAllowed", var4);
      var2.setValue("interfaceclassname", "weblogic.management.configuration.TargetInfoMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("CompatibilityName")) {
         ...
         var2 = new PropertyDescriptor("CompatibilityName", TargetInfoMBean.class, var3, var4);
      ...
      if (!var1.containsKey("ModuleType")) {
         ...
         var2 = new PropertyDescriptor("ModuleType", TargetInfoMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", TargetInfoMBean.class, var3, var4);
         var1.put("Name", var2);
      ...
      if (!var1.containsKey("Targets")) {
         ...
         var2 = new PropertyDescriptor("Targets", TargetInfoMBean.class, var3, var4);
   ...
   private void fillinCollectionMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = TargetInfoMBean.class.getMethod("addTarget", TargetMBean.class);
      ...
      var3 = TargetInfoMBean.class.getMethod("removeTarget", TargetMBean.class);
