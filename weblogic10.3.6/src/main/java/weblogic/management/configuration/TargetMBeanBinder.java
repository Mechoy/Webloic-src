...
public class TargetMBeanBinder extends ConfigurationMBeanBinder implements AttributeBinder {
   private TargetMBeanImpl bean;

   protected TargetMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (TargetMBeanImpl)var1;
   }

   public TargetMBeanBinder() {
      super(new TargetMBeanImpl());
      this.bean = (TargetMBeanImpl)this.getBean();
   }
