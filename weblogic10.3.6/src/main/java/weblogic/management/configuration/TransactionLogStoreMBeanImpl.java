...
public class TransactionLogStoreMBeanImpl extends PersistentStoreMBeanImpl implements TransactionLogStoreMBean, Serializable {
   private TargetMBean[] _Targets;
   private static SchemaHelper2 _schemaHelper;

   public TransactionLogStoreMBeanImpl() {
      this._initializeProperty(-1);
   }

   public TransactionLogStoreMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
      this._initializeProperty(-1);
   }
            ...
            if (var3.contains(var5)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(var5, TargetMBean.class, new ReferenceManager.Resolver(this, 7) {
                  public void resolveReference(Object var1) {
                     try {
                        TransactionLogStoreMBeanImpl.this.addTarget((TargetMBean)var1);
         ...
         if (var1[var2] != null) {
            ResolvedReference var3 = new ResolvedReference(this, 7, (AbstractDescriptorBean)var1[var2]) {
               protected Object getPropertyValue() {
                  return TransactionLogStoreMBeanImpl.this.getTargets();
               }
            };
   ...
   protected static class Helper extends PersistentStoreMBeanImpl.Helper {
      ...
      protected Helper(TransactionLogStoreMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            TransactionLogStoreMBeanImpl var2 = (TransactionLogStoreMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            TransactionLogStoreMBeanImpl var3 = (TransactionLogStoreMBeanImpl)var1.getSourceBean();
            TransactionLogStoreMBeanImpl var4 = (TransactionLogStoreMBeanImpl)var1.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            TransactionLogStoreMBeanImpl var5 = (TransactionLogStoreMBeanImpl)var1;
