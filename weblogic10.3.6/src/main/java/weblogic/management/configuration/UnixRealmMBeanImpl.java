...
import weblogic.management.mbeans.custom.UnixRealm;
import weblogic.utils.collections.CombinedIterator;

public class UnixRealmMBeanImpl extends BasicRealmMBeanImpl implements UnixRealmMBean, Serializable {
   private String _AuthProgram;
   private String _Name;
   private String _RealmClassName;
   private UnixRealm _customizer;
   private static SchemaHelper2 _schemaHelper;

   public UnixRealmMBeanImpl() {
      try {
         this._customizer = new UnixRealm(this);
   ...
   public UnixRealmMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
   ...
   public String getAuthProgram() {
      return this._AuthProgram;
   }
   ...
   public boolean isAuthProgramSet() {
   ...
   public void setAuthProgram(String var1) throws InvalidAttributeValueException {
      var1 = var1 == null ? null : var1.trim();
      String var2 = this._AuthProgram;
      this._AuthProgram = var1;
   ...
   public void putValue(String var1, Object var2) {
      String var4;
      if (var1.equals("AuthProgram")) {
         var4 = this._AuthProgram;
         this._AuthProgram = (String)var2;
         this._postSet(8, var4, this._AuthProgram);
         ...
         UnixRealm var3 = this._customizer;
         this._customizer = (UnixRealm)var2;
      } else {
   ...
   protected static class Helper extends BasicRealmMBeanImpl.Helper {
      private UnixRealmMBeanImpl bean;

      protected Helper(UnixRealmMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected long computeHashValue(CRC32 var1) {
         try {
            ...
            long var5 = 0L;
            if (this.bean.isAuthProgramSet()) {
               var2.append("AuthProgram");
               var2.append(String.valueOf(this.bean.getAuthProgram()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            UnixRealmMBeanImpl var2 = (UnixRealmMBeanImpl)var1;
            this.computeDiff("AuthProgram", this.bean.getAuthProgram(), var2.getAuthProgram(), false);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            UnixRealmMBeanImpl var3 = (UnixRealmMBeanImpl)var1.getSourceBean();
            UnixRealmMBeanImpl var4 = (UnixRealmMBeanImpl)var1.getProposedBean();
            String var5 = var2.getPropertyName();
            int var6 = var2.getUpdateType();
            if (!var2.isDerivedUpdate()) {
               if (var5.equals("AuthProgram")) {
                  var3.setAuthProgram(var4.getAuthProgram());
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            UnixRealmMBeanImpl var5 = (UnixRealmMBeanImpl)var1;
            super.finishCopy(var5, var2, var3);
            if ((var3 == null || !var3.contains("AuthProgram")) && this.bean.isAuthProgramSet()) {
               var5.setAuthProgram(this.bean.getAuthProgram());
            }
