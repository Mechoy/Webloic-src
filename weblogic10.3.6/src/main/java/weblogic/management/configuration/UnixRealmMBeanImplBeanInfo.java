...
public class UnixRealmMBeanImplBeanInfo extends BasicRealmMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = UnixRealmMBean.class;

   public UnixRealmMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }

   public UnixRealmMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      var2.setValue("interfaceclassname", "weblogic.management.configuration.UnixRealmMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      String var3;
      String var4;
      if (!var1.containsKey("AuthProgram")) {
         var3 = "getAuthProgram";
         var4 = null;
         if (!this.readOnly) {
            var4 = "setAuthProgram";
         ...
         var2 = new PropertyDescriptor("AuthProgram", UnixRealmMBean.class, var3, var4);
         var1.put("AuthProgram", var2);
         var2.setValue("description", "The name of the program used to authenticate users in the UNIX security realm. In most cases, the name of the program is <tt>wlauth</tt>. The authentication program must run <tt>setuid root</tt>. <ul> <li> If the program name is <tt>wlauth</tt> and is in the <tt>CLASSPATH</tt>, you need not explicitly set this attribute; leave the attribute blank. <li> If the program name is different than <tt>wlauth</tt>, or if it is not in the <tt>CLASSPATH</tt> of WebLogic Server, specify this attribute. </ul> ");
         setPropertyDescriptorDefault(var2, "wlauth");
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", UnixRealmMBean.class, var3, var4);
         var1.put("Name", var2);
      ...
      if (!var1.containsKey("RealmClassName")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("RealmClassName", UnixRealmMBean.class, var3, var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = UnixRealmMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      var3 = UnixRealmMBean.class.getMethod("restoreDefaultValue", String.class);
