...
public class WLECConnectionPoolMBeanImplBeanInfo extends DeploymentMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = WLECConnectionPoolMBean.class;

   public WLECConnectionPoolMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }

   public WLECConnectionPoolMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = WLECConnectionPoolMBeanImpl.class;
