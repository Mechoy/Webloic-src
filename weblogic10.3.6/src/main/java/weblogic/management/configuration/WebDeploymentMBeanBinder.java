...
public class WebDeploymentMBeanBinder extends DeploymentMBeanBinder implements AttributeBinder {
   private WebDeploymentMBeanImpl bean;

   protected WebDeploymentMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (WebDeploymentMBeanImpl)var1;
   }

   public WebDeploymentMBeanBinder() {
      super(new WebDeploymentMBeanImpl());
      this.bean = (WebDeploymentMBeanImpl)this.getBean();
   }
