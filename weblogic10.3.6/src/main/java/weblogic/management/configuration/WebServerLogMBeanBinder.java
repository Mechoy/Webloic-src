...
public class WebServerLogMBeanBinder extends LogFileMBeanBinder implements AttributeBinder {
   ...
   protected WebServerLogMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (WebServerLogMBeanImpl)var1;
   }

   public WebServerLogMBeanBinder() {
      super(new WebServerLogMBeanImpl());
      this.bean = (WebServerLogMBeanImpl)this.getBean();
   }
         ...
         if (!(this instanceof SecurityReadOnlyMBeanBinder) && var2 != null && var2.toString().trim().length() == 0) {
            ...
            if (var1 != null) {
               if (var1.equals("ELFFields")) {
                  try {
                     this.bean.setELFFields((String)var2);
                  ...
                  try {
                     this.bean.setLogMilliSeconds(Boolean.valueOf((String)var2));
