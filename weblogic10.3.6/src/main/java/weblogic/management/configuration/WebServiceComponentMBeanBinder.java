...
public class WebServiceComponentMBeanBinder extends WebAppComponentMBeanBinder implements AttributeBinder {
   private WebServiceComponentMBeanImpl bean;

   protected WebServiceComponentMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (WebServiceComponentMBeanImpl)var1;
   }

   public WebServiceComponentMBeanBinder() {
      super(new WebServiceComponentMBeanImpl());
      this.bean = (WebServiceComponentMBeanImpl)this.getBean();
   }
