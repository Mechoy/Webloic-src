...
import weblogic.management.mbeans.custom.WebServiceComponent;
import weblogic.utils.ArrayUtils;
import weblogic.utils.collections.CombinedIterator;

public class WebServiceComponentMBeanImpl extends WebAppComponentMBeanImpl implements WebServiceComponentMBean, Serializable {
   private TargetMBean[] _ActivatedTargets;
   private ApplicationMBean _Application;
   private String _Name;
   private TargetMBean[] _Targets;
   private WebServiceComponent _customizer;
   private static SchemaHelper2 _schemaHelper;

   public WebServiceComponentMBeanImpl() {
      try {
         this._customizer = new WebServiceComponent(this);
   ...
   public WebServiceComponentMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
            ...
            if (var3.contains(var5)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(var5, TargetMBean.class, new ReferenceManager.Resolver(this, 7) {
                  public void resolveReference(Object var1) {
                     try {
                        WebServiceComponentMBeanImpl.this.addTarget((TargetMBean)var1);
         ...
         if (var1[var2] != null) {
            ResolvedReference var3 = new ResolvedReference(this, 7, (AbstractDescriptorBean)var1[var2]) {
               protected Object getPropertyValue() {
                  return WebServiceComponentMBeanImpl.this.getTargets();
               }
            };
   ...
   public void putValue(String var1, Object var2) {
      ...
      if (var1.equals("ActivatedTargets")) {
         var4 = this._ActivatedTargets;
         this._ActivatedTargets = (TargetMBean[])((TargetMBean[])var2);
         this._postSet(11, var4, this._ActivatedTargets);
      } else if (var1.equals("Application")) {
         ApplicationMBean var6 = this._Application;
         this._Application = (ApplicationMBean)var2;
         this._postSet(9, var6, this._Application);
         ...
         WebServiceComponent var3 = this._customizer;
         this._customizer = (WebServiceComponent)var2;
      } else {
   ...
   public static class SchemaHelper2 extends WebAppComponentMBeanImpl.SchemaHelper2 implements SchemaHelper {
   ...
   protected static class Helper extends WebAppComponentMBeanImpl.Helper {
      private WebServiceComponentMBeanImpl bean;

      protected Helper(WebServiceComponentMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            WebServiceComponentMBeanImpl var2 = (WebServiceComponentMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            WebServiceComponentMBeanImpl var3 = (WebServiceComponentMBeanImpl)var1.getSourceBean();
            WebServiceComponentMBeanImpl var4 = (WebServiceComponentMBeanImpl)var1.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            WebServiceComponentMBeanImpl var5 = (WebServiceComponentMBeanImpl)var1;
