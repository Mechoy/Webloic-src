...
public class WebServiceRequestBufferingQueueMBeanImplBeanInfo extends WebServiceBufferingQueueMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = WebServiceRequestBufferingQueueMBean.class;

   public WebServiceRequestBufferingQueueMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = WebServiceRequestBufferingQueueMBeanImpl.class;
      ...
      var2.setValue("interfaceclassname", "weblogic.management.configuration.WebServiceRequestBufferingQueueMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", WebServiceRequestBufferingQueueMBean.class, var3, var4);
         var1.put("Name", var2);
