...
public class WebServiceResponseBufferingQueueMBeanImplBeanInfo extends WebServiceBufferingQueueMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = WebServiceResponseBufferingQueueMBean.class;

   public WebServiceResponseBufferingQueueMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = WebServiceResponseBufferingQueueMBeanImpl.class;
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", WebServiceResponseBufferingQueueMBean.class, var3, var4);
         var1.put("Name", var2);
