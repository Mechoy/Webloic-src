...
public interface WeblogicApplicationMBean extends XMLElementMBean, XMLDeclarationMBean {
   ...
   void setJdbcConnectionPools(JdbcConnectionPoolMBean[] var1);

   void addJdbcConnectionPool(JdbcConnectionPoolMBean var1);

   void removeJdbcConnectionPool(JdbcConnectionPoolMBean var1);
