...
public class AssemblyDescriptorMBeanImpl extends XMLElementMBeanDelegate implements AssemblyDescriptorMBean {
   ...
   public MethodPermissionMBean[] getMethodPermissions() {
      if (this.methodPermissions == null) {
         ...
         MethodPermissionMBean[] var1 = new MethodPermissionMBean[this.methodPermissions.size()];
         var1 = (MethodPermissionMBean[])((MethodPermissionMBean[])this.methodPermissions.toArray(var1));
         return var1;
      }
   }

   public void setMethodPermissions(MethodPermissionMBean[] var1) {
      MethodPermissionMBean[] var2 = null;
   ...
   public void addMethodPermission(MethodPermissionMBean var1) {
      this.isSet_methodPermissions = true;
      if (this.methodPermissions == null) {
         this.methodPermissions = Collections.synchronizedList(new ArrayList());
      }
   ...
   public void removeMethodPermission(MethodPermissionMBean var1) {
      if (this.methodPermissions != null) {
