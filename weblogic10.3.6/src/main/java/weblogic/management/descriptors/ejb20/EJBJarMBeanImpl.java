...
public class EJBJarMBeanImpl extends XMLElementMBeanDelegate implements EJBJarMBean {
   ...
   public void setEnterpriseBeans(weblogic.management.descriptors.ejb11.EnterpriseBeansMBean var1) {
      weblogic.management.descriptors.ejb11.EnterpriseBeansMBean var2 = this.enterpriseBeans;
   ...
   public void setRelationships(RelationshipsMBean var1) {
      RelationshipsMBean var2 = this.relationships;
      this.relationships = var1;
      this.isSet_relationships = var1 != null;
      this.checkChange("relationships", var2, this.relationships);
   }
   ...
   public void setAssemblyDescriptor(weblogic.management.descriptors.ejb11.AssemblyDescriptorMBean var1) {
      weblogic.management.descriptors.ejb11.AssemblyDescriptorMBean var2 = this.assemblyDescriptor;
   ...
   public String toXML(int var1) {
      ...
      if (null != this.getRelationships()) {
         var2.append(this.getRelationships().toXML(var1 + 2)).append("\n");
      }
