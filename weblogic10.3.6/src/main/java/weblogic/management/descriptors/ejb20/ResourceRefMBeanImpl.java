...
public class ResourceRefMBeanImpl extends XMLElementMBeanDelegate implements ResourceRefMBean {
   ...
   public void setResSharingScope(String var1) {
      if (var1 != null && var1.trim().length() == 0) {
         var1 = null;
      }

      String var2 = this.resSharingScope;
      this.resSharingScope = var1;
      this.isSet_resSharingScope = var1 != null;
      this.checkChange("resSharingScope", var2, this.resSharingScope);
   }
   ...
   public String toXML(int var1) {
      ...
      if ((this.isSet_resSharingScope || !"Shareable".equals(this.getResSharingScope())) && null != this.getResSharingScope()) {
         var2.append(ToXML.indent(var1 + 2)).append("<res-sharing-scope>").append(this.getResSharingScope()).append("</res-sharing-scope>\n");
      }
