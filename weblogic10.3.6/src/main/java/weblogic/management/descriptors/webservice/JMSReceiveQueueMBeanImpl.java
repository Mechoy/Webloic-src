...
public class JMSReceiveQueueMBeanImpl extends XMLElementMBeanDelegate implements JMSReceiveQueueMBean {
   ...
   public String toXML(int var1) {
      ...
      var2.append(ToXML.indent(var1)).append("<jms-receive-queue");
