...
public class AppClientModuleMBeanImplBeanInfo extends J2EEModuleMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = AppClientModuleMBean.class;

   public AppClientModuleMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = AppClientModuleMBeanImpl.class;
      ...
      var2.setValue("interfaceclassname", "weblogic.management.j2ee.AppClientModuleMBean");
