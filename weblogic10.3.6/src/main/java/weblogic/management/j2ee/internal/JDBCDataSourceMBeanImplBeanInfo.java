...
public class JDBCDataSourceMBeanImplBeanInfo extends J2EEManagedObjectMBeanImplBeanInfo {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      var2.setValue("interfaceclassname", "weblogic.management.j2ee.JDBCDataSourceMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("jdbcDriver")) {
         String var3 = "getjdbcDriver";
         Object var4 = null;
         var2 = new PropertyDescriptor("jdbcDriver", JDBCDataSourceMBean.class, var3, (String)var4);
         var1.put("jdbcDriver", var2);
