...
public final class DomainLogHandlerImpl_1036_WLStub extends Stub implements StubInfoIntf, DomainLogHandler {
   // $FF: synthetic field
   ...
   public DomainLogHandlerImpl_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
   ...
   private static synchronized void ensureInitialized(StubInfo var0) {
      if (!initialized) {
         ...
         md0 = new MethodDescriptor(m[0], class$weblogic$management$logging$DomainLogHandler == null ? (class$weblogic$management$logging$DomainLogHandler = class$("weblogic.management.logging.DomainLogHandler")) : class$weblogic$management$logging$DomainLogHandler, true, false, false, false, var0.getTimeOut(m[0]), var0.getRemoteRef().getObjectID());
         md1 = new MethodDescriptor(m[1], class$weblogic$management$logging$DomainLogHandler == null ? (class$weblogic$management$logging$DomainLogHandler = class$("weblogic.management.logging.DomainLogHandler")) : class$weblogic$management$logging$DomainLogHandler, true, false, false, false, var0.getTimeOut(m[1]), var0.getRemoteRef().getObjectID());
         md2 = new MethodDescriptor(m[2], class$weblogic$management$logging$DomainLogHandler == null ? (class$weblogic$management$logging$DomainLogHandler = class$("weblogic.management.logging.DomainLogHandler")) : class$weblogic$management$logging$DomainLogHandler, true, false, false, false, var0.getTimeOut(m[2]), var0.getRemoteRef().getObjectID());
         md3 = new MethodDescriptor(m[3], class$weblogic$management$logging$DomainLogHandler == null ? (class$weblogic$management$logging$DomainLogHandler = class$("weblogic.management.logging.DomainLogHandler")) : class$weblogic$management$logging$DomainLogHandler, true, false, false, false, var0.getTimeOut(m[3]), var0.getRemoteRef().getObjectID());
         initialized = true;
      }
   }
   ...
   public final void sendALAlertTrap(String var1, String var2, String var3, String var4, String var5, String var6, String var7, String var8, String var9, String var10, String var11, String var12) throws RemoteException {
      ...
      try {
         ...
         this.ror.invoke((Remote)null, md2, var14, m[2]);
      } catch (Error var21) {
         throw var21;
