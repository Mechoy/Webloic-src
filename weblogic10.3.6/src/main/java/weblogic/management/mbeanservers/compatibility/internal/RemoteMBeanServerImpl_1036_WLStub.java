...
public final class RemoteMBeanServerImpl_1036_WLStub extends Stub implements StubInfoIntf, RemoteMBeanServer {
   ...
   public RemoteMBeanServerImpl_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
