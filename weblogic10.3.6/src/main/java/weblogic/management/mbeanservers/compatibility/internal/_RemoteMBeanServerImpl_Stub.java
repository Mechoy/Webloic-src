...
public final class _RemoteMBeanServerImpl_Stub extends Stub implements RemoteMBeanServer {
   // $FF: synthetic field
   ...
   private static String[] _type_ids = new String[]{"RMI:weblogic.management.mbeanservers.compatibility.internal.RemoteMBeanServerImpl:0000000000000000", "RMI:weblogic.management.RemoteMBeanServer:0000000000000000"};
   // $FF: synthetic field
   ...
   public final ObjectInstance createMBean(String var1, ObjectName var2, ObjectName var3, Object[] var4, String[] var5) throws RemoteException {
      try {
         ...
         try {
            ...
            return var8;
         } catch (ApplicationException var17) {
