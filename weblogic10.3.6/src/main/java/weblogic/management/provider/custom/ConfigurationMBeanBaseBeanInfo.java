...
public class ConfigurationMBeanBaseBeanInfo extends BeanInfoImpl {
   public static Class INTERFACE_CLASS = ConfigurationMBean.class;

   public ConfigurationMBeanBaseBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = ConfigurationMBeanBase.class;
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("Name")) {
         ...
         var2 = new PropertyDescriptor("Name", ConfigurationMBean.class, var3, var4);
         var1.put("Name", var2);
      ...
      if (!var1.containsKey("Notes")) {
         ...
         var2 = new PropertyDescriptor("Notes", ConfigurationMBean.class, var3, var4);
         var1.put("Notes", var2);
      ...
      if (!var1.containsKey("ObjectName")) {
         var3 = "getObjectName";
         var4 = null;
         var2 = new PropertyDescriptor("ObjectName", ConfigurationMBean.class, var3, var4);
         var1.put("ObjectName", var2);
         var2.setValue("description", " ");
      }

      if (!var1.containsKey("Parent")) {
         var3 = "getParent";
         var4 = null;
         if (!this.readOnly) {
            var4 = "setParent";
         ...
         var2 = new PropertyDescriptor("Parent", ConfigurationMBean.class, var3, var4);
         var1.put("Parent", var2);
         var2.setValue("description", " ");
         var2.setValue("relationship", "reference");
      }

      if (!var1.containsKey("Registered")) {
         var3 = "isRegistered";
         var4 = null;
         var2 = new PropertyDescriptor("Registered", ConfigurationMBean.class, var3, var4);
         var1.put("Registered", var2);
         var2.setValue("description", " ");
      }
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = ConfigurationMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      var3 = ConfigurationMBean.class.getMethod("restoreDefaultValue", String.class);
      ...
      var3 = ConfigurationMBean.class.getMethod("isSet", String.class);
      var4 = new ParameterDescriptor[]{createParameterDescriptor("propertyName", "property to check ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var4);
         var1.put(var5, var2);
         var2.setValue("description", "Returns true if the specified attribute has been set explicitly in this MBean instance. ");
         var2.setValue("role", "operation");
         var2.setValue("impact", "info");
      }

      var3 = ConfigurationMBean.class.getMethod("unSet", String.class);
      var4 = new ParameterDescriptor[]{createParameterDescriptor("propertyName", "property to restore ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var4);
         String[] var6 = new String[]{BeanInfoHelper.encodeEntities("UnsupportedOperationException if called on a runtime          implementation.")};
         var2.setValue("throws", var6);
         var1.put(var5, var2);
         var2.setValue("description", "Restore the given property to its default value. ");
         var2.setValue("role", "operation");
         var2.setValue("allowSecurityOperations", Boolean.TRUE);
      }
