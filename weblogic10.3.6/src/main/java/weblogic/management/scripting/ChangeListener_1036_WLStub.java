...
public final class ChangeListener_1036_WLStub extends Stub implements StubInfoIntf, RemoteNotificationListener {
   ...
   public ChangeListener_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
