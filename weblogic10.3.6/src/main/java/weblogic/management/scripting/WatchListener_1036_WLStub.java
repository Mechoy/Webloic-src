...
public final class WatchListener_1036_WLStub extends Stub implements StubInfoIntf, RemoteNotificationListener {
   ...
   public WatchListener_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
