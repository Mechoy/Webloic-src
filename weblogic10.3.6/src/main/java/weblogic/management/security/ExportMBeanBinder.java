...
public class ExportMBeanBinder extends SecurityReadOnlyMBeanBinder implements AttributeBinder {
   private ExportMBeanImpl bean;

   protected ExportMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (ExportMBeanImpl)var1;
   }

   public ExportMBeanBinder() {
      super(new ExportMBeanImpl());
      this.bean = (ExportMBeanImpl)this.getBean();
   }
