...
public class ProviderMBeanBinder extends SecurityReadOnlyMBeanBinder implements AttributeBinder {
   private ProviderMBeanImpl bean;

   protected ProviderMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (ProviderMBeanImpl)var1;
   }

   public ProviderMBeanBinder() {
      super(new ProviderMBeanImpl());
