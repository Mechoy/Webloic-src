...
public class AuditorMBeanBinder extends ProviderMBeanBinder implements AttributeBinder {
   private AuditorMBeanImpl bean;

   protected AuditorMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (AuditorMBeanImpl)var1;
   }

   public AuditorMBeanBinder() {
      super(new AuditorMBeanImpl());
      this.bean = (AuditorMBeanImpl)this.getBean();
   }
