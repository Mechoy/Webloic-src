...
public class AuditorMBeanImplBeanInfo extends ProviderMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = AuditorMBean.class;

   public AuditorMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }

   public AuditorMBeanImplBeanInfo() throws IntrospectionException {
   }
