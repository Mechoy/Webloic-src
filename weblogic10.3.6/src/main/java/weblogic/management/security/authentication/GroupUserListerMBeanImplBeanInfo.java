...
public class GroupUserListerMBeanImplBeanInfo extends GroupReaderMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = GroupUserListerMBean.class;

   public GroupUserListerMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = GroupUserListerMBeanImpl.class;
      ...
      var2.setValue("interfaceclassname", "weblogic.management.security.authentication.GroupUserListerMBean");
