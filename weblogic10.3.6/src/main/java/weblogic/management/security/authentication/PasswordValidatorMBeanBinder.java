...
public class PasswordValidatorMBeanBinder extends ProviderMBeanBinder implements AttributeBinder {
   private PasswordValidatorMBeanImpl bean;

   protected PasswordValidatorMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (PasswordValidatorMBeanImpl)var1;
   }

   public PasswordValidatorMBeanBinder() {
      super(new PasswordValidatorMBeanImpl());
      this.bean = (PasswordValidatorMBeanImpl)this.getBean();
   }
