...
public class ServletAuthenticationFilterMBeanImpl extends AuthenticationProviderMBeanImpl implements ServletAuthenticationFilterMBean, Serializable {
   ...
   public ServletAuthenticationFilterMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
      this._initializeProperty(-1);
   }
   ...
   protected static class Helper extends AuthenticationProviderMBeanImpl.Helper {
      ...
      protected Helper(ServletAuthenticationFilterMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            ServletAuthenticationFilterMBeanImpl var2 = (ServletAuthenticationFilterMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            ServletAuthenticationFilterMBeanImpl var3 = (ServletAuthenticationFilterMBeanImpl)var1.getSourceBean();
            ServletAuthenticationFilterMBeanImpl var4 = (ServletAuthenticationFilterMBeanImpl)var1.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            ServletAuthenticationFilterMBeanImpl var5 = (ServletAuthenticationFilterMBeanImpl)var1;
