...
public class UserAttributeReaderMBeanBinder extends SecurityReadOnlyMBeanBinder implements AttributeBinder {
   private UserAttributeReaderMBeanImpl bean;

   protected UserAttributeReaderMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (UserAttributeReaderMBeanImpl)var1;
   }

   public UserAttributeReaderMBeanBinder() {
      super(new UserAttributeReaderMBeanImpl());
      this.bean = (UserAttributeReaderMBeanImpl)this.getBean();
   }
