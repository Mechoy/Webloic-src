...
public class UserEditorMBeanBinder extends UserReaderMBeanBinder implements AttributeBinder {
   private UserEditorMBeanImpl bean;

   protected UserEditorMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (UserEditorMBeanImpl)var1;
   }

   public UserEditorMBeanBinder() {
      super(new UserEditorMBeanImpl());
      this.bean = (UserEditorMBeanImpl)this.getBean();
   }
