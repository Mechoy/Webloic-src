...
public class AdjudicatorMBeanBinder extends ProviderMBeanBinder implements AttributeBinder {
   private AdjudicatorMBeanImpl bean;

   protected AdjudicatorMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (AdjudicatorMBeanImpl)var1;
   }

   public AdjudicatorMBeanBinder() {
      super(new AdjudicatorMBeanImpl());
      this.bean = (AdjudicatorMBeanImpl)this.getBean();
   }
