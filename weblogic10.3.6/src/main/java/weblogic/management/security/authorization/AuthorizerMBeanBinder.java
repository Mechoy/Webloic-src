...
public class AuthorizerMBeanBinder extends ProviderMBeanBinder implements AttributeBinder {
   private AuthorizerMBeanImpl bean;

   protected AuthorizerMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (AuthorizerMBeanImpl)var1;
   }

   public AuthorizerMBeanBinder() {
      super(new AuthorizerMBeanImpl());
      this.bean = (AuthorizerMBeanImpl)this.getBean();
   }
