...
public class PolicyEditorMBeanBinder extends PolicyReaderMBeanBinder implements AttributeBinder {
   private PolicyEditorMBeanImpl bean;

   protected PolicyEditorMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (PolicyEditorMBeanImpl)var1;
   }

   public PolicyEditorMBeanBinder() {
      super(new PolicyEditorMBeanImpl());
      this.bean = (PolicyEditorMBeanImpl)this.getBean();
   }
