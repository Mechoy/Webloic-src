...
public class PolicyEditorMBeanImpl extends PolicyReaderMBeanImpl implements PolicyEditorMBean, Serializable {
   ...
   public PolicyEditorMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
      this._initializeProperty(-1);
   }

   public void setPolicyExpression(String var1, String var2) throws NotFoundException, CreateException {
      throw new AssertionError("Method not implemented");
   }

   public void createPolicy(String var1, String var2) throws AlreadyExistsException, CreateException {
      throw new AssertionError("Method not implemented");
   }

   public void removePolicy(String var1) throws NotFoundException, RemoveException {
      throw new AssertionError("Method not implemented");
   }
   ...
   protected static class Helper extends PolicyReaderMBeanImpl.Helper {
      ...
      protected Helper(PolicyEditorMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            PolicyEditorMBeanImpl var2 = (PolicyEditorMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            PolicyEditorMBeanImpl var3 = (PolicyEditorMBeanImpl)var1.getSourceBean();
            PolicyEditorMBeanImpl var4 = (PolicyEditorMBeanImpl)var1.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            PolicyEditorMBeanImpl var5 = (PolicyEditorMBeanImpl)var1;
