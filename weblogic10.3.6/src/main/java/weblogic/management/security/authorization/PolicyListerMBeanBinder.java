...
public class PolicyListerMBeanBinder extends PropertiesListerMBeanBinder implements AttributeBinder {
   private PolicyListerMBeanImpl bean;

   protected PolicyListerMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (PolicyListerMBeanImpl)var1;
   }

   public PolicyListerMBeanBinder() {
      super(new PolicyListerMBeanImpl());
      this.bean = (PolicyListerMBeanImpl)this.getBean();
   }
