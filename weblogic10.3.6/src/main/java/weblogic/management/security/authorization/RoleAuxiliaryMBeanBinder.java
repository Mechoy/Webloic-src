...
public class RoleAuxiliaryMBeanBinder extends RoleEditorMBeanBinder implements AttributeBinder {
   private RoleAuxiliaryMBeanImpl bean;

   protected RoleAuxiliaryMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (RoleAuxiliaryMBeanImpl)var1;
   }

   public RoleAuxiliaryMBeanBinder() {
      super(new RoleAuxiliaryMBeanImpl());
      this.bean = (RoleAuxiliaryMBeanImpl)this.getBean();
   }
