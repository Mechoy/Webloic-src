...
public class RoleEditorMBeanBinder extends RoleReaderMBeanBinder implements AttributeBinder {
   private RoleEditorMBeanImpl bean;

   protected RoleEditorMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (RoleEditorMBeanImpl)var1;
   }

   public RoleEditorMBeanBinder() {
      super(new RoleEditorMBeanImpl());
      this.bean = (RoleEditorMBeanImpl)this.getBean();
   }
