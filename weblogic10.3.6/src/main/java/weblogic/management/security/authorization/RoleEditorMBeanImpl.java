...
public class RoleEditorMBeanImpl extends RoleReaderMBeanImpl implements RoleEditorMBean, Serializable {
   ...
   public RoleEditorMBeanImpl(DescriptorBean var1, int var2) {
      super(var1, var2);
      this._initializeProperty(-1);
   }

   public void createRole(String var1, String var2, String var3) throws AlreadyExistsException, CreateException {
      throw new AssertionError("Method not implemented");
   }

   public void removeRole(String var1, String var2) throws NotFoundException, RemoveException {
      throw new AssertionError("Method not implemented");
   }

   public void setRoleExpression(String var1, String var2, String var3) throws NotFoundException, CreateException {
      throw new AssertionError("Method not implemented");
   }
   ...
   protected static class Helper extends RoleReaderMBeanImpl.Helper {
      ...
      protected Helper(RoleEditorMBeanImpl var1) {
         super(var1);
         this.bean = var1;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean var1) {
         try {
            ...
            RoleEditorMBeanImpl var2 = (RoleEditorMBeanImpl)var1;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent var1, BeanUpdateEvent.PropertyUpdate var2) {
         try {
            RoleEditorMBeanImpl var3 = (RoleEditorMBeanImpl)var1.getSourceBean();
            RoleEditorMBeanImpl var4 = (RoleEditorMBeanImpl)var1.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean var1, boolean var2, List var3) {
         try {
            RoleEditorMBeanImpl var5 = (RoleEditorMBeanImpl)var1;
