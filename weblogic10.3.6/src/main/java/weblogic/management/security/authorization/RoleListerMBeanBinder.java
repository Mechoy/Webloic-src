...
public class RoleListerMBeanBinder extends PropertiesListerMBeanBinder implements AttributeBinder {
   private RoleListerMBeanImpl bean;

   protected RoleListerMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (RoleListerMBeanImpl)var1;
   }

   public RoleListerMBeanBinder() {
      super(new RoleListerMBeanImpl());
      this.bean = (RoleListerMBeanImpl)this.getBean();
   }
