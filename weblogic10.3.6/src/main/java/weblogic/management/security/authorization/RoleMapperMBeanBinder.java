...
public class RoleMapperMBeanBinder extends ProviderMBeanBinder implements AttributeBinder {
   private RoleMapperMBeanImpl bean;

   protected RoleMapperMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (RoleMapperMBeanImpl)var1;
   }

   public RoleMapperMBeanBinder() {
      super(new RoleMapperMBeanImpl());
      this.bean = (RoleMapperMBeanImpl)this.getBean();
   }
