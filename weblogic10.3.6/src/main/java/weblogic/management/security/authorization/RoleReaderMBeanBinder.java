...
public class RoleReaderMBeanBinder extends SecurityReadOnlyMBeanBinder implements AttributeBinder {
   private RoleReaderMBeanImpl bean;

   protected RoleReaderMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (RoleReaderMBeanImpl)var1;
   }

   public RoleReaderMBeanBinder() {
      super(new RoleReaderMBeanImpl());
      this.bean = (RoleReaderMBeanImpl)this.getBean();
   }
