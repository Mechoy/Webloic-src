...
public class CredentialMapperMBeanBinder extends ProviderMBeanBinder implements AttributeBinder {
   private CredentialMapperMBeanImpl bean;

   protected CredentialMapperMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (CredentialMapperMBeanImpl)var1;
   }

   public CredentialMapperMBeanBinder() {
      super(new CredentialMapperMBeanImpl());
      this.bean = (CredentialMapperMBeanImpl)this.getBean();
   }
