...
public class UserPasswordCredentialMapReaderMBeanBinder extends ListerMBeanBinder implements AttributeBinder {
   private UserPasswordCredentialMapReaderMBeanImpl bean;

   protected UserPasswordCredentialMapReaderMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (UserPasswordCredentialMapReaderMBeanImpl)var1;
   }

   public UserPasswordCredentialMapReaderMBeanBinder() {
      super(new UserPasswordCredentialMapReaderMBeanImpl());
      this.bean = (UserPasswordCredentialMapReaderMBeanImpl)this.getBean();
   }
