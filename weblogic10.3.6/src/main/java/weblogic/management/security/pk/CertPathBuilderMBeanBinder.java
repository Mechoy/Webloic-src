...
public class CertPathBuilderMBeanBinder extends CertPathProviderMBeanBinder implements AttributeBinder {
   private CertPathBuilderMBeanImpl bean;

   protected CertPathBuilderMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (CertPathBuilderMBeanImpl)var1;
   }

   public CertPathBuilderMBeanBinder() {
      super(new CertPathBuilderMBeanImpl());
      this.bean = (CertPathBuilderMBeanImpl)this.getBean();
   }
