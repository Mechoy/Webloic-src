...
public class CertPathProviderMBeanBinder extends ProviderMBeanBinder implements AttributeBinder {
   private CertPathProviderMBeanImpl bean;

   protected CertPathProviderMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (CertPathProviderMBeanImpl)var1;
   }

   public CertPathProviderMBeanBinder() {
      super(new CertPathProviderMBeanImpl());
      this.bean = (CertPathProviderMBeanImpl)this.getBean();
   }
