...
public class CertPathValidatorMBeanBinder extends CertPathProviderMBeanBinder implements AttributeBinder {
   private CertPathValidatorMBeanImpl bean;

   protected CertPathValidatorMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (CertPathValidatorMBeanImpl)var1;
   }

   public CertPathValidatorMBeanBinder() {
      super(new CertPathValidatorMBeanImpl());
      this.bean = (CertPathValidatorMBeanImpl)this.getBean();
   }
