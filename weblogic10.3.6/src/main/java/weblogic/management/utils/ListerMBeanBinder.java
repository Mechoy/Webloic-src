...
public class ListerMBeanBinder extends SecurityReadOnlyMBeanBinder implements AttributeBinder {
   private ListerMBeanImpl bean;

   protected ListerMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (ListerMBeanImpl)var1;
   }

   public ListerMBeanBinder() {
      super(new ListerMBeanImpl());
      this.bean = (ListerMBeanImpl)this.getBean();
   }
