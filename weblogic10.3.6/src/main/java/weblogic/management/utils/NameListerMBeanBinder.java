...
public class NameListerMBeanBinder extends ListerMBeanBinder implements AttributeBinder {
   private NameListerMBeanImpl bean;

   protected NameListerMBeanBinder(DescriptorBean var1) {
      super(var1);
      this.bean = (NameListerMBeanImpl)var1;
   }

   public NameListerMBeanBinder() {
      super(new NameListerMBeanImpl());
      this.bean = (NameListerMBeanImpl)this.getBean();
   }
