...
public final class FastDispatcherImpl_1036_WLStub extends Stub implements StubInfoIntf, DispatcherRemote, DispatcherOneWay {
   ...
   public FastDispatcherImpl_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
   ...
   private static synchronized void ensureInitialized(StubInfo var0) {
      if (!initialized) {
         ...
         md3 = new MethodDescriptor(m[3], class$weblogic$messaging$dispatcher$DispatcherRemote == null ? (class$weblogic$messaging$dispatcher$DispatcherRemote = class$("weblogic.messaging.dispatcher.DispatcherRemote")) : class$weblogic$messaging$dispatcher$DispatcherRemote, false, true, false, false, var0.getTimeOut(m[3]), var0.getRemoteRef().getObjectID());
