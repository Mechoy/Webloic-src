...
public class MessageCursorRuntimeImplBeanInfo extends CursorRuntimeImplBeanInfo {
   public static Class INTERFACE_CLASS = MessageCursorRuntimeMBean.class;

   public MessageCursorRuntimeImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = MessageCursorRuntimeImpl.class;
      ...
      var2.setValue("package", "weblogic.messaging.kernel.runtime");
      String var4 = (new String("<p>This interface specifies methods for cursor result sets comprised of messages.  Given a cursor handle and an identifier, they return a complete message in CompositeData representation.</p>  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX\" on <a href=\"http://www.oracle.com/technology/products/weblogic/index.html\" shape=\"rect\">http://www.oracle.com/technology/products/weblogic/index.html</a>.</p> ")).intern();
      var2.setShortDescription(var4);
      var2.setValue("description", var4);
      var2.setValue("interfaceclassname", "weblogic.management.runtime.MessageCursorRuntimeMBean");
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = MessageCursorRuntimeMBean.class.getMethod("getCursorStartPosition", String.class);
      ...
      var3 = MessageCursorRuntimeMBean.class.getMethod("getMessage", String.class, String.class);
      ...
      var3 = MessageCursorRuntimeMBean.class.getMethod("preDeregister");
      ...
      var3 = MessageCursorRuntimeMBean.class.getMethod("getCursorEndPosition", String.class);
      ...
      var3 = MessageCursorRuntimeMBean.class.getMethod("getMessage", String.class, Long.class);
      ...
      if (!var1.containsKey(var5)) {
         ...
         String[] var7 = new String[]{BeanInfoHelper.encodeEntities("javax.management.openmbean.CompositeData")};
         var2.setValue("see", var7);
         var2.setValue("role", "operation");
      }

      var3 = MessageCursorRuntimeMBean.class.getMethod("getItems", String.class, Long.class, Integer.class);
      ...
      var3 = MessageCursorRuntimeMBean.class.getMethod("getNext", String.class, Integer.class);
      ...
      var3 = MessageCursorRuntimeMBean.class.getMethod("getPrevious", String.class, Integer.class);
      ...
      var3 = MessageCursorRuntimeMBean.class.getMethod("getCursorSize", String.class);
      var4 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var4);
      ...
      var3 = MessageCursorRuntimeMBean.class.getMethod("closeCursor", String.class);
      var4 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var4);
