...
public class PSEntryCursorRuntimeDelegateBeanInfo extends CursorRuntimeImplBeanInfo {
   public static Class INTERFACE_CLASS = PSEntryCursorRuntimeMBean.class;

   public PSEntryCursorRuntimeDelegateBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = PSEntryCursorRuntimeDelegate.class;
      ...
      String[] var3 = new String[]{BeanInfoHelper.encodeEntities("weblogic.management.runtime.CursorRuntimeMBean")};
      var2.setValue("see", var3);
      var2.setValue("package", "weblogic.messaging.path");
      String var4 = (new String("This runtime MBean extends the cursor mbean with write methods, such as delete, update, etc.  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX\" on <a href=\"http://www.oracle.com/technology/products/weblogic/index.html\" shape=\"rect\">http://www.oracle.com/technology/products/weblogic/index.html</a>.</p> ")).intern();
      var2.setShortDescription(var4);
      var2.setValue("description", var4);
      var2.setValue("interfaceclassname", "weblogic.management.runtime.PSEntryCursorRuntimeMBean");
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = PSEntryCursorRuntimeMBean.class.getMethod("getCursorStartPosition", String.class);
      ...
      var3 = PSEntryCursorRuntimeMBean.class.getMethod("preDeregister");
      ...
      var3 = PSEntryCursorRuntimeMBean.class.getMethod("remove", String.class, Integer.class);
      ...
      var3 = PSEntryCursorRuntimeMBean.class.getMethod("getCursorEndPosition", String.class);
      ...
      var3 = PSEntryCursorRuntimeMBean.class.getMethod("update", String.class, Integer.class, CompositeData.class);
      ...
      var3 = PSEntryCursorRuntimeMBean.class.getMethod("getItems", String.class, Long.class, Integer.class);
      ...
      var3 = PSEntryCursorRuntimeMBean.class.getMethod("getMember", String.class, Integer.class);
      ...
      var3 = PSEntryCursorRuntimeMBean.class.getMethod("getNext", String.class, Integer.class);
      ...
      var3 = PSEntryCursorRuntimeMBean.class.getMethod("getPrevious", String.class, Integer.class);
      ...
      var3 = PSEntryCursorRuntimeMBean.class.getMethod("getCursorSize", String.class);
      var4 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var4);
      ...
      var3 = PSEntryCursorRuntimeMBean.class.getMethod("closeCursor", String.class);
      var4 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var4);
