...
public class PathServiceRuntimeDelegateBeanInfo extends WebLogicMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = PathServiceRuntimeMBean.class;

   public PathServiceRuntimeDelegateBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }

   public PathServiceRuntimeDelegateBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = PathServiceRuntimeDelegate.class;
      ...
      var2.setValue("interfaceclassname", "weblogic.management.runtime.PathServiceRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("Assemblies")) {
         String var3 = "getAssemblies";
         Object var4 = null;
         var2 = new PropertyDescriptor("Assemblies", PathServiceRuntimeMBean.class, var3, (String)var4);
         var1.put("Assemblies", var2);
         var2.setValue("description", "Returns all maps accessible to a path service. ");
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = PathServiceRuntimeMBean.class.getMethod("preDeregister");
