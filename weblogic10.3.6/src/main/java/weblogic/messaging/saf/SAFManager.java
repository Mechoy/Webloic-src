...
public interface SAFManager {
   ...
   List<Long> getAllSequenceNumberRangesOnReceivingSide(String var1) throws SAFException;

   long getLastAssignedSequenceValueOnSendingSide(String var1) throws SAFException;

   List<Long> getAllSequenceNumberRangesOnSendingSide(String var1) throws SAFException;
   ...
   public static class LocationInfo {
      ...
      public LocationInfo(String var1) {
         this._storeName = var1;
      }
