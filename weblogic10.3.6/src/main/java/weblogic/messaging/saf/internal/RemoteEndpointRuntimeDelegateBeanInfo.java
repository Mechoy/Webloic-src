...
public class RemoteEndpointRuntimeDelegateBeanInfo extends SAFRemoteEndpointCustomizerBeanInfo {
   public static Class INTERFACE_CLASS = WSRMRemoteEndpointRuntimeMBean.class;

   public RemoteEndpointRuntimeDelegateBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = RemoteEndpointRuntimeDelegate.class;
      ...
      String var3 = (new String("This class is used for monitoring a WebLogic SAF remote endpoint for WebServices Reliable Messaging.  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX\" on <a href=\"http://www.oracle.com/technology/products/weblogic/index.html\" shape=\"rect\">http://www.oracle.com/technology/products/weblogic/index.html</a>.</p> ")).intern();
      var2.setShortDescription(var3);
      var2.setValue("description", var3);
      var2.setValue("interfaceclassname", "weblogic.management.runtime.WSRMRemoteEndpointRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("BytesCurrentCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("BytesCurrentCount", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("BytesHighCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("BytesHighCount", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("BytesPendingCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("BytesPendingCount", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("BytesReceivedCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("BytesReceivedCount", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("BytesThresholdTime")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("BytesThresholdTime", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("Conversations")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("Conversations", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
         var1.put("Conversations", var2);
         var2.setValue("description", "<p>Returns the list of SAFConversationRuntimeMBean instances</p> ");
      ...
      if (!var1.containsKey("ConversationsCurrentCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("ConversationsCurrentCount", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("ConversationsHighCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("ConversationsHighCount", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
         var1.put("ConversationsHighCount", var2);
         var2.setValue("description", "<p>Returns the peak number of conversations since the last reset.</p> ");
      }

      if (!var1.containsKey("ConversationsTotalCount")) {
         var3 = "getConversationsTotalCount";
         var4 = null;
         var2 = new PropertyDescriptor("ConversationsTotalCount", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
         var1.put("ConversationsTotalCount", var2);
         var2.setValue("description", "<p>Returns the total number of conversations since the last reset.</p> ");
      }

      if (!var1.containsKey("DowntimeHigh")) {
         var3 = "getDowntimeHigh";
         var4 = null;
         var2 = new PropertyDescriptor("DowntimeHigh", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("DowntimeTotal")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("DowntimeTotal", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("EndpointType")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("EndpointType", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("FailedMessagesTotal")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("FailedMessagesTotal", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("LastException")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("LastException", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("LastTimeConnected")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("LastTimeConnected", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("LastTimeFailedToConnect")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("LastTimeFailedToConnect", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MessagesCurrentCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MessagesCurrentCount", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MessagesHighCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MessagesHighCount", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MessagesPendingCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MessagesPendingCount", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MessagesReceivedCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MessagesReceivedCount", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MessagesThresholdTime")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MessagesThresholdTime", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("OperationState")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("OperationState", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("URL")) {
         var3 = "getURL";
         var4 = null;
         var2 = new PropertyDescriptor("URL", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
         var1.put("URL", var2);
      ...
      if (!var1.containsKey("UptimeHigh")) {
         var3 = "getUptimeHigh";
         var4 = null;
         var2 = new PropertyDescriptor("UptimeHigh", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("UptimeTotal")) {
         var3 = "getUptimeTotal";
         var4 = null;
         var2 = new PropertyDescriptor("UptimeTotal", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("PausedForForwarding")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("PausedForForwarding", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("PausedForIncoming")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("PausedForIncoming", WSRMRemoteEndpointRuntimeMBean.class, var3, (String)var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("closeConversations", String.class);
      String var4 = BeanInfoHelper.buildMethodKey(var3);
      MethodDescriptor var2;
      if (!var1.containsKey(var4)) {
         var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
         var1.put(var4, var2);
         var2.setValue("description", "<p>Forcefully closes all outstanding conversations whose name contains the given name.</p> ");
         var2.setValue("role", "operation");
      }

      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("getCursorStartPosition", String.class);
      ParameterDescriptor[] var8 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("getMessage", String.class, String.class);
      var8 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The handle of the cursor. "), createParameterDescriptor("messageID", "The JMS message ID of the requested message. ")};
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("preDeregister");
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("getCursorEndPosition", String.class);
      var8 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var8);
         var1.put(var5, var2);
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("getMessage", String.class, Long.class);
      var8 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The handle of the cursor. "), createParameterDescriptor("messageHandle", "The handle of the message within the cursor. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var8);
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("getItems", String.class, Long.class, Integer.class);
      var8 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. "), createParameterDescriptor("start", "The new cursor start location. "), createParameterDescriptor("count", "The maximum number of items to return. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var8);
         var1.put(var5, var2);
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("getNext", String.class, Integer.class);
      var8 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. "), createParameterDescriptor("count", "The maximum number of items to return. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var8);
         var1.put(var5, var2);
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("pauseIncoming");
      var4 = BeanInfoHelper.buildMethodKey(var3);
      String[] var9;
      if (!var1.containsKey(var4)) {
         var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("getPrevious", String.class, Integer.class);
      var8 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. "), createParameterDescriptor("count", "The maximum number of item to return. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var8);
         var1.put(var5, var2);
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("resumeIncoming");
      var4 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var4)) {
         var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
         var1.put(var4, var2);
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("getCursorSize", String.class);
      var8 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var8);
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("closeCursor", String.class);
      var8 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var8);
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("pauseForwarding");
      var4 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var4)) {
         var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
         var1.put(var4, var2);
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("resumeForwarding");
      var4 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var4)) {
         var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
         var1.put(var4, var2);
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("expireAll");
      var4 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var4)) {
         var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
         var1.put(var4, var2);
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("purge");
      var4 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var4)) {
         var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
         var1.put(var4, var2);
      ...
      var3 = WSRMRemoteEndpointRuntimeMBean.class.getMethod("getMessages", String.class, Integer.class);
      var8 = new ParameterDescriptor[]{createParameterDescriptor("selector", "A valid JMS message selector or SAF message selector. "), createParameterDescriptor("timeout", "Specifies the amount of time the message cursor is valid.  A value of 0 indicates the cursor does not expire. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var8);
         var1.put(var5, var2);
