...
public class SAFMessageCursorRuntimeImplBeanInfo extends MessageCursorRuntimeImplBeanInfo {
   public static Class INTERFACE_CLASS = SAFMessageCursorRuntimeMBean.class;

   public SAFMessageCursorRuntimeImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = SAFMessageCursorRuntimeImpl.class;
      ...
      String var3 = (new String("This runtime MBean represents a handle to a SAF message result set.  It is used for paging through large sets of messages. Messages are returned in an array of MessageInfo objects.  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX\" on <a href=\"http://www.oracle.com/technology/products/weblogic/index.html\" shape=\"rect\">http://www.oracle.com/technology/products/weblogic/index.html</a>.</p> ")).intern();
      var2.setShortDescription(var3);
      var2.setValue("description", var3);
      var2.setValue("interfaceclassname", "weblogic.management.runtime.SAFMessageCursorRuntimeMBean");
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = SAFMessageCursorRuntimeMBean.class.getMethod("getCursorStartPosition", String.class);
      ...
      var3 = SAFMessageCursorRuntimeMBean.class.getMethod("getMessage", String.class, String.class);
      ...
      var3 = SAFMessageCursorRuntimeMBean.class.getMethod("preDeregister");
      ...
      var3 = SAFMessageCursorRuntimeMBean.class.getMethod("sort", String.class, Long.class, String[].class, Boolean[].class);
      ...
      var3 = SAFMessageCursorRuntimeMBean.class.getMethod("getCursorEndPosition", String.class);
      ...
      var3 = SAFMessageCursorRuntimeMBean.class.getMethod("getMessage", String.class, Long.class);
      ...
      var3 = SAFMessageCursorRuntimeMBean.class.getMethod("getItems", String.class, Long.class, Integer.class);
      ...
      var3 = SAFMessageCursorRuntimeMBean.class.getMethod("getNext", String.class, Integer.class);
      ...
      var3 = SAFMessageCursorRuntimeMBean.class.getMethod("getPrevious", String.class, Integer.class);
      ...
      var3 = SAFMessageCursorRuntimeMBean.class.getMethod("getCursorSize", String.class);
      var4 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var4);
      ...
      var3 = SAFMessageCursorRuntimeMBean.class.getMethod("closeCursor", String.class);
      var4 = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      var5 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var5)) {
         var2 = new MethodDescriptor(var3, var4);
