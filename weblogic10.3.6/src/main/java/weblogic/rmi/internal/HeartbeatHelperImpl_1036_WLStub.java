...
public final class HeartbeatHelperImpl_1036_WLStub extends Stub implements StubInfoIntf, HeartbeatHelper {
   ...
   public HeartbeatHelperImpl_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
