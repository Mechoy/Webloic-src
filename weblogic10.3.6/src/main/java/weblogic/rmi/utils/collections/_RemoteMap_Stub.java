...
public final class _RemoteMap_Stub extends Stub implements RemoteMap {
   private static String[] _type_ids = new String[]{"RMI:weblogic.rmi.utils.collections.RemoteMap:0000000000000000"};
   // $FF: synthetic field
   ...
   public final int size() throws RemoteException {
      try {
         ...
         try {
            ...
            int var3 = ((InputStream)var1).read_long();
            return var3;
         } catch (ApplicationException var12) {
            var1 = (org.omg.CORBA_2_3.portable.InputStream)var12.getInputStream();
            String var4 = ((InputStream)var1).read_string();
            if (var4.equals("IDL:java/io/IOEx:1.0")) {
               throw (IOException)((IOException)((org.omg.CORBA_2_3.portable.InputStream)var1).read_value(class$java$io$IOException == null ? (class$java$io$IOException = class$("java.io.IOException")) : class$java$io$IOException));
            }
            ...
            this._releaseReply((InputStream)var1);
         }
   ...
   public final boolean isEmpty() throws RemoteException {
      try {
         ...
         try {
            ...
            var1 = this._invoke(var2);
            boolean var3 = ((InputStream)var1).read_boolean();
            return var3;
         } catch (ApplicationException var12) {
            var1 = (org.omg.CORBA_2_3.portable.InputStream)var12.getInputStream();
            String var4 = ((InputStream)var1).read_string();
   ...
   public final boolean containsKey(Object var1) throws RemoteException {
      try {
         ...
         try {
            ...
            boolean var4 = ((InputStream)var2).read_boolean();
            return var4;
         } catch (ApplicationException var13) {
            var2 = (org.omg.CORBA_2_3.portable.InputStream)var13.getInputStream();
            String var5 = ((InputStream)var2).read_string();
            if (var5.equals("IDL:java/io/IOEx:1.0")) {
               throw (IOException)((IOException)((org.omg.CORBA_2_3.portable.InputStream)var2).read_value(class$java$io$IOException == null ? (class$java$io$IOException = class$("java.io.IOException")) : class$java$io$IOException));
            }
            ...
            this._releaseReply((InputStream)var2);
         }
   ...
   public final Object put(Object var1, Object var2) throws RemoteException {
      try {
         ...
         try {
            ...
            var3 = (org.omg.CORBA_2_3.portable.InputStream)this._invoke(var4);
   ...
   public final void putAll(Map var1) throws RemoteException {
      try {
         ...
         try {
            ...
            var2 = (org.omg.CORBA_2_3.portable.InputStream)var11.getInputStream();
            String var5 = var2.read_string();
            if (var5.equals("IDL:java/io/IOEx:1.0")) {
               throw (IOException)((IOException)var2.read_value(class$java$io$IOException == null ? (class$java$io$IOException = class$("java.io.IOException")) : class$java$io$IOException));
            }
   ...
   public final void clear() throws RemoteException {
      try {
         org.omg.CORBA_2_3.portable.InputStream var1 = null;

         try {
            OutputStream var2 = this._request("clear", true);
            this._invoke(var2);
         } catch (ApplicationException var10) {
            var1 = (org.omg.CORBA_2_3.portable.InputStream)var10.getInputStream();
   ...
   public final Map snapshot() throws RemoteException {
      try {
         ...
         try {
            ...
            var1 = (org.omg.CORBA_2_3.portable.InputStream)this._invoke(var2);
