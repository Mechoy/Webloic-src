...
public final class SecurityServiceImpl_1036_WLStub extends Stub implements StubInfoIntf, SecurityService {
   // $FF: synthetic field
   ...
   public SecurityServiceImpl_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
