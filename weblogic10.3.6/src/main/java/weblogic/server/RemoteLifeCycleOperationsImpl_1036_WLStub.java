...
public final class RemoteLifeCycleOperationsImpl_1036_WLStub extends Stub implements StubInfoIntf, RemoteLifeCycleOperations {
   ...
   public RemoteLifeCycleOperationsImpl_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
