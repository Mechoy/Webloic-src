...
public class ServerLifeCycleTaskRuntimeBeanInfo extends TaskRuntimeMBeanImplBeanInfo {
   ...
   public ServerLifeCycleTaskRuntimeBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = ServerLifeCycleTaskRuntime.class;
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("BeginTime")) {
         var3 = "getBeginTime";
         var4 = null;
         var2 = new PropertyDescriptor("BeginTime", ServerLifeCycleTaskRuntimeMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Description")) {
         var3 = "getDescription";
         var4 = null;
         var2 = new PropertyDescriptor("Description", ServerLifeCycleTaskRuntimeMBean.class, var3, var4);
      ...
      if (!var1.containsKey("EndTime")) {
         var3 = "getEndTime";
         var4 = null;
         var2 = new PropertyDescriptor("EndTime", ServerLifeCycleTaskRuntimeMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Error")) {
         var3 = "getError";
         var4 = null;
         var2 = new PropertyDescriptor("Error", ServerLifeCycleTaskRuntimeMBean.class, var3, var4);
         var1.put("Error", var2);
         var2.setValue("description", " ");
      }
      ...
      if (!var1.containsKey("Operation")) {
         var3 = "getOperation";
         var4 = null;
         var2 = new PropertyDescriptor("Operation", ServerLifeCycleTaskRuntimeMBean.class, var3, var4);
      ...
      if (!var1.containsKey("ParentTask")) {
         var3 = "getParentTask";
         var4 = null;
         var2 = new PropertyDescriptor("ParentTask", ServerLifeCycleTaskRuntimeMBean.class, var3, var4);
      ...
      if (!var1.containsKey("ServerName")) {
         var3 = "getServerName";
         var4 = null;
         var2 = new PropertyDescriptor("ServerName", ServerLifeCycleTaskRuntimeMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Status")) {
         var3 = "getStatus";
         var4 = null;
         var2 = new PropertyDescriptor("Status", ServerLifeCycleTaskRuntimeMBean.class, var3, var4);
      ...
      if (!var1.containsKey("SubTasks")) {
         var3 = "getSubTasks";
         var4 = null;
         var2 = new PropertyDescriptor("SubTasks", ServerLifeCycleTaskRuntimeMBean.class, var3, var4);
      ...
      if (!var1.containsKey("Running")) {
         var3 = "isRunning";
         var4 = null;
         var2 = new PropertyDescriptor("Running", ServerLifeCycleTaskRuntimeMBean.class, var3, var4);
      ...
      if (!var1.containsKey("SystemTask")) {
         ...
         var2 = new PropertyDescriptor("SystemTask", ServerLifeCycleTaskRuntimeMBean.class, var3, var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = ServerLifeCycleTaskRuntimeMBean.class.getMethod("preDeregister");
      ...
      var3 = ServerLifeCycleTaskRuntimeMBean.class.getMethod("cancel");
      ...
      var3 = ServerLifeCycleTaskRuntimeMBean.class.getMethod("printLog", PrintWriter.class);
      var4 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var4)) {
         var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
         var1.put(var4, var2);
