...
public final class RemoteChannelServiceImpl_1036_WLStub extends Stub implements StubInfoIntf, RemoteChannelService {
   ...
   public RemoteChannelServiceImpl_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
   ...
   public final String getAdministrationURL() throws RemoteException {
      ...
      try {
         ...
         var15 = (String)this.ror.invoke((Remote)null, md0, var2, m[0]);
      } catch (Error var10) {
         throw var10;
   ...
   public final ChannelList getChannelList(ServerIdentity var1) throws RemoteException {
      ...
      try {
         ...
         var16 = (ChannelList)this.ror.invoke((Remote)null, md1, var3, m[1]);
      } catch (Error var11) {
         throw var11;
   ...
   public final ServerChannel getServerChannel(String var1) throws RemoteException {
      ...
      try {
         Object[] var3 = new Object[]{var1};
         var16 = (ServerChannel)this.ror.invoke((Remote)null, md4, var3, m[4]);
      } catch (Error var11) {
         throw var11;
      } catch (RuntimeException var12) {
         throw var12;
   ...
   public final ServerIdentity getServerIdentity() throws RemoteException {
      ...
      try {
         Object[] var2 = new Object[0];
         var15 = (ServerIdentity)this.ror.invoke((Remote)null, md5, var2, m[5]);
      } catch (Error var10) {
         throw var10;
      } catch (RuntimeException var11) {
         throw var11;
   ...
   public final String getURL(String var1) throws RemoteException {
      ...
      try {
         Object[] var3 = new Object[]{var1};
         var16 = (String)this.ror.invoke((Remote)null, md6, var3, m[6]);
      } catch (Error var11) {
         throw var11;
      } catch (RuntimeException var12) {
         throw var12;
   ...
   public final String registerServer(String var1, ChannelList var2) throws RemoteException {
      ...
      try {
         ...
         var17 = (String)this.ror.invoke((Remote)null, md7, var4, m[7]);
      } catch (Error var12) {
         throw var12;
