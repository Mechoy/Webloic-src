...
public class WANReplicationRuntimeBeanInfo extends ReplicationRuntimeBeanInfo {
   public static Class INTERFACE_CLASS = WANReplicationRuntimeMBean.class;

   public WANReplicationRuntimeBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = WANReplicationRuntime.class;
      ...
      var2.setValue("package", "weblogic.servlet.cluster");
      ...
      var2.setValue("interfaceclassname", "weblogic.management.runtime.WANReplicationRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("DetailedSecondariesDistribution")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("DetailedSecondariesDistribution", WANReplicationRuntimeMBean.class, var3, var4);
      ...
      if (!var1.containsKey("NumberOfSessionsFlushedToTheDatabase")) {
         var3 = "getNumberOfSessionsFlushedToTheDatabase";
         var4 = null;
         var2 = new PropertyDescriptor("NumberOfSessionsFlushedToTheDatabase", WANReplicationRuntimeMBean.class, var3, var4);
         var1.put("NumberOfSessionsFlushedToTheDatabase", var2);
         var2.setValue("description", " ");
      }

      if (!var1.containsKey("NumberOfSessionsRetrievedFromTheDatabase")) {
         var3 = "getNumberOfSessionsRetrievedFromTheDatabase";
         var4 = null;
         var2 = new PropertyDescriptor("NumberOfSessionsRetrievedFromTheDatabase", WANReplicationRuntimeMBean.class, var3, var4);
         var1.put("NumberOfSessionsRetrievedFromTheDatabase", var2);
         var2.setValue("description", " ");
      }
      ...
      if (!var1.containsKey("PrimaryCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("PrimaryCount", WANReplicationRuntimeMBean.class, var3, var4);
      ...
      if (!var1.containsKey("RemoteClusterReachable")) {
         ...
         var4 = null;
         if (!this.readOnly) {
            var4 = "setRemoteClusterReachable";
         }

         var2 = new PropertyDescriptor("RemoteClusterReachable", WANReplicationRuntimeMBean.class, var3, var4);
      ...
      if (!var1.containsKey("SecondaryCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("SecondaryCount", WANReplicationRuntimeMBean.class, var3, var4);
      ...
      if (!var1.containsKey("SecondaryServerDetails")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("SecondaryServerDetails", WANReplicationRuntimeMBean.class, var3, var4);
      ...
      if (!var1.containsKey("SecondaryServerName")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("SecondaryServerName", WANReplicationRuntimeMBean.class, var3, var4);
         var1.put("SecondaryServerName", var2);
         var2.setValue("description", "<p>Answer the current secondary server </p> ");
         var2.setValue("deprecated", "10.3.0.0 deprecated in favor of getSecondaryServerDetails method ");
      }
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = WANReplicationRuntimeMBean.class.getMethod("preDeregister");
      ...
      var3 = WANReplicationRuntimeMBean.class.getMethod("cleanupExpiredSessionsInTheDatabase");
      var4 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var4)) {
         var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
         var1.put(var4, var2);
         var2.setValue("description", "<p>Clean up expired sessions in the database</p> ");
         var2.setValue("role", "operation");
      }
