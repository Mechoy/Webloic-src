...
public final class PersistenceServiceImpl_1036_WLStub extends Stub implements StubInfoIntf, PersistenceServiceInternal {
   // $FF: synthetic field
   ...
   public PersistenceServiceImpl_1036_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
