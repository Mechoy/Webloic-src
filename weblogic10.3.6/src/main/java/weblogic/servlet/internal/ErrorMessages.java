...
public final class ErrorMessages {
   ...
   public static final String getSection(int var0) {
      switch (var0) {
         case 400:
   ...
   public static final String getMessage(int var0) {
      switch (var0) {
         case 400:
   ...
   public static String getErrorPage(int var0) {
      String var1 = getExplanation(var0);
      return getErrorPage(var0, var1);
   }

   public static String getErrorPage(int var0, String var1) {
      String var2 = "Error " + var0 + "--" + HttpReasonPhraseCoder.getReasonPhrase(var0);
      String var3 = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 Draft//EN\">\n" + "<HTML>\n" + "<HEAD>\n" + "<TITLE>" + var2 + "</TITLE>\n" + "</HEAD>\n" + "<BODY bgcolor=\"white\">\n" + "<FONT FACE=Helvetica><BR CLEAR=all>\n" + "<TABLE border=0 cellspacing=5><TR><TD><BR CLEAR=all>\n" + "<FONT FACE=\"Helvetica\" COLOR=\"black\" SIZE=\"3\">" + "<H2>" + var2 + "</H2>\n" + "</FONT></TD></TR>\n" + "</TABLE>\n" + "<TABLE border=0 width=100% cellpadding=10><TR><TD VALIGN=top WIDTH=100% BGCOLOR=white><FONT FACE=\"Courier New\">" + var1 + "</FONT></TD></TR>\n" + "</TABLE>\n\n" + "</BODY>\n" + "</HTML>\n";
      return var3;
   }

   private static String getExplanation(int var0) {
      String var1 = getSection(var0);
      String var2 = getMessage(var0);
      return "<FONT FACE=\"Helvetica\" SIZE=\"3\"><H3>From RFC 2068 <i>Hypertext Transfer Protocol -- HTTP/1.1</i>:</H3>\n" + "</FONT><FONT FACE=\"Helvetica\" SIZE=\"3\"><H4>" + var1 + "</H4>\n" + "</FONT><P><FONT FACE=\"Courier New\">" + var2 + "</FONT></P>\n";
   }
}
