...
public class WANAsyncSessionContext extends AsyncReplicatedSessionContext {
   ...
   public WANAsyncSessionContext(WebAppServletContext var1, SessionConfigManager var2) {
      super(var1, var2);
   }
   ...
   public HttpSession getNewSession(String var1, ServletRequestImpl var2, ServletResponseImpl var3) {
      ...
      WANAsyncSessionData var4 = new WANAsyncSessionData(var1, this);
   ...
   public SessionData getSessionInternal(String var1, ServletRequestImpl var2, ServletResponseImpl var3) {
      ...
      if (var4 == null && var2 != null && var3 != null) {
         WANAsyncSessionData var6 = new WANAsyncSessionData(var5, this, false);
