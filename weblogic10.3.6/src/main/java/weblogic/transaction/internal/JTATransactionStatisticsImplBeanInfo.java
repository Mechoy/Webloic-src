...
public class JTATransactionStatisticsImplBeanInfo extends JTAStatisticsImplBeanInfo {
   public static Class INTERFACE_CLASS = JTATransactionStatisticsRuntimeMBean.class;

   public JTATransactionStatisticsImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = JTATransactionStatisticsImpl.class;
      ...
      String var3 = (new String("This interface contains general JTA transaction runtime statistics.  <h3 class=\"TypeSafeDeprecation\">Deprecation of MBeanHome and Type-Safe Interfaces</h3>  <p class=\"TypeSafeDeprecation\">This is a type-safe interface for a WebLogic Server MBean, which you can import into your client classes and access through <code>weblogic.management.MBeanHome</code>. As of 9.0, the <code>MBeanHome</code> interface and all type-safe interfaces for WebLogic Server MBeans are deprecated. Instead, client classes that interact with WebLogic Server MBeans should use standard JMX design patterns in which clients use the <code>javax.management.MBeanServerConnection</code> interface to discover MBeans, attributes, and attribute types at runtime. For more information, see \"Developing Manageable Applications with JMX\" on <a href=\"http://www.oracle.com/technology/products/weblogic/index.html\" shape=\"rect\">http://www.oracle.com/technology/products/weblogic/index.html</a>.</p> ")).intern();
      var2.setShortDescription(var3);
      var2.setValue("description", var3);
      var2.setValue("interfaceclassname", "weblogic.management.runtime.JTATransactionStatisticsRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("SecondsActiveTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("SecondsActiveTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TransactionAbandonedTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TransactionAbandonedTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TransactionCommittedTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TransactionCommittedTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TransactionHeuristicsTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TransactionHeuristicsTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TransactionLLRCommittedTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TransactionLLRCommittedTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TransactionNoResourcesCommittedTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TransactionNoResourcesCommittedTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TransactionOneResourceOnePhaseCommittedTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TransactionOneResourceOnePhaseCommittedTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TransactionReadOnlyOnePhaseCommittedTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TransactionReadOnlyOnePhaseCommittedTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TransactionRolledBackAppTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TransactionRolledBackAppTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TransactionRolledBackResourceTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TransactionRolledBackResourceTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TransactionRolledBackSystemTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TransactionRolledBackSystemTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TransactionRolledBackTimeoutTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TransactionRolledBackTimeoutTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TransactionRolledBackTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TransactionRolledBackTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TransactionTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TransactionTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TransactionTwoPhaseCommittedTotalCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TransactionTwoPhaseCommittedTotalCount", JTATransactionStatisticsRuntimeMBean.class, var3, (String)var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = JTATransactionStatisticsRuntimeMBean.class.getMethod("preDeregister");
