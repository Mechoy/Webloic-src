...
class TransactionLogJDBCStoreConfigImpl implements TransactionLogJDBCStoreConfig {
   ...
   public String getJdbcTLogDataSource() {
      if (this.tjdbcMBean == null) {
         ...
         JDBCSystemResourceMBean var1 = this.tjdbcMBean.getDataSource();
         return var1 == null ? null : var1.getJDBCResource().getName();
      }
   }

   public void addPropertyChangeListener(PropertyChangeListener var1) {
      if (this.tjdbcMBean != null) {
         this.tjdbcMBean.addPropertyChangeListener(var1);
      }
   }
}
