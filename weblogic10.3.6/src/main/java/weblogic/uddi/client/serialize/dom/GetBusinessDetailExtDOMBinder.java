...
public class GetBusinessDetailExtDOMBinder {
   public static Element toDOM(GetBusinessDetailExt var0, Document var1) {
      Element var2 = RequestDOMBinder.toDOM("get_businessDetailExt", var0, var1);
