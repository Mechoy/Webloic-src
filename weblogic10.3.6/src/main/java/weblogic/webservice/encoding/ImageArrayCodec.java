...
public class ImageArrayCodec extends AttachmentCodec {
   ...
   protected Object deserializeContent(Object var1) {
      ...
      try {
         ...
         for(int var5 = 0; var5 < var3; ++var5) {
            ...
            Image var8 = (Image)this.codec.deserializeContent(var7);
            var11.add(var8);
         }

         return var11.toArray(new Image[var11.size()]);
      } catch (MessagingException var9) {
         var4 = WebServiceLogger.logImageEncodingMessageException();
         WebServiceLogger.logStackTrace(var4, var9);
         throw new JAXRPCException("failed to deserialize mime multipart", var9);
      } catch (IOException var10) {
         var4 = WebServiceLogger.logImageEncodingIOException();
   ...
   protected Object serializeContent(Object var1) {
      if (!(var1 instanceof Image[])) {
         throw new JAXRPCException("input is not Image[] :" + var1);
      } else {
         Image[] var2 = (Image[])((Image[])var1);
