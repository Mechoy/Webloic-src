...
public class XmlBeansApacheBuildtimeBindings extends XmlBeansBaseBuildtimeBindings implements BuildtimeBindings {
   private static final boolean VERBOSE = Verbose.isVerbose(XmlBeansApacheBuildtimeBindings.class);
   private static SchemaTypeLoader _baseLoader = BuiltinSchemaTypeSystem.get();

   public XmlBeansApacheBuildtimeBindings(com.bea.xml.SchemaTypeLoader var1, SchemaDocument[] var2, SchemaTypeLoader var3) throws XmlException {
      this._typeLoader = var1;

      assert var3 != null;

      this._apache_loader = var3;
      this._documents = var2;

      try {
         this._emptyBindings = EmptyBuildtimeBindings.Factory.getInstance().loadFromURI((URI)null);
      } catch (Exception var5) {
         throw new XmlException(" ERROR getting EmptyBuildtimeBindings !  " + var5.getMessage());
      }
   }
   ...
   public String getClassFromSchemaType(QName var1) {
      ...
      if (_baseLoader != null) {
         var2 = _baseLoader.findType(var1);
         if (var2 != null) {
            if (VERBOSE) {
               Verbose.log((Object)("  $$$$$$  for xmlType '" + var1 + "'  SchemaType is '" + var2 + "', fullJavaName from apache baseLoader is '" + var2.getFullJavaName() + "'\n"));
            }
      ...
      var2 = this._apache_loader.findType(var1);
      if (var2 == null) {
         return null;
      } else {
         if (VERBOSE) {
            Verbose.log((Object)("  $$$$$$  for xmlType '" + var1 + "'  SchemaType is '" + var2 + "', fullJavaName from apache typeLoader is '" + var2.getFullJavaName() + "'\n"));
         }
   ...
   public String getClassFromSchemaElement(QName var1) {
      SchemaType var2 = this._apache_loader.findDocumentType(var1);
      if (var2 != null) {
         return var2.getFullJavaName();
      } else {
   ...
   public QName getSchemaType(String var1) {
      SchemaType var2 = this._apache_loader.typeForClassname(var1);
      if (var2 != null) {
         return var2.getName();
      } else {
   ...
   public Class getBuilderClass() {
      return XmlBeansApacheBindingsBuilderImpl.class;
   }
   ...
   public LinkedHashMap getJavaTypesForWrapperElement(QName var1) {
      SchemaGlobalElement var2 = this._apache_loader.findElement(var1);
      if (var2 == null) {
         return null;
      } else {
         SchemaType var3 = var2.getType();
         if (!hasWrapperFormat(var3, false)) {
            return null;
         } else {
   ...
   private void addElement(SchemaParticle var1, LinkedHashMap var2, QName var3) {
      ...
      if (!StringUtil.isEmpty(var6)) {
         ...
         if (var8 != null) {
            ...
            if (var12) {
               ...
               if (ExceptionUtil.classNameIsSchemaBuiltin(var13)) {
                  ...
                  SchemaType var14 = this._apache_loader.findType(var5);
                  if (var14 != null) {
                     SchemaParticle var15 = var14.getContentModel();
                     if (var15 != null && var15.getParticleType() == 4) {
                        SchemaType var16 = this._apache_loader.findDocumentType(var15.getName());
                        if (var16 != null) {
         ...
         if (!var7) {
            SchemaType var17 = this._apache_loader.findDocumentType(var1.getName());
            if (var17 != null) {
               var4 = var17;
            }
   ...
   public static class Factory implements BuildtimeBindings.Factory {
      ...
      public BuildtimeBindings loadFromURI(URI var1) throws IOException, XmlException {
         ...
         com.bea.xml.SchemaTypeLoader var3 = XmlBeans.typeLoaderForClassLoader(var2);
         return new XmlBeansApacheBuildtimeBindings(var3, (SchemaDocument[])null, (SchemaTypeLoader)null);
      }
