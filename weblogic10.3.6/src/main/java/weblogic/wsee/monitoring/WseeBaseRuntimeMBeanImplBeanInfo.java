...
public class WseeBaseRuntimeMBeanImplBeanInfo extends WebLogicMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = WseeBaseRuntimeMBean.class;

   public WseeBaseRuntimeMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = WseeBaseRuntimeMBeanImpl.class;
      ...
      String var3 = (new String("<p> Base interface for <code>WseeRuntimeMBean</code> and <code>WseeV2RuntimeMBean</code> </p> ")).intern();
      var2.setShortDescription(var3);
      var2.setValue("description", var3);
      var2.setValue("interfaceclassname", "weblogic.management.runtime.WseeBaseRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("ConversationInstanceCount")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("ConversationInstanceCount", WseeBaseRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("ImplementationType")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("ImplementationType", WseeBaseRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("OwsmSecurityPolicyRuntime")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("OwsmSecurityPolicyRuntime", WseeBaseRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("PolicyFaults")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("PolicyFaults", WseeBaseRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("PolicyRuntime")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("PolicyRuntime", WseeBaseRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("Ports")) {
         var3 = "getPorts";
         var4 = null;
         var2 = new PropertyDescriptor("Ports", WseeBaseRuntimeMBean.class, var3, (String)var4);
         var1.put("Ports", var2);
      ...
      if (!var1.containsKey("ServiceName")) {
         var3 = "getServiceName";
         var4 = null;
         var2 = new PropertyDescriptor("ServiceName", WseeBaseRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("StartTime")) {
         var3 = "getStartTime";
         var4 = null;
         var2 = new PropertyDescriptor("StartTime", WseeBaseRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TotalFaults")) {
         var3 = "getTotalFaults";
         var4 = null;
         var2 = new PropertyDescriptor("TotalFaults", WseeBaseRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TotalSecurityFaults")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TotalSecurityFaults", WseeBaseRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("URI")) {
         var3 = "getURI";
         var4 = null;
         var2 = new PropertyDescriptor("URI", WseeBaseRuntimeMBean.class, var3, (String)var4);
         var1.put("URI", var2);
      ...
      if (!var1.containsKey("WebserviceDescriptionName")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("WebserviceDescriptionName", WseeBaseRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("WsType")) {
         var3 = "getWsType";
         var4 = null;
         var2 = new PropertyDescriptor("WsType", WseeBaseRuntimeMBean.class, var3, (String)var4);
   ...
   private void fillinCollectionMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = WseeBaseRuntimeMBean.class.getMethod("addPort", WseePortRuntimeMBean.class);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = WseeBaseRuntimeMBean.class.getMethod("preDeregister");
      String var4 = BeanInfoHelper.buildMethodKey(var3);
      if (!var1.containsKey(var4)) {
         MethodDescriptor var2 = new MethodDescriptor(var3, (ParameterDescriptor[])null);
         var1.put(var4, var2);
