...
public class OwsmSecurityPolicyRuntimeMBeanImplBeanInfo extends WebLogicMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = OwsmSecurityPolicyRuntimeMBean.class;

   public OwsmSecurityPolicyRuntimeMBeanImplBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }

   public OwsmSecurityPolicyRuntimeMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         var1 = OwsmSecurityPolicyRuntimeMBeanImpl.class;
      ...
      var2.setValue("interfaceclassname", "weblogic.management.runtime.OwsmSecurityPolicyRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("AvailablePolicies")) {
         ...
         Object var4 = null;
         var2 = new PropertyDescriptor("AvailablePolicies", OwsmSecurityPolicyRuntimeMBean.class, var3, (String)var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = OwsmSecurityPolicyRuntimeMBean.class.getMethod("preDeregister");
