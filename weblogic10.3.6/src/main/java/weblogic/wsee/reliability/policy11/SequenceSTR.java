...
public class SequenceSTR implements Externalizable {
   private static final long serialVersionUID = 1L;
   public static final QName NAME = new QName(WsrmConstants.RMVersion.latest().getPolicyNamespaceUri(), "SequenceSTR");
   ...
   public boolean equals(Object var1) {
      return var1 instanceof SequenceSTR;
   }
