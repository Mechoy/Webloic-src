...
public class SequenceTransportSecurity implements Externalizable {
   private static final long serialVersionUID = 1L;
   public static final QName NAME = new QName(WsrmConstants.RMVersion.latest().getPolicyNamespaceUri(), "SequenceTransportSecurity");
   ...
   public boolean equals(Object var1) {
      return var1 instanceof SequenceTransportSecurity;
   }
