...
public class ConfidentialityTargetTypeImpl extends XmlComplexContentImpl implements ConfidentialityTargetType {
   private static final long serialVersionUID = 1L;
   private static final QName ENCRYPTIONALGORITHM$0 = new QName("http://www.bea.com/wls90/security/policy", "EncryptionAlgorithm");
   ...
   private static final QName ENCRYPTCONTENTONLY$6 = new QName("", "encryptContentOnly");

   public ConfidentialityTargetTypeImpl(SchemaType var1) {
      super(var1);
   }
   ...
   public AlgorithmType getEncryptionAlgorithm() {
      synchronized(this.monitor()) {
         ...
         var2 = (AlgorithmType)this.get_store().find_element_user(ENCRYPTIONALGORITHM$0, 0);
         return var2 == null ? null : var2;
      }
   }

   public void setEncryptionAlgorithm(AlgorithmType var1) {
      this.generatedSetterHelperImpl(var1, ENCRYPTIONALGORITHM$0, 0, (short)1);
   }

   public AlgorithmType addNewEncryptionAlgorithm() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         AlgorithmType var2 = null;
         var2 = (AlgorithmType)this.get_store().add_element_user(ENCRYPTIONALGORITHM$0);
         return var2;
      }
   }
   ...
   public boolean getEncryptContentOnly() {
      synchronized(this.monitor()) {
         ...
         var2 = (SimpleValue)this.get_store().find_attribute_user(ENCRYPTCONTENTONLY$6);
         if (var2 == null) {
            var2 = (SimpleValue)this.get_default_attribute_value(ENCRYPTCONTENTONLY$6);
         }
   ...
   public XmlBoolean xgetEncryptContentOnly() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlBoolean var2 = null;
         var2 = (XmlBoolean)this.get_store().find_attribute_user(ENCRYPTCONTENTONLY$6);
         if (var2 == null) {
            var2 = (XmlBoolean)this.get_default_attribute_value(ENCRYPTCONTENTONLY$6);
         }
   ...
   public boolean isSetEncryptContentOnly() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().find_attribute_user(ENCRYPTCONTENTONLY$6) != null;
      }
   }

   public void setEncryptContentOnly(boolean var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue var3 = null;
         var3 = (SimpleValue)this.get_store().find_attribute_user(ENCRYPTCONTENTONLY$6);
         if (var3 == null) {
            var3 = (SimpleValue)this.get_store().add_attribute_user(ENCRYPTCONTENTONLY$6);
         }
   ...
   public void xsetEncryptContentOnly(XmlBoolean var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlBoolean var3 = null;
         var3 = (XmlBoolean)this.get_store().find_attribute_user(ENCRYPTCONTENTONLY$6);
         if (var3 == null) {
            var3 = (XmlBoolean)this.get_store().add_attribute_user(ENCRYPTCONTENTONLY$6);
         }
   ...
   public void unsetEncryptContentOnly() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_attribute(ENCRYPTCONTENTONLY$6);
      }
   }
}
