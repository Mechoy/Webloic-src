...
public class SignedElements extends XPathElements {
   ...
   public QName getName() {
      return new QName(this.getNamespace(), "SignedElements", "sp");
   }
   ...
   public static void isValidElement(Node var0) throws SecurityPolicyArchitectureException {
      ...
      if (var1 != null) {
         if (!var1.startsWith("/http://schemas.xmlsoap.org/soap/envelope/:Envelope/") && !var1.startsWith("/http://www.w3.org/2003/05/soap-envelope:Envelope/")) {
            throw new SecurityPolicyArchitectureException("Error validating SignedElement assertion for element <" + var1 + ">: nodelist does not contain a SOAP Envelope element");
         }
      }
   }
}
