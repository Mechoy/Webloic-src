...
public class HttpExtensionParser implements WsdlExtensionParser {
   ...
   public WsdlExtension parseBinding(WsdlBinding var1, Element var2) throws WsdlException {
      if (WsdlReader.tagEquals(var2, "binding", "http://schemas.xmlsoap.org/wsdl/http/")) {
         HttpBinding var3 = new HttpBinding();
         var3.parse(var2);
         if (var1 instanceof WsdlBindingBuilder) {
            WsdlBindingBuilder var4 = (WsdlBindingBuilder)var1;
            var4.setBindingType("HTTP-binding");
            var4.setTransportProtocol("http");
         }
   ...
   public WsdlExtension parseBindingOperation(WsdlBindingOperation var1, Element var2) {
      if (WsdlReader.tagEquals(var2, "operation", "http://schemas.xmlsoap.org/wsdl/http/")) {
         HttpBindingOperation var3 = new HttpBindingOperation();
         var3.parse(var2);
         return var3;
      } else {
         return null;
   ...
   public WsdlExtension parseBindingMessage(WsdlBindingMessage var1, Element var2) throws WsdlException {
      if (WsdlReader.tagEquals(var2, "urlEncoded", "http://schemas.xmlsoap.org/wsdl/http/")) {
         UrlEncoded var4 = new UrlEncoded();
         var4.parse(var2);
         return var4;
      } else if (WsdlReader.tagEquals(var2, "UrlReplacement", "http://schemas.xmlsoap.org/wsdl/http/")) {
         UrlReplacement var3 = new UrlReplacement();
         var3.parse(var2);
         return var3;
      } else {
         return null;
   ...
   public WsdlExtension parsePort(WsdlPort var1, Element var2) throws WsdlException {
      if (WsdlReader.tagEquals(var2, "address", "http://schemas.xmlsoap.org/wsdl/http/")) {
         HttpAddress var3 = new HttpAddress();
