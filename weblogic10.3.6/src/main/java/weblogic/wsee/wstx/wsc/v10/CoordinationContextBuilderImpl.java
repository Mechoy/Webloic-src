...
public class CoordinationContextBuilderImpl extends CoordinationContextBuilder {
   ...
   private MemberSubmissionEndpointReference getEPR() {
      ...
      return (MemberSubmissionEndpointReference)EndpointReferenceBuilder.MemberSubmission().address(this.address).referenceParameter(var1).referenceParameter(var2).build();
   }
}
