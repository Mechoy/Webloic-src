...
public final class tmibflds implements FldTbl {
   ...
   public String[] getFldNames() {
      String[] var1 = new String[]{new String("TA__ENCPASSWD"), new String("TA__BBVERSION"), new String("TA__TUXVERSION"), new String("TA__DATA"), new String("TA__DIRNAME"), new String("TA__DIRPERM"), new String("TA__FILENAME"), new String("TA__LENGTH"), new String("TA__OFFSET"), new String("TA__TOTSIZE"), new String("TA__TRUNCATE"), new String("TA__SEC_PRINCIPAL_ENCPASSWORD")};
      return var1;
   }
}
