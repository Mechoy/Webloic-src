...
public final class tmqflds implements FldTbl {
   ...
   public String[] getFldNames() {
      String[] var1 = new String[]{new String("TQ_DIAGNOSTIC"), new String("TQ_PRIORITY"), new String("TQ_FLAGS"), new String("TQ_TIME"), new String("TQ_FAILUREQ"), new String("TQ_REPLYQ"), new String("TQ_QNAME"), new String("TQ_CORRID"), new String("TQ_MSGID"), new String("TQ_DELIVERYQOS"), new String("TQ_REPLYQOS"), new String("TQ_EXPTIME")};
      return var1;
   }
}
