...
public final class ParsingUtils {
   ...
   public static boolean readWS(PushbackInputStream var0) throws IOException {
      int var1;
      do {
         var1 = var0.read();
         if (var1 < 0) {
   ...
   public static String read(PushbackInputStream var0, String var1, boolean var2) throws IOException {
   ...
   public static String readUntilWS(PushbackInputStream var0) throws IOException {
   ...
   public static String read(PushbackInputStream var0, String[] var1, boolean var2) throws IOException {
      ...
      while(true) {
         ...
         for(int var9 = 0; var9 < var1.length; ++var9) {
            byte[] var10 = (byte[])((byte[])var4.get(var9));
            ...
            if (var3[var9] >= var10.length) {
               if (!var2) {
                  var7 = ((byte[])((byte[])var4.get(var9))).length;
                  var0.unread(var7);
                  var8 = var11.length();
