...
public class Utils extends weblogic.xml.security.utils.Utils {
   ...
   public static boolean readIV(InputStream var0, byte[] var1) throws EncryptionException {
      int var2 = 0;
   ...
   public static void writeIV(OutputStream var0, byte[] var1) throws EncryptionException {
      try {
         var0.write(var1);
      } catch (IOException var3) {
         throw new EncryptionException("Could not write IV", var3);
      }
   }
