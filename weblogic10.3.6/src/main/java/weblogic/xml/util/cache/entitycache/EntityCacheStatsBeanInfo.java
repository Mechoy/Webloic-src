...
public class EntityCacheStatsBeanInfo extends WebLogicMBeanImplBeanInfo {
   public static Class INTERFACE_CLASS = EntityCacheRuntimeMBean.class;

   public EntityCacheStatsBeanInfo(boolean var1, String var2) throws IntrospectionException {
      super(var1, var2);
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      var2.setValue("interfaceclassname", "weblogic.management.runtime.EntityCacheRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map var1) throws IntrospectionException {
      ...
      if (!var1.containsKey("AvgPerEntryDiskSize")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("AvgPerEntryDiskSize", EntityCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("AvgPerEntryMemorySize")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("AvgPerEntryMemorySize", EntityCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("AvgPercentPersistent")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("AvgPercentPersistent", EntityCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("AvgPercentTransient")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("AvgPercentTransient", EntityCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("AvgTimeout")) {
         var3 = "getAvgTimeout";
         var4 = null;
         var2 = new PropertyDescriptor("AvgTimeout", EntityCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MaxEntryMemorySize")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MaxEntryMemorySize", EntityCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MaxEntryTimeout")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MaxEntryTimeout", EntityCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MinEntryMemorySize")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MinEntryMemorySize", EntityCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("MinEntryTimeout")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("MinEntryTimeout", EntityCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TotalCurrentEntries")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TotalCurrentEntries", EntityCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TotalPersistentCurrentEntries")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TotalPersistentCurrentEntries", EntityCacheRuntimeMBean.class, var3, (String)var4);
      ...
      if (!var1.containsKey("TotalTransientCurrentEntries")) {
         ...
         var4 = null;
         var2 = new PropertyDescriptor("TotalTransientCurrentEntries", EntityCacheRuntimeMBean.class, var3, (String)var4);
   ...
   private void fillinOperationMethodInfos(Map var1) throws IntrospectionException, NoSuchMethodException {
      Method var3 = EntityCacheRuntimeMBean.class.getMethod("preDeregister");
